...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.chad.library.adapter.base.BaseQuickAdapter<T, K extends com.chad.library.adapter.base.BaseViewHolder> */
        ...
        if (recyclerView != null && (manager = recyclerView.getLayoutManager()) != null) {
            if (manager instanceof LinearLayoutManager) {
                ...
                recyclerView.postDelayed(new Runnable() {
                    /* class com.chad.library.adapter.base.BaseQuickAdapter.AnonymousClass1 */
                ...
                recyclerView.postDelayed(new Runnable() {
                    /* class com.chad.library.adapter.base.BaseQuickAdapter.AnonymousClass2 */
    ...
    public void setNewDiffData(BaseQuickDiffCallback<T> baseQuickDiffCallback, boolean detectMoves) {
        ...
        DiffUtil.calculateDiff(baseQuickDiffCallback, detectMoves).dispatchUpdatesTo(new BaseQuickAdapterListUpdateCallback(this));
    ...
    public K onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case HEADER_VIEW /*{ENCODED_INT: 273}*/:
                ...
                break;
            case LOADING_VIEW /*{ENCODED_INT: 546}*/:
                baseViewHolder = getLoadingView(parent);
                break;
            case FOOTER_VIEW /*{ENCODED_INT: 819}*/:
                ...
                break;
            case EMPTY_VIEW /*{ENCODED_INT: 1365}*/:
    ...
    private K getLoadingView(ViewGroup parent) {
        ...
        ((BaseViewHolder) holder).itemView.setOnClickListener(new View.OnClickListener() {
            /* class com.chad.library.adapter.base.BaseQuickAdapter.AnonymousClass3 */
    ...
    public void onAttachedToRecyclerView(RecyclerView recyclerView) {
        ...
        if (manager instanceof GridLayoutManager) {
            ...
            gridManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                /* class com.chad.library.adapter.base.BaseQuickAdapter.AnonymousClass4 */
    ...
    public void bindViewClickListener(final K baseViewHolder) {
        if (baseViewHolder != null) {
            View view = ((BaseViewHolder) baseViewHolder).itemView;
            if (getOnItemClickListener() != null) {
                view.setOnClickListener(new View.OnClickListener() {
                    /* class com.chad.library.adapter.base.BaseQuickAdapter.AnonymousClass5 */
            ...
            if (getOnItemLongClickListener() != null) {
                view.setOnLongClickListener(new View.OnLongClickListener() {
                    /* class com.chad.library.adapter.base.BaseQuickAdapter.AnonymousClass6 */
    ...
    public K createBaseViewHolder(View view) {
        ...
        K k = z == null ? (K) new BaseViewHolder(view) : createGenericKInstance(z, view);
        return k != null ? k : (K) new BaseViewHolder(view);
    }

    /* JADX WARN: Type inference failed for: r1v2, types: [com.chad.library.adapter.base.BaseViewHolder, K extends com.chad.library.adapter.base.BaseViewHolder] */
    /* JADX WARN: Type inference failed for: r0v16, types: [com.chad.library.adapter.base.BaseViewHolder, K extends com.chad.library.adapter.base.BaseViewHolder] */
    private K createGenericKInstance(Class z, View view) {
        try {
            ...
            Constructor constructor2 = z.getDeclaredConstructor(getClass(), View.class);
            constructor2.setAccessible(true);
            return constructor2.newInstance(this, view);
            ...
            if (!this.mLoading) {
                ...
                if (getRecyclerView() != null) {
                    getRecyclerView().post(new Runnable() {
                        /* class com.chad.library.adapter.base.BaseQuickAdapter.AnonymousClass7 */
    ...
    private int recursiveCollapse(int position) {
        ...
        for (int i = position + 1; i < n; i++) {
            ...
            if ((itemTemp instanceof IExpandable) && itemTemp.getLevel() <= itemLevel) {
                break;
            }
    ...
    public int getParentPosition(T item) {
        ...
        for (int i = position; i >= 0; i--) {
            IExpandable temp = this.mData.get(i);
            if (temp instanceof IExpandable) {
                IExpandable expandable = temp;
