...
public class LexusSetFactoryLayout extends RelativeLayout implements View.OnClickListener {
    ...
    public LexusSetFactoryLayout(Context context2, Handler handler2) {
        super(context2);
    ...
    private void initView(View view) {
        ...
        this.img_del.setOnLongClickListener(new View.OnLongClickListener() {
            /* class com.wits.ksw.settings.lexus.layout_one.LexusSetFactoryLayout.AnonymousClass1 */

            public boolean onLongClick(View view) {
                if (LexusSetFactoryLayout.this.pwdInput.length() <= 0) {
                    return true;
                }
                LexusSetFactoryLayout.this.pwdInput.delete(0, LexusSetFactoryLayout.this.pwdInput.length());
                LexusSetFactoryLayout.this.tv_showPwd.setText(LexusSetFactoryLayout.this.pwdInput.toString());
                return true;
            }
        });
    }
