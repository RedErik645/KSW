...
public class AlsID7UiSetLanguageLayout extends RelativeLayout {
    ...
    public AlsID7UiSetLanguageLayout(Context context2) {
        super(context2);
        this.context = context2;
        View view = LayoutInflater.from(context2).inflate(R.layout.als_id7_ui_layout_set_language, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        this.adapter.registOnFunctionClickListener(new AlsID7UiLanguageAdapter.OnFunctionClickListener() {
            /* class com.wits.ksw.settings.als_id7_ui_set.layout_one.AlsID7UiSetLanguageLayout.AnonymousClass1 */
