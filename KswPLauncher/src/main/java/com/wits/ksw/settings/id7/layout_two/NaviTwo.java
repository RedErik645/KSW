...
import com.wits.ksw.settings.id7.adapter.NaviAdapter;
...
public class NaviTwo extends RelativeLayout {
    ...
    public NaviTwo(Context context2) {
        ...
        View view = LayoutInflater.from(context2).inflate(R.layout.layout_set_navi_two, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        this.naviAdapter.registCheckListener(new NaviAdapter.IrbtCheckListener() {
            /* class com.wits.ksw.settings.id7.layout_two.NaviTwo.AnonymousClass1 */

            @Override // com.wits.ksw.settings.id7.adapter.NaviAdapter.IrbtCheckListener
            public void checkListener(int pos) {
                ...
                if (mapBean != null) {
                    ...
                    Settings.System.putString(NaviTwo.this.context.getContentResolver(), "wits_freedom_pkg", mapBean.getPackageName());
                }
            }
        });
        ...
        this.rdg_naviv.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            /* class com.wits.ksw.settings.id7.layout_two.NaviTwo.AnonymousClass2 */
