...
public class Ntg6FactoryLayout extends RelativeLayout implements View.OnClickListener {
    ...
    public Ntg6FactoryLayout(Context context2, Handler handler2) {
        super(context2);
        this.context = context2;
        this.handler = handler2;
        View view = LayoutInflater.from(context2).inflate(R.layout.layout_ntg6_factory, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        this.img_del.setOnLongClickListener(new View.OnLongClickListener() {
            /* class com.wits.ksw.settings.ntg6.one_layout.Ntg6FactoryLayout.AnonymousClass1 */

            public boolean onLongClick(View view) {
                if (Ntg6FactoryLayout.this.pwdInput.length() <= 0) {
                    return true;
                }
                Ntg6FactoryLayout.this.pwdInput.delete(0, Ntg6FactoryLayout.this.pwdInput.length());
                Ntg6FactoryLayout.this.tv_showPwd.setText(Ntg6FactoryLayout.this.pwdInput.toString());
                return true;
            }
        });
    }
