...
public class AlsID7UiSetVocModelTwo extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public AlsID7UiSetVocModelTwo(Context context2) {
        super(context2);
        this.context = context2;
        View view = LayoutInflater.from(context2).inflate(R.layout.als_id7_ui_layout_set_voc_model_two, (ViewGroup) null);
    ...
    /* JADX INFO: Multiple debug info for r0v11 int: [D('sdi' int), D('go' int)] */
    /* JADX INFO: Multiple debug info for r0v12 int: [D('zh' int), D('go' int)] */
