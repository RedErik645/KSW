...
public class AlsID7SetFactoryLayout extends RelativeLayout implements View.OnClickListener {
    ...
    public AlsID7SetFactoryLayout(Context context2, Handler handler2) {
        super(context2);
        this.context = context2;
        this.handler = handler2;
        View view = LayoutInflater.from(context2).inflate(R.layout.als_layout_set_factory, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        this.img_del.setOnLongClickListener(new View.OnLongClickListener() {
            /* class com.wits.ksw.settings.alsid7.layout_one.AlsID7SetFactoryLayout.AnonymousClass1 */

            public boolean onLongClick(View view) {
                if (AlsID7SetFactoryLayout.this.pwdInput.length() <= 0) {
                    return true;
                }
                AlsID7SetFactoryLayout.this.pwdInput.delete(0, AlsID7SetFactoryLayout.this.pwdInput.length());
                AlsID7SetFactoryLayout.this.tv_showPwd.setText(AlsID7SetFactoryLayout.this.pwdInput.toString());
                return true;
            }
        });
    }
