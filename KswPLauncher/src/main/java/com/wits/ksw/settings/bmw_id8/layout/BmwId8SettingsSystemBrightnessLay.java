...
public class BmwId8SettingsSystemBrightnessLay extends RelativeLayout implements View.OnClickListener, ID8ProgressBar.OnValueChangeListener, ID8ProgressBar.OnTouchChangeListener {
    ...
    private final Runnable mUpdateSliderRunnable = new Runnable() {
        /* class com.wits.ksw.settings.bmw_id8.layout.BmwId8SettingsSystemBrightnessLay.AnonymousClass3 */
    ...
    public BmwId8SettingsSystemBrightnessLay(Context context2) {
        ...
        this.mBinding = (BmwId8SettingsSystemBrightnessLayoutBinding) DataBindingUtil.inflate(LayoutInflater.from(context2), R.layout.bmw_id8_settings_system_brightness_layout, null, false);
            ...
            while (true) {
                ...
                if (i < iArr.length) {
                    ...
                    findViewById(this.imageButtonId[i]).setOnTouchListener(new View.OnTouchListener() {
                        /* class com.wits.ksw.settings.bmw_id8.layout.BmwId8SettingsSystemBrightnessLay.AnonymousClass1 */
                    ...
                    this.mBinding.getRoot().getViewTreeObserver().addOnGlobalFocusChangeListener(new ViewTreeObserver.OnGlobalFocusChangeListener() {
                        /* class com.wits.ksw.settings.bmw_id8.layout.BmwId8SettingsSystemBrightnessLay.AnonymousClass2 */
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.bmw_id8_settings_brightness_add_btn /*{ENCODED_INT: 2131231032}*/:
                this.mBinding.bmwId8SettingsBrightnessSeekbar.setValue(this.mBinding.bmwId8SettingsBrightnessSeekbar.getValue() + 1);
                return;
            case R.id.bmw_id8_settings_brightness_sub_btn /*{ENCODED_INT: 2131231035}*/:
                this.mBinding.bmwId8SettingsBrightnessSeekbar.setValue(this.mBinding.bmwId8SettingsBrightnessSeekbar.getValue() - 1);
                return;
            default:
                return;
