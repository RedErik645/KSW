...
public class Ntg6SettingsActivity extends BaseActivity implements IUpdateTwoLayout, ScanNaviList.OnMapListScanListener {
    ...
    Handler handler = new Handler() {
        /* class com.wits.ksw.settings.ntg6.Ntg6SettingsActivity.AnonymousClass2 */
            ...
            switch (msg.what) {
                case 1:
                    ...
                    Ntg6SettingsActivity.this.animatorIn.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                        /* class com.wits.ksw.settings.ntg6.Ntg6SettingsActivity.AnonymousClass2.AnonymousClass1 */
                ...
                case 3:
                    ...
                    Ntg6SettingsActivity.this.animatorIn.setDuration(600L);
                    Ntg6SettingsActivity.this.animatorIn.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                        /* class com.wits.ksw.settings.ntg6.Ntg6SettingsActivity.AnonymousClass2.AnonymousClass2 */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_benchi_settings);
    ...
    public void onResume() {
        ...
        if (ntg6TimeLayout2 != null) {
            ntg6TimeLayout2.setOnTimeListener(new Ntg6TimeLayout.onTimeListener() {
                /* class com.wits.ksw.settings.ntg6.Ntg6SettingsActivity.AnonymousClass1 */

                @Override // com.wits.ksw.settings.ntg6.one_layout.Ntg6TimeLayout.onTimeListener
                public void getTieType() {
                    new Handler().postDelayed(new Runnable() {
                        /* class com.wits.ksw.settings.ntg6.Ntg6SettingsActivity.AnonymousClass1.AnonymousClass1 */
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setAnimatorIn(RelativeLayout view) {
        this.animatorIn = ObjectAnimator.ofFloat(view, "translationX", 0.0f, (float) UtilsInfo.dip2px(this, 500.0f));
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setAnimatorOut(RelativeLayout view) {
    ...
    private void initView() {
        ...
        this.adapter.registOnFunctionClickListener(new Ntg6FunctionAdapter.OnFunctionClickListener() {
            /* class com.wits.ksw.settings.ntg6.Ntg6SettingsActivity.AnonymousClass3 */
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setFistImageView(int index) {
        if (index == 5) {
        ...
        if (index == 6) {
            String allRAM = String.format(getResources().getString(R.string.text_14), UtilsInfo.getRAMSize(this));
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateLayout(int type) {
        ...
        switch (type) {
            ...
            case 6:
                ...
                new Handler().postDelayed(new Runnable() {
                    /* class com.wits.ksw.settings.ntg6.$$Lambda$Ntg6SettingsActivity$RnDSPPBGKOZgbCk1e80aE9ymx8 */

                    public final void run() {
                        Ntg6SettingsActivity.this.lambda$updateLayout$0$Ntg6SettingsActivity();
                    }
                }, 50);
                return;
            case 7:
    ...
    public /* synthetic */ void lambda$updateLayout$0$Ntg6SettingsActivity() {
        this.ntg6SystemInfoLayout.getFocus1();
    }
