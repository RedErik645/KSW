...
public class BmwId8SettingsSystemTempLay extends RelativeLayout {
    ...
    public BmwId8SettingsSystemTempLay(Context context2) {
        ...
        this.mBinding = (BmwId8SettingsSystemTempLayoutBinding) DataBindingUtil.inflate(LayoutInflater.from(context2), R.layout.bmw_id8_settings_system_temp_layout, null, false);
    ...
    private void initView() {
        try {
            this.mBinding.getRoot().getViewTreeObserver().addOnGlobalFocusChangeListener(new ViewTreeObserver.OnGlobalFocusChangeListener() {
                /* class com.wits.ksw.settings.bmw_id8.layout.BmwId8SettingsSystemTempLay.AnonymousClass1 */
            ...
            while (true) {
                ...
                if (i < iArr.length) {
                    findViewById(iArr[i]).setOnTouchListener(new View.OnTouchListener() {
                        /* class com.wits.ksw.settings.bmw_id8.layout.BmwId8SettingsSystemTempLay.AnonymousClass2 */
