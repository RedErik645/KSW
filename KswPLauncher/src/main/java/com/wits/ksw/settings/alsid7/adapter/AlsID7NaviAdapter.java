    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        if (this.rbtCheckListener != null) {
            holder.rbt_navi.setOnClickListener(new View.OnClickListener() {
                /* class com.wits.ksw.settings.alsid7.adapter.AlsID7NaviAdapter.AnonymousClass1 */
        ...
        holder.rbt_navi.setOnKeyListener(new View.OnKeyListener() {
            /* class com.wits.ksw.settings.alsid7.adapter.AlsID7NaviAdapter.AnonymousClass2 */
