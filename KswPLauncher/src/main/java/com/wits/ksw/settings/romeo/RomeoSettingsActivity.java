...
public class RomeoSettingsActivity extends BaseActivity implements IUpdateTwoLayout, IUpdateListBg, ScanNaviList.OnMapListScanListener {
    ...
    Handler handler = new Handler() {
        /* class com.wits.ksw.settings.romeo.RomeoSettingsActivity.AnonymousClass1 */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_romeo_settings);
        initData();
        initView();
    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void changeDistance(RecyclerView recyclerView2) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void resetListItemBg(int type) {
        if (type == -1) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void changeItemSelect(int top, int type) {
        if (type == 1) {
            resetListItemBg(1);
        }
        this.romeo_indicator_1.setVisibility(8);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void clearItemSelect(int top, int type) {
        if (top >= 0) {
            if (top < 107) {
                if (this.romeo_left1.getDrawable().getLevel() == type) {
                    this.romeo_left1.getDrawable().setLevel(0);
    ...
    private void initView() {
        ...
        this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            /* class com.wits.ksw.settings.romeo.RomeoSettingsActivity.AnonymousClass2 */
        ...
        this.adapter.registOnItemBgChangeListener(new FunctionAdapter.OnItemBgChangeListener() {
            /* class com.wits.ksw.settings.romeo.RomeoSettingsActivity.AnonymousClass3 */
        ...
        this.adapter.registOnFunctionClickListener(new FunctionAdapter.OnFunctionClickListener() {
            /* class com.wits.ksw.settings.romeo.RomeoSettingsActivity.AnonymousClass4 */
