...
public class LexusNaviTwo extends RelativeLayout {
    ...
    public LexusNaviTwo(Context context2) {
        super(context2);
    ...
    private void initView(View view) {
        ...
        this.naviAdapter.registCheckListener(new NaviAdapter.IrbtCheckListener() {
            /* class com.wits.ksw.settings.lexus.layout_two.LexusNaviTwo.AnonymousClass1 */
        ...
        this.rdg_naviv.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            /* class com.wits.ksw.settings.lexus.layout_two.LexusNaviTwo.AnonymousClass2 */
