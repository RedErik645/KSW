...
public class BmwId8SettingsSystemVideoLay extends RelativeLayout {
    ...
    public BmwId8SettingsSystemVideoLay(Context context2) {
        ...
        this.mBinding = (BmwId8SettingsSystemVideoLayoutBinding) DataBindingUtil.inflate(LayoutInflater.from(context2), R.layout.bmw_id8_settings_system_video_layout, null, false);
    ...
    private void initView() {
        try {
            ...
            this.mBinding.bmwId8SettingsVideoRecycle.addItemDecoration(new RecyclerView.ItemDecoration() {
                /* class com.wits.ksw.settings.bmw_id8.layout.BmwId8SettingsSystemVideoLay.AnonymousClass1 */
            ...
            adapterMusic.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                /* class com.wits.ksw.settings.bmw_id8.layout.BmwId8SettingsSystemVideoLay.AnonymousClass2 */
            ...
            this.mBinding.bmwId8SettingsVideoRecycle.addOnScrollListener(new RecyclerView.OnScrollListener() {
                /* class com.wits.ksw.settings.bmw_id8.layout.BmwId8SettingsSystemVideoLay.AnonymousClass3 */
            ...
            this.mBinding.getRoot().getViewTreeObserver().addOnGlobalFocusChangeListener(new ViewTreeObserver.OnGlobalFocusChangeListener() {
                /* class com.wits.ksw.settings.bmw_id8.layout.BmwId8SettingsSystemVideoLay.AnonymousClass4 */
