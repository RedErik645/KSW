...
public class AlsID7UiRawCarShow extends FrameLayout {
    ...
    Handler handler = new Handler() {
        /* class com.wits.ksw.settings.als_id7_ui_set.factory.AlsID7UiRawCarShow.AnonymousClass1 */
    ...
    private void initView() {
        ...
        this.uiConfigAdapter.registCheckListener(new AlsID7UiUiConfigAdapter.OnItemClickLisen() {
            /* class com.wits.ksw.settings.als_id7_ui_set.factory.AlsID7UiRawCarShow.AnonymousClass2 */
