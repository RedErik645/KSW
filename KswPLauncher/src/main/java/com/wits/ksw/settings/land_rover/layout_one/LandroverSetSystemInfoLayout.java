...
public class LandroverSetSystemInfoLayout extends RelativeLayout implements View.OnClickListener {
    ...
    Handler handler = new Handler() {
        /* class com.wits.ksw.settings.land_rover.layout_one.LandroverSetSystemInfoLayout.AnonymousClass1 */

        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            if (msg.what == 0) {
                try {
                    LandroverSetSystemInfoLayout.this.tv_infoMcuv.setText(String.format(LandroverSetSystemInfoLayout.this.getResources().getString(R.string.text_8), McuUtil.getMcuVersion()));
                } catch (Exception e) {
                    e.getStackTrace();
                }
            } else if (msg.what == 1) {
    ...
    private void initView(View view) {
        ...
        PowerManagerApp.registerIContentObserver("mcuVerison", new IContentObserver.Stub() {
            /* class com.wits.ksw.settings.land_rover.layout_one.LandroverSetSystemInfoLayout.AnonymousClass2 */
        ...
        this.tv_infoSysv.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.settings.land_rover.layout_one.LandroverSetSystemInfoLayout.AnonymousClass3 */

            public void onClick(View v) {
                UtilsInfo.showQRCode(LandroverSetSystemInfoLayout.this.context);
            }
        });
        ...
        this.tv_infoCpu.post(new Runnable() {
            /* class com.wits.ksw.settings.land_rover.layout_one.LandroverSetSystemInfoLayout.AnonymousClass4 */

            public void run() {
                LandroverSetSystemInfoLayout.this.tv_infoCpu.setSelected(true);
            }
        });
