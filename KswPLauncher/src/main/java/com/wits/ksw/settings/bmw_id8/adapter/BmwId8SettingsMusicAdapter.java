...
public class BmwId8SettingsMusicAdapter extends BaseQuickAdapter<LexusLsAppSelBean, BaseViewHolder> {
    ...
    public void convert(BaseViewHolder helper, final LexusLsAppSelBean item) {
        if (item != null) {
            ...
            helper.setText(R.id.bmw_id8_settings_system_music_item_title, item.getAppName());
            helper.itemView.setOnTouchListener(new View.OnTouchListener() {
                /* class com.wits.ksw.settings.bmw_id8.adapter.BmwId8SettingsMusicAdapter.AnonymousClass1 */
            ...
            helper.itemView.setOnKeyListener(new View.OnKeyListener() {
                /* class com.wits.ksw.settings.bmw_id8.adapter.BmwId8SettingsMusicAdapter.AnonymousClass2 */
                ...
                public boolean onKey(View v, int keyCode, KeyEvent event) {
                    ...
                    if (keyCode == 20) {
                        return position == BmwId8SettingsMusicAdapter.this.getData().size() - 1;
                    }
                    return false;
                }
            });
