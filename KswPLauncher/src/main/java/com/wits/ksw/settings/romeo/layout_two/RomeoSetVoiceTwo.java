...
public class RomeoSetVoiceTwo extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public RomeoSetVoiceTwo(Context context2) {
        super(context2);
    ...
    private void initData() {
        ...
        getContext().getContentResolver().registerContentObserver(Settings.System.getUriFor(KeyConfig.ANDROID_MEDIA_VOL), true, new ContentObserver(new Handler()) {
            /* class com.wits.ksw.settings.romeo.layout_two.RomeoSetVoiceTwo.AnonymousClass1 */

            public void onChange(boolean selfChange) {
                try {
                    RomeoSetVoiceTwo.this.seek_mtb.setProgress(PowerManagerApp.getSettingsInt(KeyConfig.ANDROID_MEDIA_VOL));
