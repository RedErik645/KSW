...
public class AudiMib3EQViewModel extends AndroidViewModel {
    ...
    private ContentObserver contentObserver = new ContentObserver(new Handler()) {
        /* class com.wits.ksw.settings.audi_mib3.vm.AudiMib3EQViewModel.AnonymousClass1 */
    ...
    private void setProgress(int model, int bassValue, int mezzoValue, int trebleValue) {
    ...
    public static void setEQModelChangeListener(RadioButton radioButton, final int index) {
        radioButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            /* class com.wits.ksw.settings.audi_mib3.vm.AudiMib3EQViewModel.AnonymousClass2 */
    ...
    public void setEQModelChange(RadioButton radioButton, final SeekBar seekBar, final int index) {
        radioButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            /* class com.wits.ksw.settings.audi_mib3.vm.AudiMib3EQViewModel.AnonymousClass3 */
    ...
    public static void setBassSeekBarChangeListener(SeekBar seekbar, AudiMib3EQViewModel viewModel) {
        seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            /* class com.wits.ksw.settings.audi_mib3.vm.AudiMib3EQViewModel.AnonymousClass4 */
    ...
    public static void setmezzoSeekBarChangeListener(SeekBar seekbar, AudiMib3EQViewModel viewModel) {
        seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            /* class com.wits.ksw.settings.audi_mib3.vm.AudiMib3EQViewModel.AnonymousClass5 */
    ...
    public static void setTrebleSeekBarChangeListener(SeekBar seekbar, AudiMib3EQViewModel viewModel) {
        seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            /* class com.wits.ksw.settings.audi_mib3.vm.AudiMib3EQViewModel.AnonymousClass6 */
