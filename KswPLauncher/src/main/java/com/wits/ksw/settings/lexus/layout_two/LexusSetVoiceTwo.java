...
public class LexusSetVoiceTwo extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public LexusSetVoiceTwo(Context context2) {
        super(context2);
        this.context = context2;
        View view = LayoutInflater.from(context2).inflate(R.layout.lexus_layout_set_voice_two, (ViewGroup) null);
    ...
    private void initData() {
        ...
        getContext().getContentResolver().registerContentObserver(Settings.System.getUriFor(KeyConfig.ANDROID_MEDIA_VOL), true, new ContentObserver(new Handler()) {
            /* class com.wits.ksw.settings.lexus.layout_two.LexusSetVoiceTwo.AnonymousClass1 */

            public void onChange(boolean selfChange) {
                try {
                    LexusSetVoiceTwo.this.seek_mtb.setProgress(PowerManagerApp.getSettingsInt(KeyConfig.ANDROID_MEDIA_VOL));
