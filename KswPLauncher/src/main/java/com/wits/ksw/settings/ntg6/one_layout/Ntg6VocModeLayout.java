...
public class Ntg6VocModeLayout extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    private void initView(View view) {
        ...
        this.rdg_vocmd.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            /* class com.wits.ksw.settings.ntg6.one_layout.Ntg6VocModeLayout.AnonymousClass1 */
        ...
        this.img_TwoBack.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.settings.ntg6.one_layout.Ntg6VocModeLayout.AnonymousClass2 */
    ...
    /* JADX INFO: Multiple debug info for r0v1 int: [D('sdi' int), D('go' int)] */
    /* JADX INFO: Multiple debug info for r0v2 int: [D('zh' int), D('go' int)] */
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        switch (seekBar.getId()) {
            case R.id.seekbar_mdi /*{ENCODED_INT: 2131232561}*/:
                ...
                return;
            case R.id.seekbar_mgo /*{ENCODED_INT: 2131232562}*/:
                ...
                return;
            case R.id.seekbar_mzh /*{ENCODED_INT: 2131232563}*/:
