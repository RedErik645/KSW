...
public class CanBusSelect extends FrameLayout {
    ...
    Handler handler = new Handler() {
        /* class com.wits.ksw.settings.id7.layout_factory.CanBusSelect.AnonymousClass1 */
    ...
    private void initView() {
        ...
        this.uiConfigAdapter.registCheckListener(new UiConfigAdapter.OnItemClickLisen() {
            /* class com.wits.ksw.settings.id7.layout_factory.CanBusSelect.AnonymousClass2 */
