...
public class BmwId8SettingsSystemMusicLay extends RelativeLayout {
    ...
    public BmwId8SettingsSystemMusicLay(Context context2) {
        ...
        this.mBinding = (BmwId8SettingsSystemMusicLayoutBinding) DataBindingUtil.inflate(LayoutInflater.from(context2), R.layout.bmw_id8_settings_system_music_layout, null, false);
    ...
    private void initView() {
        try {
            ...
            this.mBinding.bmwId8SettingsMusicRecycle.addItemDecoration(new RecyclerView.ItemDecoration() {
                /* class com.wits.ksw.settings.bmw_id8.layout.BmwId8SettingsSystemMusicLay.AnonymousClass1 */
            ...
            adapterMusic.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                /* class com.wits.ksw.settings.bmw_id8.layout.BmwId8SettingsSystemMusicLay.AnonymousClass2 */
            ...
            this.mBinding.bmwId8SettingsMusicRecycle.addOnScrollListener(new RecyclerView.OnScrollListener() {
                /* class com.wits.ksw.settings.bmw_id8.layout.BmwId8SettingsSystemMusicLay.AnonymousClass3 */
            ...
            this.mBinding.getRoot().getViewTreeObserver().addOnGlobalFocusChangeListener(new ViewTreeObserver.OnGlobalFocusChangeListener() {
                /* class com.wits.ksw.settings.bmw_id8.layout.BmwId8SettingsSystemMusicLay.AnonymousClass4 */
