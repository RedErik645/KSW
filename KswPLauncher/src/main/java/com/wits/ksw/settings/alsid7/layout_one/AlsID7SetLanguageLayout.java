...
public class AlsID7SetLanguageLayout extends RelativeLayout {
    private AlsID7LanguageAdapter adapter;
    ...
    private void initView(View view) {
        ...
        this.adapter.registOnFunctionClickListener(new AlsID7LanguageAdapter.OnFunctionClickListener() {
            /* class com.wits.ksw.settings.alsid7.layout_one.AlsID7SetLanguageLayout.AnonymousClass1 */

            @Override // com.wits.ksw.settings.alsid7.adapter.AlsID7LanguageAdapter.OnFunctionClickListener
