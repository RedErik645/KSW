...
public class BmwId8SettingsSystemFuelLay extends RelativeLayout {
    ...
    public BmwId8SettingsSystemFuelLay(Context context2) {
        ...
        this.mBinding = (BmwId8SettingsSystemFuelLayoutBinding) DataBindingUtil.inflate(LayoutInflater.from(context2), R.layout.bmw_id8_settings_system_fuel_layout, null, false);
    ...
    private void initView() {
        try {
            this.mBinding.getRoot().getViewTreeObserver().addOnGlobalFocusChangeListener(new ViewTreeObserver.OnGlobalFocusChangeListener() {
                /* class com.wits.ksw.settings.bmw_id8.layout.BmwId8SettingsSystemFuelLay.AnonymousClass1 */
            ...
            while (true) {
                ...
                if (i < iArr.length) {
                    findViewById(iArr[i]).setOnTouchListener(new View.OnTouchListener() {
                        /* class com.wits.ksw.settings.bmw_id8.layout.BmwId8SettingsSystemFuelLay.AnonymousClass2 */
