...
public class AudiMbi3SelThirdAppActivity extends AudiMib3SubActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        AudiMbi3SelThirdCls bindingCls = (AudiMbi3SelThirdCls) DataBindingUtil.inflate(LayoutInflater.from(this), R.layout.audimbi3_sel_third_app_layout, null, false);
        ...
        adapterMusic.setAppsCheckListener(new AudiMib3RecyclerAdapter.IAppsCheckListener() {
            /* class com.wits.ksw.settings.audi_mib3.AudiMbi3SelThirdAppActivity.AnonymousClass1 */
        ...
        adapterVideo.setAppsCheckListener(new AudiMib3RecyclerAdapter.IAppsCheckListener() {
            /* class com.wits.ksw.settings.audi_mib3.AudiMbi3SelThirdAppActivity.AnonymousClass2 */
