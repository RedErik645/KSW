...
public class LanguageAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.tv_functionItem.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.settings.romeo.adapter.LanguageAdapter.AnonymousClass1 */
        ...
        holder.tv_functionItem.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            /* class com.wits.ksw.settings.romeo.adapter.LanguageAdapter.AnonymousClass2 */
        ...
        holder.tv_functionItem.setOnTouchListener(new View.OnTouchListener() {
            /* class com.wits.ksw.settings.romeo.adapter.LanguageAdapter.AnonymousClass3 */
