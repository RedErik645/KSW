...
public class AudiMib3SoundAndroidActivity extends AudiMib3SubActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.binding = (ActivityAudiMib3SoundAndroidBinding) DataBindingUtil.inflate(LayoutInflater.from(this), R.layout.activity_audi_mib3_sound_android, null, false);
