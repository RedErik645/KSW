...
public class SetSystemInfoLayout extends RelativeLayout implements View.OnClickListener {
    ...
    Handler handler = new Handler() {
        /* class com.wits.ksw.settings.id7.layout_one.SetSystemInfoLayout.AnonymousClass1 */

        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            if (msg.what == 0) {
                try {
                    SetSystemInfoLayout.this.tv_infoMcuv.setText(String.format(SetSystemInfoLayout.this.getResources().getString(R.string.text_8), McuUtil.getMcuVersion()));
                } catch (Exception e) {
                    e.getStackTrace();
                }
            } else if (msg.what == 1) {
    ...
    public SetSystemInfoLayout(Context context2) {
        ...
        View view = LayoutInflater.from(context2).inflate(R.layout.layout_set_sys_info, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        PowerManagerApp.registerIContentObserver("mcuVerison", new IContentObserver.Stub() {
            /* class com.wits.ksw.settings.id7.layout_one.SetSystemInfoLayout.AnonymousClass2 */
        ...
        this.tv_infoSysv.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.settings.id7.layout_one.SetSystemInfoLayout.AnonymousClass3 */
        ...
        this.tv_infoCpu.post(new Runnable() {
            /* class com.wits.ksw.settings.id7.layout_one.SetSystemInfoLayout.AnonymousClass4 */

            public void run() {
                SetSystemInfoLayout.this.tv_infoCpu.setSelected(true);
            }
        });
