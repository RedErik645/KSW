...
public class AlsID7UiTimeSetTwo extends RelativeLayout implements RadioGroup.OnCheckedChangeListener {
    ...
    public AlsID7UiTimeSetTwo(Context context2) {
        super(context2);
        this.context = context2;
        View view = LayoutInflater.from(context2).inflate(R.layout.als_id7_ui_layout_set_time_two, (ViewGroup) null);
