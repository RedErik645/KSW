...
import com.wits.ksw.settings.benz_mbux_2021.activity.BenzMbuxSettingsAudioActivity;
import com.wits.ksw.settings.benz_mbux_2021.activity.BenzMbuxSettingsMainActivity;
...
import com.wits.ksw.settings.bmw_id9.activity.BmwId9SettingsAudioActivity;
import com.wits.ksw.settings.bmw_id9.activity.BmwId9SettingsMainActivity;
...
public class SettingsActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (UiThemeUtils.isBenz_NTG6(this)) {
            ...
            if (TextUtils.equals(getIntent().getAction(), "com.on.systemUi.start.voice") || TextUtils.equals(getIntent().getAction(), "com.on.systemUi.start.voice.function")) {
                intentSend = new Intent(this, BenzMbuxSettingsAudioActivity.class);
            } else {
                intentSend = new Intent(this, BenzMbuxSettingsMainActivity.class);
            }
        } else if (UiThemeUtils.isUI_EVOID9_ALS(this)) {
            if (TextUtils.equals(getIntent().getAction(), "com.on.systemUi.start.voice") || TextUtils.equals(getIntent().getAction(), "com.on.systemUi.start.voice.function")) {
                intentSend = new Intent(this, BmwId9SettingsAudioActivity.class);
            } else {
                intentSend = new Intent(this, BmwId9SettingsMainActivity.class);
            }
        } else if (UiThemeUtils.isUI_GS_ID8(this) || UiThemeUtils.isEVOID8_UG(this)) {
            if (TextUtils.equals(getIntent().getAction(), "com.on.systemUi.start.voice") || TextUtils.equals(getIntent().getAction(), "com.on.systemUi.start.voice.function")) {
                intentSend = new Intent(this, BmwId8SettingsAudioActivity.class);
            } else {
