    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (this.rbtCheckListener != null) {
            holder.relat_listTv.setOnClickListener(new View.OnClickListener() {
                /* class com.wits.ksw.settings.als_id7_ui_set.adapter.AlsID7UiUiConfigAdapter.AnonymousClass1 */
        ...
        holder.relat_listTv.setOnKeyListener(new View.OnKeyListener() {
            /* class com.wits.ksw.settings.als_id7_ui_set.adapter.AlsID7UiUiConfigAdapter.AnonymousClass2 */
