...
public class LandroverTimeSetTwo extends RelativeLayout implements RadioGroup.OnCheckedChangeListener {
    ...
    public LandroverTimeSetTwo(Context context2) {
        super(context2);
        this.context = context2;
        View view = LayoutInflater.from(context2).inflate(R.layout.als_layout_set_time_two, (ViewGroup) null);
