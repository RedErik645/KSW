...
public class AlsID7SetSystemTwo extends RelativeLayout {
    ...
    private final Runnable mUpdateSliderRunnable = new Runnable() {
        /* class com.wits.ksw.settings.alsid7.layout_two.AlsID7SetSystemTwo.AnonymousClass10 */
    ...
    private void initView(View view) {
        ...
        this.seekbar_caux.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            /* class com.wits.ksw.settings.alsid7.layout_two.AlsID7SetSystemTwo.AnonymousClass1 */
        ...
        this.seekbar_caux2.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            /* class com.wits.ksw.settings.alsid7.layout_two.AlsID7SetSystemTwo.AnonymousClass2 */
        ...
        this.seekbar_brightness.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            /* class com.wits.ksw.settings.alsid7.layout_two.AlsID7SetSystemTwo.AnonymousClass3 */
        ...
        this.rdg_shext.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            /* class com.wits.ksw.settings.alsid7.layout_two.AlsID7SetSystemTwo.AnonymousClass4 */
        ...
        this.tempRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            /* class com.wits.ksw.settings.alsid7.layout_two.AlsID7SetSystemTwo.AnonymousClass5 */
        ...
        this.fuelRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            /* class com.wits.ksw.settings.alsid7.layout_two.AlsID7SetSystemTwo.AnonymousClass6 */
        ...
        adapterMusic.setIFocusListener(new VerRecyclerAdapter.IFocusListener() {
            /* class com.wits.ksw.settings.alsid7.layout_two.AlsID7SetSystemTwo.AnonymousClass7 */
        ...
        adapterMusic.setAppsCheckListener(new VerRecyclerAdapter.IAppsCheckListener() {
            /* class com.wits.ksw.settings.alsid7.layout_two.AlsID7SetSystemTwo.AnonymousClass8 */
        ...
        adapterVideo.setAppsCheckListener(new VerRecyclerAdapter.IAppsCheckListener() {
            /* class com.wits.ksw.settings.alsid7.layout_two.AlsID7SetSystemTwo.AnonymousClass9 */
