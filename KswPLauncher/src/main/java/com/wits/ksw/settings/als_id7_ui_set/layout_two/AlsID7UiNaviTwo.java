...
import com.wits.ksw.settings.als_id7_ui_set.adapter.AlsID7UiNaviAdapter;
...
public class AlsID7UiNaviTwo extends RelativeLayout {
    private Context context;
    private LinearLayoutManager layoutManager;
    private List<MapBean> mapBanList;
    private AlsID7UiNaviAdapter naviAdapter;
    ...
    public AlsID7UiNaviTwo(Context context2) {
        super(context2);
        this.context = context2;
        View view = LayoutInflater.from(context2).inflate(R.layout.als_id7_ui_layout_set_navi_two, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        this.naviAdapter = new AlsID7UiNaviAdapter(this.context, this.mapBanList);
        ...
        this.naviAdapter.registCheckListener(new AlsID7UiNaviAdapter.IrbtCheckListener() {
            /* class com.wits.ksw.settings.als_id7_ui_set.layout_two.AlsID7UiNaviTwo.AnonymousClass1 */

            @Override // com.wits.ksw.settings.als_id7_ui_set.adapter.AlsID7UiNaviAdapter.IrbtCheckListener
            public void checkListener(int pos) {
                MapBean mapBean = (MapBean) AlsID7UiNaviTwo.this.mapBanList.get(pos);
                if (mapBean != null) {
                    FileUtils.savaStringData(KeyConfig.NAVI_DEFUAL, mapBean.getPackageName());
                    mapBean.setCheck(true);
                    Settings.System.putString(AlsID7UiNaviTwo.this.context.getContentResolver(), "wits_freedom_pkg", mapBean.getPackageName());
                }
            }
        });
        ...
        this.rdg_naviv.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            /* class com.wits.ksw.settings.als_id7_ui_set.layout_two.AlsID7UiNaviTwo.AnonymousClass2 */

            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    case R.id.rdb_naviv1 /*{ENCODED_INT: 2131232312}*/:
                        FileUtils.savaIntData(KeyConfig.NAVI_VOICE_MIX, 0);
                        return;
                    case R.id.rdb_naviv2 /*{ENCODED_INT: 2131232313}*/:
                        FileUtils.savaIntData(KeyConfig.NAVI_VOICE_MIX, 1);
                        return;
                    case R.id.rdb_naviv3 /*{ENCODED_INT: 2131232314}*/:
                        FileUtils.savaIntData(KeyConfig.NAVI_VOICE_MIX, 2);
                        return;
                    case R.id.rdb_naviv4 /*{ENCODED_INT: 2131232315}*/:
                        FileUtils.savaIntData(KeyConfig.NAVI_VOICE_MIX, 3);
                        return;
                    case R.id.rdb_naviv5 /*{ENCODED_INT: 2131232316}*/:
                        FileUtils.savaIntData(KeyConfig.NAVI_VOICE_MIX, 4);
                        return;
                    case R.id.rdb_naviv6 /*{ENCODED_INT: 2131232317}*/:
