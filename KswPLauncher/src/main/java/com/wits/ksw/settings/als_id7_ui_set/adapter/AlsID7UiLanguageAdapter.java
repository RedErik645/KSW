...
public class AlsID7UiLanguageAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public AlsID7UiLanguageAdapter(Context context2, List<FunctionBean> appInfoList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(this.context).inflate(R.layout.als_id7_ui_list_settings_language, viewGroup, false));
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.img_functionItem.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.settings.als_id7_ui_set.adapter.AlsID7UiLanguageAdapter.AnonymousClass1 */

            public void onClick(View v) {
                if (AlsID7UiLanguageAdapter.this.functionClickListener != null) {
                    AlsID7UiLanguageAdapter.this.functionClickListener.functonClick(position);
                }
            }
        });
