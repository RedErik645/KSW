...
public class AudiSettingViewModel extends AndroidViewModel {
    ...
    public RadioGroup.OnCheckedChangeListener on24HourChangeListener = new RadioGroup.OnCheckedChangeListener() {
        /* class com.wits.ksw.settings.audi.vm.AudiSettingViewModel.AnonymousClass2 */
    ...
    public RadioGroup.OnCheckedChangeListener onTimeMoedlChangeListener = new RadioGroup.OnCheckedChangeListener() {
        /* class com.wits.ksw.settings.audi.vm.AudiSettingViewModel.AnonymousClass3 */
    ...
    public AudiSettingViewModel(Application application) {
        ...
        PowerManagerApp.registerIContentObserver("mcuVerison", new IContentObserver.Stub() {
            /* class com.wits.ksw.settings.audi.vm.AudiSettingViewModel.AnonymousClass1 */

            @Override // com.wits.pms.IContentObserver
            public void onChange() throws RemoteException {
                new Handler().post(new Runnable() {
                    /* class com.wits.ksw.settings.audi.vm.AudiSettingViewModel.AnonymousClass1.AnonymousClass1 */
