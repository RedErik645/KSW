...
public class AlsID7UiSetFactoryLayout extends RelativeLayout implements View.OnClickListener {
    ...
    public AlsID7UiSetFactoryLayout(Context context2, Handler handler2) {
        super(context2);
        this.context = context2;
        this.handler = handler2;
        View view = LayoutInflater.from(context2).inflate(R.layout.als_id7_ui_layout_set_factory, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        this.img_del.setOnLongClickListener(new View.OnLongClickListener() {
            /* class com.wits.ksw.settings.als_id7_ui_set.layout_one.AlsID7UiSetFactoryLayout.AnonymousClass1 */

            public boolean onLongClick(View view) {
                if (AlsID7UiSetFactoryLayout.this.pwdInput.length() <= 0) {
                    return true;
                }
                AlsID7UiSetFactoryLayout.this.pwdInput.delete(0, AlsID7UiSetFactoryLayout.this.pwdInput.length());
                AlsID7UiSetFactoryLayout.this.tv_showPwd.setText(AlsID7UiSetFactoryLayout.this.pwdInput.toString());
                return true;
            }
        });
    }
