...
public class FunctionAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(this.context).inflate(R.layout.list_settings_function, viewGroup, false));
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        if (this.data.get(position).isIscheck()) {
            holder.tv_functionItem.setTextColor(SupportMenu.CATEGORY_MASK);
        } else {
            holder.tv_functionItem.setTextColor(-1);
        }
        holder.relat_functionItem.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.settings.id7.adapter.FunctionAdapter.AnonymousClass1 */
        ...
        holder.relat_functionItem.setOnKeyListener(new View.OnKeyListener() {
            /* class com.wits.ksw.settings.id7.adapter.FunctionAdapter.AnonymousClass2 */
