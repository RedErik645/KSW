...
public class BmwId8GsSettingsMainActivity extends BaseSkinActivity {
    ...
    private ContentObserver contentObserver = new ContentObserver(new Handler()) {
        /* class com.wits.ksw.settings.bmw_id8.activity.BmwId8GsSettingsMainActivity.AnonymousClass1 */
    ...
    private BaseQuickAdapter.OnItemClickListener mOnItemClickListener = new BaseQuickAdapter.OnItemClickListener() {
        /* class com.wits.ksw.settings.bmw_id8.activity.BmwId8GsSettingsMainActivity.AnonymousClass4 */
    ...
    private void initView() {
        ...
        this.mAdapter.setItemClickListener(new BmwId8SettingsMainAdapter.ItemClickListener() {
            /* class com.wits.ksw.settings.bmw_id8.activity.BmwId8GsSettingsMainActivity.AnonymousClass2 */
        ...
        this.mItemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.Callback() {
            /* class com.wits.ksw.settings.bmw_id8.activity.BmwId8GsSettingsMainActivity.AnonymousClass3 */
        ...
        switch (c) {
            case 0:
                ...
                linearLayout.setOnClickListener(new View.OnClickListener() {
                    /* class com.wits.ksw.settings.bmw_id8.activity.BmwId8GsSettingsMainActivity.AnonymousClass5 */

                    public void onClick(View view) {
                        BmwId8GsSettingsMainActivity.this.bmwId8ViewModel.openNaviApp();
                    }
                });
                break;
            case 1:
                ...
                linearLayout.setOnClickListener(new View.OnClickListener() {
                    /* class com.wits.ksw.settings.bmw_id8.activity.BmwId8GsSettingsMainActivity.AnonymousClass6 */

                    public void onClick(View view) {
                        BmwId8GsSettingsMainActivity.this.bmwId8ViewModel.openMusicMulti(view);
                    }
                });
                break;
            case 2:
                ...
                linearLayout.setOnClickListener(new View.OnClickListener() {
                    /* class com.wits.ksw.settings.bmw_id8.activity.BmwId8GsSettingsMainActivity.AnonymousClass7 */

                    public void onClick(View view) {
                        BmwId8GsSettingsMainActivity.this.bmwId8ViewModel.openCar(view);
                    }
                });
                break;
            case 3:
                ...
                linearLayout.setOnClickListener(new View.OnClickListener() {
                    /* class com.wits.ksw.settings.bmw_id8.activity.BmwId8GsSettingsMainActivity.AnonymousClass8 */

                    public void onClick(View view) {
                        BmwId8GsSettingsMainActivity.this.bmwId8ViewModel.openBtApp(view);
                    }
                });
                break;
            case 4:
                ...
                linearLayout.setOnClickListener(new View.OnClickListener() {
                    /* class com.wits.ksw.settings.bmw_id8.activity.BmwId8GsSettingsMainActivity.AnonymousClass9 */

                    public void onClick(View view) {
                        BmwId8GsSettingsMainActivity.this.bmwId8ViewModel.openWeatherApp(view);
                    }
                });
                break;
            case 5:
                ...
                linearLayout.setOnClickListener(new View.OnClickListener() {
                    /* class com.wits.ksw.settings.bmw_id8.activity.BmwId8GsSettingsMainActivity.AnonymousClass10 */

                    public void onClick(View view) {
                        BmwId8GsSettingsMainActivity.this.bmwId8ViewModel.enterGsChangeModus(view);
                    }
                });
                break;
            case 6:
                ...
                linearLayout.setOnClickListener(new View.OnClickListener() {
                    /* class com.wits.ksw.settings.bmw_id8.activity.BmwId8GsSettingsMainActivity.AnonymousClass11 */

                    public void onClick(View view) {
                        BmwId8GsSettingsMainActivity.this.bmwId8ViewModel.openDashboard(view);
                    }
                });
                break;
            case 7:
                ...
                linearLayout.setOnClickListener(new View.OnClickListener() {
                    /* class com.wits.ksw.settings.bmw_id8.activity.BmwId8GsSettingsMainActivity.AnonymousClass12 */

                    public void onClick(View view) {
                        BmwId8GsSettingsMainActivity.this.bmwId8ViewModel.openSettings(view);
                    }
                });
                break;
            case '\b':
                ...
                linearLayout.setOnClickListener(new View.OnClickListener() {
                    /* class com.wits.ksw.settings.bmw_id8.activity.BmwId8GsSettingsMainActivity.AnonymousClass13 */

                    public void onClick(View view) {
                        BmwId8GsSettingsMainActivity.this.bmwId8ViewModel.openVideoMulti(view);
                    }
                });
                break;
        }
