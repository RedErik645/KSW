...
public class AlsId7UiSettingsActivity extends BaseSkinActivity implements AlsID7UiIUpdateTwoLayout, ScanNaviList.OnMapListScanListener {
    ...
    Handler handler = new Handler() {
        /* class com.wits.ksw.settings.als_id7_ui_set.AlsId7UiSettingsActivity.AnonymousClass1 */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_als_id7_ui_settings);
        initData();
        initView();
    }
    ...
    private void initView() {
        ...
        this.adapter.registOnFunctionClickListener(new AlsID7UiFunctionAdapter.OnFunctionClickListener() {
            /* class com.wits.ksw.settings.als_id7_ui_set.AlsId7UiSettingsActivity.AnonymousClass2 */
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.settings.als_id7_ui_set.AlsId7UiSettingsActivity.AnonymousClass3 */
