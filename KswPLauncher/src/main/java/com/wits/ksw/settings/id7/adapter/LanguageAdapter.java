...
public class LanguageAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(this.context).inflate(R.layout.list_settings_language, viewGroup, false));
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.img_functionItem.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.settings.id7.adapter.LanguageAdapter.AnonymousClass1 */
