...
public class AlsID7SetVoiceLayout extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public AlsID7SetVoiceLayout(Context context2) {
        super(context2);
        this.context = context2;
        View view = LayoutInflater.from(context2).inflate(R.layout.als_layout_set_voice, (ViewGroup) null);
    ...
    private void initData() {
        ...
        getContext().getContentResolver().registerContentObserver(Settings.System.getUriFor(KeyConfig.ANDROID_MEDIA_VOL), true, new ContentObserver(new Handler()) {
            /* class com.wits.ksw.settings.alsid7.layout_one.AlsID7SetVoiceLayout.AnonymousClass1 */

            public void onChange(boolean selfChange) {
                try {
                    AlsID7SetVoiceLayout.this.seek_mtb.setProgress(PowerManagerApp.getSettingsInt(KeyConfig.ANDROID_MEDIA_VOL));
