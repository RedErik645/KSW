...
public class LexusSetLanguageLayout extends RelativeLayout {
    ...
    private void initView(View view) {
        ...
        this.adapter.registOnFunctionClickListener(new LanguageAdapter.OnFunctionClickListener() {
            /* class com.wits.ksw.settings.lexus.layout_one.LexusSetLanguageLayout.AnonymousClass1 */
            ...
            public void functonClick(int pos) {
                ...
                ((FunctionBean) LexusSetLanguageLayout.this.data.get(pos)).setIscheck(true);
                LexusSetLanguageLayout.this.adapter.notifyDataSetChanged();
                try {
