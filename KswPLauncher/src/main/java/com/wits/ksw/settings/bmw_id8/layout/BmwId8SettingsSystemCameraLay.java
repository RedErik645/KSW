...
public class BmwId8SettingsSystemCameraLay extends RelativeLayout {
    ...
    private int[] relativeLayoutId = {R.id.bmw_id8_settings_system_camera_after, R.id.bmw_id8_settings_system_camera_oem, R.id.bmw_id8_settings_system_camera_360, R.id.bmw_id8_settings_system_camera_360_built};

    public BmwId8SettingsSystemCameraLay(Context context2) {
        super(context2);
        this.context = context2;
        this.mBinding = (BmwId8SettingsSystemCameraLayoutBinding) DataBindingUtil.inflate(LayoutInflater.from(context2), R.layout.bmw_id8_settings_system_camera_layout, null, false);
    ...
    private void initView() {
        try {
            this.mBinding.getRoot().getViewTreeObserver().addOnGlobalFocusChangeListener(new ViewTreeObserver.OnGlobalFocusChangeListener() {
                /* class com.wits.ksw.settings.bmw_id8.layout.BmwId8SettingsSystemCameraLay.AnonymousClass1 */
            ...
            while (true) {
                ...
                if (i < iArr.length) {
                    findViewById(iArr[i]).setOnTouchListener(new View.OnTouchListener() {
                        /* class com.wits.ksw.settings.bmw_id8.layout.BmwId8SettingsSystemCameraLay.AnonymousClass2 */
