...
public class ID6VoiceModel extends RelativeLayout implements SeekBar.OnSeekBarChangeListener, View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_eqgud /*{ENCODED_INT: 2131232726}*/:
                ...
                this.tv_eqwuq.setTextColor(ContextCompat.getColor(this.context, R.color.color1));
                return;
            case R.id.tv_eqjues /*{ENCODED_INT: 2131232727}*/:
                ...
                this.tv_eqwuq.setTextColor(ContextCompat.getColor(this.context, R.color.color1));
                return;
            case R.id.tv_eqliux /*{ENCODED_INT: 2131232728}*/:
                ...
                this.tv_eqwuq.setTextColor(ContextCompat.getColor(this.context, R.color.color1));
                return;
            case R.id.tv_eqwuq /*{ENCODED_INT: 2131232729}*/:
                ...
                this.tv_eqwuq.setTextColor(ContextCompat.getColor(this.context, R.color.text_red));
                return;
            case R.id.tv_eqyaog /*{ENCODED_INT: 2131232730}*/:
                ...
                this.tv_eqwuq.setTextColor(ContextCompat.getColor(this.context, R.color.color1));
                return;
            case R.id.tv_eqyongh /*{ENCODED_INT: 2131232731}*/:
