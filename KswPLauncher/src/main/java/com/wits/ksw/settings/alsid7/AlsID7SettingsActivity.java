...
public class AlsID7SettingsActivity extends BaseSkinActivity implements IUpdateTwoLayout, ScanNaviList.OnMapListScanListener {
    ...
    Handler handler = new Handler() {
        /* class com.wits.ksw.settings.alsid7.AlsID7SettingsActivity.AnonymousClass1 */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_als_id7_settings);
        initData();
        initView();
    }
    ...
    private void initView() {
        ...
        this.adapter.registOnFunctionClickListener(new AlsID7FunctionAdapter.OnFunctionClickListener() {
            /* class com.wits.ksw.settings.alsid7.AlsID7SettingsActivity.AnonymousClass2 */
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.settings.alsid7.AlsID7SettingsActivity.AnonymousClass3 */
