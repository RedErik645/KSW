...
public class AlsID7UiFactoryActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_als_id7_ui_factory);
        initData();
        initLayout();
        initView();
    }
    ...
    private void initData() {
        ...
        for (String str : getResources().getStringArray(R.array.set_factory)) {
    ...
    private void initView() {
        ...
        this.adapter.registOnFunctionClickListener(new AlsID7UiFunctionAdapter.OnFunctionClickListener() {
            /* class com.wits.ksw.settings.als_id7_ui_set.AlsID7UiFactoryActivity.AnonymousClass1 */
