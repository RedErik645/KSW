...
public class LandroverSettingsActivity extends BaseActivity implements IUpdateTwoLayout, ScanNaviList.OnMapListScanListener {
    ...
    Handler handler = new Handler() {
        /* class com.wits.ksw.settings.land_rover.LandroverSettingsActivity.AnonymousClass1 */
    ...
    private void initView() {
        ...
        this.adapter.registOnFunctionClickListener(new LandroverFunctionAdapter.OnFunctionClickListener() {
            /* class com.wits.ksw.settings.land_rover.LandroverSettingsActivity.AnonymousClass2 */
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.settings.land_rover.LandroverSettingsActivity.AnonymousClass3 */
