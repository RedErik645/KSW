...
import com.wits.ksw.settings.id7.adapter.LanguageAdapter;
...
public class SetLanguageLayout extends RelativeLayout {
    ...
    private void initView(View view) {
        ...
        this.adapter.registOnFunctionClickListener(new LanguageAdapter.OnFunctionClickListener() {
            /* class com.wits.ksw.settings.id7.layout_one.SetLanguageLayout.AnonymousClass1 */

            @Override // com.wits.ksw.settings.id7.adapter.LanguageAdapter.OnFunctionClickListener
