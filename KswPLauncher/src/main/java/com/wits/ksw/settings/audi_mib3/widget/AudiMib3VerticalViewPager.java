...
public class AudiMib3VerticalViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new Comparator<ItemInfo>() {
        /* class com.wits.ksw.settings.audi_mib3.widget.AudiMib3VerticalViewPager.AnonymousClass1 */
    ...
    private static final Interpolator sInterpolator = new Interpolator() {
        /* class com.wits.ksw.settings.audi_mib3.widget.AudiMib3VerticalViewPager.AnonymousClass2 */
    ...
    private final Runnable mEndScrollRunnable = new Runnable() {
        /* class com.wits.ksw.settings.audi_mib3.widget.AudiMib3VerticalViewPager.AnonymousClass3 */
    ...
    /* JADX INFO: Multiple debug info for r0v19 float: [D('topHeightNeeded' float), D('extraHeightBottom' float)] */
    /* access modifiers changed from: package-private */
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new ParcelableCompatCreatorCallbacks<SavedState>() {
            /* class com.wits.ksw.settings.audi_mib3.widget.AudiMib3VerticalViewPager.SavedState.AnonymousClass1 */
    ...
    /* JADX INFO: Multiple debug info for r3v6 int: [D('height' int), D('childTop' int)] */
    /* access modifiers changed from: protected */
                    ...
                    if (child2.getVisibility() != i2) {
                        ...
                        if (!lp2.isDecor) {
                            ...
                            if (ii != null) {
                                count = count2;
                                height = height2;
                                int childTop3 = paddingTop2 + ((int) (((float) childHeight) * ii.offset));
                                if (lp2.needsMeasure) {
                                ...
                                child2.layout(paddingLeft2, childTop3, child2.getMeasuredWidth() + paddingLeft2, child2.getMeasuredHeight() + childTop3);
                            } else {
                                height = height2;
                                paddingTop = paddingTop2;
                                paddingBottom = paddingBottom2;
    ...
    private boolean performDrag(float y) {
        boolean needsInvalidate = false;
        this.mLastMotionY = y;
        float scrollY = ((float) getScrollY()) + (this.mLastMotionY - y);
        int height = getClientHeight();
    ...
    public boolean canScroll(View v, boolean checkV, int dy, int x, int y) {
        ...
        if (checkV) {
            if (ViewCompat.canScrollVertically(v, -dy)) {
                return true;
            }
        }
        return false;
