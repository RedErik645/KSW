...
public class AlsID7UiSetSystemInfoLayout extends RelativeLayout implements View.OnClickListener {
    ...
    Handler handler = new Handler() {
        /* class com.wits.ksw.settings.als_id7_ui_set.layout_one.AlsID7UiSetSystemInfoLayout.AnonymousClass1 */

        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            if (msg.what == 0) {
                try {
                    AlsID7UiSetSystemInfoLayout.this.tv_infoMcuv.setText(String.format(AlsID7UiSetSystemInfoLayout.this.getResources().getString(R.string.text_8), McuUtil.getMcuVersion()));
                } catch (Exception e) {
                    e.getStackTrace();
                }
            } else if (msg.what == 1) {
    ...
    private void initView(View view) {
        ...
        PowerManagerApp.registerIContentObserver("mcuVerison", new IContentObserver.Stub() {
            /* class com.wits.ksw.settings.als_id7_ui_set.layout_one.AlsID7UiSetSystemInfoLayout.AnonymousClass2 */
        ...
        this.tv_infoSysv.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.settings.als_id7_ui_set.layout_one.AlsID7UiSetSystemInfoLayout.AnonymousClass3 */
        ...
        this.tv_infoCpu.post(new Runnable() {
            /* class com.wits.ksw.settings.als_id7_ui_set.layout_one.AlsID7UiSetSystemInfoLayout.AnonymousClass4 */

            public void run() {
                AlsID7UiSetSystemInfoLayout.this.tv_infoCpu.setSelected(true);
            }
        });
