...
public class ID6SetSystemLayout extends RelativeLayout implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private final Runnable mUpdateSliderRunnable = new Runnable() {
        /* class com.wits.ksw.settings.id6.oneLayout.ID6SetSystemLayout.AnonymousClass2 */
    ...
    private void initView(View view) {
        ...
        this.seekbar_brightness.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            /* class com.wits.ksw.settings.id6.oneLayout.ID6SetSystemLayout.AnonymousClass1 */
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.id6_sysFuelUnit /*{ENCODED_INT: 2131231614}*/:
                this.updateTwoLayout.updateTwoLayout(1, 4);
                return;
            case R.id.id6_sysTempUnit /*{ENCODED_INT: 2131231615}*/:
