...
public class AudiSelThirdAppActivity extends AudiSubActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        AudiSelThirdCls bindingCls = (AudiSelThirdCls) DataBindingUtil.inflate(LayoutInflater.from(this), R.layout.audi_sel_third_app_layout, null, false);
        ...
        adapterMusic.setAppsCheckListener(new VerRecyclerAdapter.IAppsCheckListener() {
            /* class com.wits.ksw.settings.audi.AudiSelThirdAppActivity.AnonymousClass1 */
        ...
        adapterVideo.setAppsCheckListener(new VerRecyclerAdapter.IAppsCheckListener() {
            /* class com.wits.ksw.settings.audi.AudiSelThirdAppActivity.AnonymousClass2 */
