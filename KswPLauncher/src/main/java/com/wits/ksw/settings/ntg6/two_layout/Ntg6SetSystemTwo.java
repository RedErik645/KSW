...
public class Ntg6SetSystemTwo extends RelativeLayout {
    ...
    private final Runnable mUpdateSliderRunnable = new Runnable() {
        /* class com.wits.ksw.settings.ntg6.two_layout.Ntg6SetSystemTwo.AnonymousClass12 */
    ...
    private void initView(View view) {
        ...
        this.seekbar_caux.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            /* class com.wits.ksw.settings.ntg6.two_layout.Ntg6SetSystemTwo.AnonymousClass1 */
        ...
        this.seekbar_caux2.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            /* class com.wits.ksw.settings.ntg6.two_layout.Ntg6SetSystemTwo.AnonymousClass2 */
        ...
        this.seekbar_brightness.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            /* class com.wits.ksw.settings.ntg6.two_layout.Ntg6SetSystemTwo.AnonymousClass3 */
        ...
        this.rdb_shext4 = (RtlRadioButton) view.findViewById(R.id.rdb_shext4);
        switch (this.groupValue) {
            ...
            case 2:
                ...
                break;
            case 3:
                this.rdg_shext.check(R.id.rdb_shext4);
                break;
        }
        this.rdb_shext1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            /* class com.wits.ksw.settings.ntg6.two_layout.Ntg6SetSystemTwo.AnonymousClass4 */
        ...
        this.rdb_shext2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            /* class com.wits.ksw.settings.ntg6.two_layout.Ntg6SetSystemTwo.AnonymousClass5 */
        ...
        this.rdb_shext3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            /* class com.wits.ksw.settings.ntg6.two_layout.Ntg6SetSystemTwo.AnonymousClass6 */
        ...
        this.rdb_shext4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            /* class com.wits.ksw.settings.ntg6.two_layout.Ntg6SetSystemTwo.AnonymousClass7 */
        ...
        this.img_TwoBack.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.settings.ntg6.two_layout.Ntg6SetSystemTwo.AnonymousClass8 */
        ...
        this.rdgTempUnitRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            /* class com.wits.ksw.settings.ntg6.two_layout.Ntg6SetSystemTwo.AnonymousClass9 */
        ...
        adapterMusic.setAppsCheckListener(new VerRecyclerAdapter.IAppsCheckListener() {
            /* class com.wits.ksw.settings.ntg6.two_layout.Ntg6SetSystemTwo.AnonymousClass10 */
        ...
        adapterVideo.setAppsCheckListener(new VerRecyclerAdapter.IAppsCheckListener() {
            /* class com.wits.ksw.settings.ntg6.two_layout.Ntg6SetSystemTwo.AnonymousClass11 */
