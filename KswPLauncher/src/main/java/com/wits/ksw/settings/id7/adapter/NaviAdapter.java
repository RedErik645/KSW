...
public class NaviAdapter extends RecyclerView.Adapter<MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new MyViewHolder(LayoutInflater.from(this.context).inflate(R.layout.navi_adpter_layout, viewGroup, false));
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        if (this.rbtCheckListener != null) {
            holder.rbt_navi.setOnClickListener(new View.OnClickListener() {
                /* class com.wits.ksw.settings.id7.adapter.NaviAdapter.AnonymousClass1 */
        ...
        holder.rbt_navi.setOnKeyListener(new View.OnKeyListener() {
            /* class com.wits.ksw.settings.id7.adapter.NaviAdapter.AnonymousClass2 */
