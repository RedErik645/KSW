...
public class AlsID7UiLogoSelect extends FrameLayout {
    ...
    private void initView() {
        ...
        this.adapter.registOnFunctionClickListener(new AlsID7UiUiSelectAdapter.OnFunctionClickListener() {
            /* class com.wits.ksw.settings.als_id7_ui_set.factory.AlsID7UiLogoSelect.AnonymousClass1 */
        ...
        this.siRenAdapter.registOnFunctionClickListener(new AlsID7UiUiSelectAdapter.OnFunctionClickListener() {
            /* class com.wits.ksw.settings.als_id7_ui_set.factory.AlsID7UiLogoSelect.AnonymousClass2 */
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.settings.als_id7_ui_set.factory.AlsID7UiLogoSelect.AnonymousClass3 */
        ...
        textView2.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.settings.als_id7_ui_set.factory.AlsID7UiLogoSelect.AnonymousClass4 */
        ...
        textView3.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.settings.als_id7_ui_set.factory.AlsID7UiLogoSelect.AnonymousClass5 */
