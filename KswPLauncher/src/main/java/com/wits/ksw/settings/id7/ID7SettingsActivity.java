...
public class ID7SettingsActivity extends BaseActivity implements IUpdateTwoLayout, ScanNaviList.OnMapListScanListener {
    ...
    Handler handler = new Handler() {
        /* class com.wits.ksw.settings.id7.ID7SettingsActivity.AnonymousClass1 */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_id7_settings);
        initData();
        initView();
    }
    ...
    private void initView() {
        ...
        this.adapter.registOnFunctionClickListener(new FunctionAdapter.OnFunctionClickListener() {
            /* class com.wits.ksw.settings.id7.ID7SettingsActivity.AnonymousClass2 */
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.settings.id7.ID7SettingsActivity.AnonymousClass3 */
