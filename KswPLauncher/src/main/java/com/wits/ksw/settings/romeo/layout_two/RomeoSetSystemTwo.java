...
public class RomeoSetSystemTwo extends RelativeLayout {
    ...
    private final Runnable mUpdateSliderRunnable = new Runnable() {
        /* class com.wits.ksw.settings.romeo.layout_two.RomeoSetSystemTwo.AnonymousClass14 */
    ...
    private void initView(View view) {
        ...
        this.seekbar_caux.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            /* class com.wits.ksw.settings.romeo.layout_two.RomeoSetSystemTwo.AnonymousClass1 */
        ...
        this.seekbar_caux2.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            /* class com.wits.ksw.settings.romeo.layout_two.RomeoSetSystemTwo.AnonymousClass2 */
        ...
        this.seekbar_brightness.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            /* class com.wits.ksw.settings.romeo.layout_two.RomeoSetSystemTwo.AnonymousClass3 */
        ...
        this.rdg_shext.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            /* class com.wits.ksw.settings.romeo.layout_two.RomeoSetSystemTwo.AnonymousClass4 */
        ...
        for (final int i = 0; i < this.rdg_shext.getChildCount(); i++) {
            this.rdg_shext.getChildAt(i).setOnTouchListener(new View.OnTouchListener() {
                /* class com.wits.ksw.settings.romeo.layout_two.RomeoSetSystemTwo.AnonymousClass5 */
            ...
            this.rdg_shext.getChildAt(i).setOnFocusChangeListener(new View.OnFocusChangeListener() {
                /* class com.wits.ksw.settings.romeo.layout_two.RomeoSetSystemTwo.AnonymousClass6 */

                public void onFocusChange(View view, boolean b) {
                    int i = i;
                    int i2 = 0;
                    if (i == 0) {
                        ImageView imageView = RomeoSetSystemTwo.this.romeo_list_r1;
                        if (!b) {
                            i2 = 4;
                        }
                        imageView.setVisibility(i2);
                    } else if (i == 1) {
                        ImageView imageView2 = RomeoSetSystemTwo.this.romeo_list_r2;
                        if (!b) {
                            i2 = 4;
                        }
                        imageView2.setVisibility(i2);
                    } else if (i == 2) {
                        ImageView imageView3 = RomeoSetSystemTwo.this.romeo_list_r3;
                        if (!b) {
                            i2 = 4;
                        }
        ...
        for (final int i2 = 0; i2 < this.tempRadioGroup.getChildCount(); i2++) {
            if (i2 == this.tempUnit) {
            ...
            this.tempRadioGroup.getChildAt(i2).setOnTouchListener(new View.OnTouchListener() {
                /* class com.wits.ksw.settings.romeo.layout_two.RomeoSetSystemTwo.AnonymousClass7 */
            ...
            this.tempRadioGroup.getChildAt(i2).setOnFocusChangeListener(new View.OnFocusChangeListener() {
                /* class com.wits.ksw.settings.romeo.layout_two.RomeoSetSystemTwo.AnonymousClass8 */
        ...
        this.tempRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            /* class com.wits.ksw.settings.romeo.layout_two.RomeoSetSystemTwo.AnonymousClass9 */
        ...
        adapterMusic.setAppsCheckListener(new VerRecyclerAdapter.IAppsCheckListener() {
            /* class com.wits.ksw.settings.romeo.layout_two.RomeoSetSystemTwo.AnonymousClass10 */
        ...
        adapterVideo.setAppsCheckListener(new VerRecyclerAdapter.IAppsCheckListener() {
            /* class com.wits.ksw.settings.romeo.layout_two.RomeoSetSystemTwo.AnonymousClass11 */
    ...
    private void changeItemBg(final ViewGroup viewGroup, Context context2) {
        ...
        for (final int i = 0; i < viewGroup.getChildCount(); i++) {
            viewGroup.getChildAt(i).setOnTouchListener(new View.OnTouchListener() {
                /* class com.wits.ksw.settings.romeo.layout_two.RomeoSetSystemTwo.AnonymousClass12 */

                public boolean onTouch(View view, MotionEvent motionEvent) {
                    Log.d(RomeoSetSystemTwo.TAG, "changeItemBg onTouch i=" + i + " action=" + motionEvent.getAction());
                    int[] locW = new int[2];
            ...
            viewGroup.getChildAt(i).setOnFocusChangeListener(new View.OnFocusChangeListener() {
                /* class com.wits.ksw.settings.romeo.layout_two.RomeoSetSystemTwo.AnonymousClass13 */

                public void onFocusChange(View view, boolean b) {
                    if (b) {
                        Log.d(RomeoSetSystemTwo.TAG, "changeItemBg onFocusChange i=" + i + " downY=" + RomeoSetSystemTwo.this.downY);
                        int[] locW = new int[2];
                        viewGroup.getChildAt(i).getLocationInWindow(locW);
