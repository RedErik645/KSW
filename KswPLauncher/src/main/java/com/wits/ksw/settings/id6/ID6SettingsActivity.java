...
public class ID6SettingsActivity extends BaseActivity implements IUpdateTwoLayout, ScanNaviList.OnMapListScanListener {
    ...
    Handler handler = new Handler() {
        /* class com.wits.ksw.settings.id6.ID6SettingsActivity.AnonymousClass2 */
    ...
    Handler handlerUI = new Handler() {
        /* class com.wits.ksw.settings.id6.ID6SettingsActivity.AnonymousClass1 */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_id6_settings);
        initData();
    ...
    private void initData() {
        ...
        for (String str : getResources().getStringArray(R.array.set_id6_function)) {
    ...
    private void initView() {
        ...
        this.adapter.registOnFunctionClickListener(new ID6FunctionAdapter.OnFunctionClickListener() {
            /* class com.wits.ksw.settings.id6.ID6SettingsActivity.AnonymousClass3 */
        ...
        this.img_Back.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.settings.id6.ID6SettingsActivity.AnonymousClass4 */
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void fousceLayout(int pos) {
        this.relat_Show.removeAllViews();
        switch (pos) {
            case 0:
                if (this.id6ShowNavi == null) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void funCheckLayout(int pos) {
        checkView();
