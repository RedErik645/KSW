...
public class AlsID7SetSystemLayout extends RelativeLayout implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public AlsID7SetSystemLayout(Context context2) {
        super(context2);
        this.context = context2;
        View view = LayoutInflater.from(context2).inflate(R.layout.als_layout_set_system, (ViewGroup) null);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.tv_music_app /*{ENCODED_INT: 2131232767}*/:
                this.tv_music_app.setTextColor(getResources().getColor(R.color.alsid7_text_bule, null));
                this.updateTwoLayout.updateTwoLayout(1, 6);
                return;
            case R.id.tv_sysBgld /*{ENCODED_INT: 2131232791}*/:
                this.tv_sysBgld.setTextColor(getResources().getColor(R.color.alsid7_text_bule, null));
            ...
            case R.id.tv_sysDcsxt /*{ENCODED_INT: 2131232793}*/:
                this.tv_sysDcsxt.setTextColor(getResources().getColor(R.color.alsid7_text_bule, null));
                this.updateTwoLayout.updateTwoLayout(1, 1);
                return;
            case R.id.tv_sysFuelUnit /*{ENCODED_INT: 2131232794}*/:
                this.fuelUnitView.setTextColor(getResources().getColor(R.color.alsid7_text_bule, null));
                this.updateTwoLayout.updateTwoLayout(1, 5);
                return;
            case R.id.tv_sysTempUnit /*{ENCODED_INT: 2131232795}*/:
                this.tempUnitView.setTextColor(getResources().getColor(R.color.alsid7_text_bule, null));
                this.updateTwoLayout.updateTwoLayout(1, 4);
                return;
            case R.id.tv_video_app /*{ENCODED_INT: 2131232809}*/:
                this.tv_video_app.setTextColor(getResources().getColor(R.color.alsid7_text_bule, null));
