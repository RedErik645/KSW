...
public class AlsID7LanguageAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public AlsID7LanguageAdapter(Context context2, List<FunctionBean> appInfoList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(this.context).inflate(R.layout.alsid7_list_settings_language, viewGroup, false));
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.img_functionItem.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.settings.alsid7.adapter.AlsID7LanguageAdapter.AnonymousClass1 */

            public void onClick(View v) {
                if (AlsID7LanguageAdapter.this.functionClickListener != null) {
                    AlsID7LanguageAdapter.this.functionClickListener.functonClick(position);
                }
            }
        });
