...
public class AlsID7UiSetVoiceLayout extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public AlsID7UiSetVoiceLayout(Context context2) {
        super(context2);
        this.context = context2;
        View view = LayoutInflater.from(context2).inflate(R.layout.als_id7_ui_layout_set_voice, (ViewGroup) null);
    ...
    private void initData() {
        ...
        contentResolver.registerContentObserver(Settings.System.getUriFor(KeyConfig.ANDROID_MEDIA_VOL), true, new ContentObserver(new Handler()) {
            /* class com.wits.ksw.settings.als_id7_ui_set.layout_one.AlsID7UiSetVoiceLayout.AnonymousClass1 */
        ...
        contentResolver.registerContentObserver(Settings.System.getUriFor(KeyConfig.ANDROID_PHONE_VOL), true, new ContentObserver(new Handler()) {
            /* class com.wits.ksw.settings.als_id7_ui_set.layout_one.AlsID7UiSetVoiceLayout.AnonymousClass2 */
