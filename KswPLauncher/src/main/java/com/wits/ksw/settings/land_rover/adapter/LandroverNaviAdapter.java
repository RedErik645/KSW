    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        if (this.rbtCheckListener != null) {
            holder.img_functionItem.setOnClickListener(new View.OnClickListener() {
                /* class com.wits.ksw.settings.land_rover.adapter.LandroverNaviAdapter.AnonymousClass1 */
        ...
        holder.img_functionItem.setOnKeyListener(new View.OnKeyListener() {
            /* class com.wits.ksw.settings.land_rover.adapter.LandroverNaviAdapter.AnonymousClass2 */
