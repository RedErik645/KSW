...
public class KswId7MainFirstFragment extends Fragment {
    ...
    private IContentObserver.Stub topAppContentObserver = new IContentObserver.Stub() {
        /* class com.wits.ksw.launcher.view.KswId7MainFirstFragment.AnonymousClass1 */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        KswId7MainPage1Fragment kswId7MainPage1Fragment = (KswId7MainPage1Fragment) DataBindingUtil.inflate(inflater, R.layout.ksw_id7_main_page1, null, false);
