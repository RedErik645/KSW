...
public class UgHomeFragmentOne extends Fragment implements View.OnFocusChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (UiThemeUtils.isCommon_UI_GS_UG_1024(getActivity())) {
            UgHomeOne2BindingImpl ugHomeOne2BindingImpl = (UgHomeOne2BindingImpl) DataBindingUtil.inflate(inflater, R.layout.ug_home_one2, null, false);
        ...
        UgHomeOneBindingImpl ugHomeOneBindingImpl = (UgHomeOneBindingImpl) DataBindingUtil.inflate(inflater, R.layout.ug_home_one, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (UiThemeUtils.isCommon_UI_GS_UG_1024(getActivity())) {
            ...
            this.mainActivity.select.observe(getActivity(), new Observer<UgPager>() {
                /* class com.wits.ksw.launcher.view.ug.UgHomeFragmentOne.AnonymousClass1 */
        ...
        this.mainActivity.select.observe(getActivity(), new Observer<UgPager>() {
            /* class com.wits.ksw.launcher.view.ug.UgHomeFragmentOne.AnonymousClass2 */
