...
public abstract class BaseThemeActivity extends AppCompatActivity {
    ...
    /* access modifiers changed from: protected */
    public abstract void initBenz_MBUX_2021_KSW_View_new();
    ...
    /* access modifiers changed from: protected */
    public abstract void initBenz_NTG6_FY_View_new();
    ...
    /* access modifiers changed from: protected */
    public abstract void initBmwId8PempUiView();
    ...
    /* access modifiers changed from: protected */
    public abstract void initEVOID8_UG();

    /* access modifiers changed from: protected */
    public abstract void initEVOID9_ALSUIView();
    ...
    /* access modifiers changed from: protected */
    public abstract void initRomeo_V2();
    ...
    /* access modifiers changed from: protected */
    public abstract void initUI_NTG6_FY_ViewV3();
        ...
        if (UiThemeUtils.isBenz_NTG6(this)) {
            ...
            if (!UiThemeUtils.isUI_NTG6_FY_V2(this) || !ClientManager.getInstance().isAls6208Client()) {
                if (UiThemeUtils.isUI_NTG6_FY_V3(this)) {
                    initUI_NTG6_FY_ViewV3();
                } else if (UiThemeUtils.isEVOID8_UG(this)) {
                    initEVOID8_UG();
                    ...
                    initEVOID9_ALSUIView();
                } else {
                    initBmwid7UiView();
                }
            } else if ((width == 1280 && height == 720) || (width == 1024 && height == 600)) {
