...
public class CustomCircleProgressView extends View {
    ...
    public void calculatePointerXYPosition() {
        ...
        if (!pm.getPosTan(pm.getLength(), this.mPointerPositionXY, null)) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        float touchEventRadius = (float) Math.sqrt(Math.pow((double) (this.mCircleRectF.centerX() - x), 2.0d) + Math.pow((double) (this.mCircleRectF.centerY() - y), 2.0d));
