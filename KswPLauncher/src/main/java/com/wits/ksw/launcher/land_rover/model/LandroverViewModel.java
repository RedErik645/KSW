...
public class LandroverViewModel extends LauncherViewModel {
    public View.OnFocusChangeListener btViewFocusChangeListener = new View.OnFocusChangeListener() {
        /* class com.wits.ksw.launcher.land_rover.model.LandroverViewModel.AnonymousClass2 */
    ...
    public View.OnFocusChangeListener settingsViewFocusChangeListener = new View.OnFocusChangeListener() {
        /* class com.wits.ksw.launcher.land_rover.model.LandroverViewModel.AnonymousClass1 */
    ...
    public static void sendKeyDownUpSync(final int key) {
        new Handler().post(new Runnable() {
            /* class com.wits.ksw.launcher.land_rover.model.LandroverViewModel.AnonymousClass3 */

            public void run() {
                new Thread(new Runnable() {
                    /* class com.wits.ksw.launcher.land_rover.model.LandroverViewModel.AnonymousClass3.AnonymousClass1 */
