...
public class BenzNtg6FyThemeActivity extends Activity {
    ...
    private View.OnClickListener mThemeItemClickListener = new View.OnClickListener() {
        /* class com.wits.ksw.launcher.view.benzntg6fy.BenzNtg6FyThemeActivity.AnonymousClass1 */

        public void onClick(View v) {
            LOGE.E("v.getId() = " + v.getId());
            switch (v.getId()) {
                case R.id.rb_benz_fy_bg1 /*{ENCODED_INT: 2131232281}*/:
                    ...
                    return;
                case R.id.rb_benz_fy_bg2 /*{ENCODED_INT: 2131232282}*/:
                    ...
                    MainActivity.mBenzNtgFyActivityNewBinding.layoutMainNtgFy.setBackgroundResource(BenzNtg6FyConfigs.BG_ONE[BenzNtg6FyConfigs.bg_sel - 1]);
                    return;
                case R.id.rb_benz_fy_bg3 /*{ENCODED_INT: 2131232283}*/:
                    ...
                    MainActivity.mBenzNtgFyActivityNewBinding.layoutMainNtgFy.setBackgroundResource(BenzNtg6FyConfigs.BG_ONE[BenzNtg6FyConfigs.bg_sel - 1]);
                    return;
                case R.id.rb_benz_fy_bg4 /*{ENCODED_INT: 2131232284}*/:
                    ...
                    MainActivity.mBenzNtgFyActivityNewBinding.layoutMainNtgFy.setBackgroundResource(BenzNtg6FyConfigs.BG_ONE[BenzNtg6FyConfigs.bg_sel - 1]);
                    return;
                case R.id.rb_benz_fy_bg5 /*{ENCODED_INT: 2131232285}*/:
                    ...
                    MainActivity.mBenzNtgFyActivityNewBinding.layoutMainNtgFy.setBackgroundResource(BenzNtg6FyConfigs.BG_ONE[BenzNtg6FyConfigs.bg_sel - 1]);
                    return;
                case R.id.rb_benz_fy_bg6 /*{ENCODED_INT: 2131232286}*/:
                    ...
                    MainActivity.mBenzNtgFyActivityNewBinding.layoutMainNtgFy.setBackgroundResource(BenzNtg6FyConfigs.BG_ONE[BenzNtg6FyConfigs.bg_sel - 1]);
                    return;
                case R.id.rb_benz_fy_bg7 /*{ENCODED_INT: 2131232287}*/:
                    ...
                    MainActivity.mBenzNtgFyActivityNewBinding.layoutMainNtgFy.setBackgroundResource(BenzNtg6FyConfigs.BG_ONE[BenzNtg6FyConfigs.bg_sel - 1]);
                    return;
                case R.id.rb_benz_fy_bg8 /*{ENCODED_INT: 2131232288}*/:
