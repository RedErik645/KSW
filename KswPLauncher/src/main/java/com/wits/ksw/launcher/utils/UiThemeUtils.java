...
public class UiThemeUtils {
    ...
    public static final String EVOID8_UG_2mode = "EVOID8_UG_2mode";
    public static final String EVOID9_ALS = "EVOID9_ALS";
    ...
    public static final String UI_NTG6_FY_V3 = "UI_NTG6_FY_V3";
    ...
    public static boolean isROMEO_UI_V2(Context context) {
        return TextUtils.equals(getUiName(context), ROMEO_UI_V2);
    }
    ...
    public static boolean isBenz_MBUX_2021(Context context) {
        return TextUtils.equals(getUiName(context), Benz_MBUX_2021) || isUI_MBUX_YO(context);
    }

    public static boolean isUI_MBUX_YO(Context context) {
        return TextUtils.equals(getUiName(context), UI_MBUX_YO);
    }
    ...
    public static boolean isUI_MBUX_2021_KSW_1024(Context context) {
        return TextUtils.equals(getUiName(context), UI_MBUX_2021_KSW_1024);
    }

    public static boolean isUI_MBUX_2021_KSW_1024_V2(Context context) {
        return TextUtils.equals(getUiName(context), UI_MBUX_2021_KSW_1024_V2);
    }
    ...
    public static boolean isUI_NTG6_FY_V3(Context context) {
        return TextUtils.equals(getUiName(context), UI_NTG6_FY_V3);
    }
    ...
    public static boolean isEVOID8_UG(Context context) {
        return TextUtils.equals(getUiName(context), EVOID8_UG_2mode);
    }
    ...
    public static boolean isUI_PEMP_ID8(Context context) {
        return TextUtils.equals(getUiName(context), UI_PEMP_ID8);
    }

    public static boolean isUI_EVOID9_ALS(Context context) {
        return TextUtils.equals(getUiName(context), EVOID9_ALS);
    }
    ...
    public static int getCarManufacturer(Context context) {
        ...
        if (isBenz_NTG5(context) || isBenz_GS(context) || isBenz_NTG6(context) || isBenz_MBUX(context) || isBenz_MBUX_2021(context) || isBenz_NTG6_FY(context) || isUI_NTG6_FY_V2(context) || isBenz_MBUX_2021_KSW(context) || isBenz_MBUX_2021_KSW_V2(context) || isUI_MBUX_2021_KSW_1024(context) || isUI_MBUX_2021_KSW_1024_V2(context) || isUI_NTG6_FY_V3(context)) {
            return 2;
        }
