...
public class ColorArcProgressBar extends View {
    ...
    private void initConfig(Context context, AttributeSet attrs) {
        ...
        int color1 = a.getColor(5, -16711936);
        int color2 = a.getColor(6, color1);
        int color3 = a.getColor(7, color1);
        this.bgArcColor = a.getColor(0, -15658735);
        this.longDegreeColor = a.getColor(4, -15658735);
        this.shortDegreeColor = a.getColor(4, -15658735);
        this.hintColor = a.getColor(9, -10000537);
        this.colors = new int[]{color1, color2, color3, color3};
        this.sweepAngle = (float) a.getInteger(18, Constants.DEFAULT_START_ANGLE);
        this.startAngle = (float) a.getInteger(2, WitsCommand.SystemCommand.ST_SWITCH);
        this.bgArcWidth = a.getDimension(1, (float) dipToPx(10.0f));
        this.progressWidth = a.getDimension(8, (float) dipToPx(10.0f));
        this.seekEnable = a.getBoolean(14, false);
        this.isNeedTitle = a.getBoolean(12, false);
        this.isNeedContent = a.getBoolean(10, false);
        this.isNeedUnit = a.getBoolean(13, false);
        this.isNeedDial = a.getBoolean(11, false);
        this.hintString = a.getString(17);
        this.titleString = a.getString(16);
        this.progress = a.getFloat(3, 0.0f);
        this.maxValues = a.getFloat(15, 60.0f);
            ...
            for (int i = 0; i < 40; i++) {
                if (i <= 15 || i >= 25) {
                    if (i % 5 == 0) {
                        ...
                        canvas.drawLine(f, ((f2 - ((float) (i2 / 2))) - (f3 / 2.0f)) - ((float) i3), f, (((f2 - ((float) (i2 / 2))) - (f3 / 2.0f)) - ((float) i3)) - this.longDegree, this.degreePaint);
                    } else {
                        ...
                        canvas.drawLine(f4, (((f5 - ((float) (i4 / 2))) - (f6 / 2.0f)) - ((float) i5)) - ((f7 - f8) / 2.0f), f4, ((((f5 - ((float) (i4 / 2))) - (f6 / 2.0f)) - ((float) i5)) - ((f7 - f8) / 2.0f)) - f8, this.degreePaint);
                    }
    ...
    private void setAnimation(float last, float current, int length) {
        ...
        this.progressAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            /* class com.wits.ksw.launcher.view.ColorArcProgressBar.AnonymousClass1 */

            public void onAnimationUpdate(ValueAnimator animation) {
                ColorArcProgressBar.this.currentAngle = ((Float) animation.getAnimatedValue()).floatValue();
                ColorArcProgressBar colorArcProgressBar = ColorArcProgressBar.this;
                colorArcProgressBar.progress = colorArcProgressBar.currentAngle / ColorArcProgressBar.this.k;
            }
        });
