...
public class Benz2021DialogThemeActivity extends Activity {
    ...
    private View.OnClickListener mThemeItemClickListener = new View.OnClickListener() {
        /* class com.wits.ksw.launcher.view.benzmbux2021.Benz2021DialogThemeActivity.AnonymousClass1 */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.rb_icon_sel_classical.setButtonDrawable(UiThemeUtils.isUI_MBUX_YO(this) ? R.drawable.benz_mbux_2021_coast_style_rb_yo_sel_classical : R.drawable.benz_mbux_2021_coast_style_rb_sel_classical);
