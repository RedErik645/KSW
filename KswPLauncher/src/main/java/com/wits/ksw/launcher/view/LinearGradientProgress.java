...
public class LinearGradientProgress extends View implements SkinCompatSupportable {
    ...
    private void initView() {
        ...
        } else if (TextUtils.equals("blue", ID8LauncherConstants.loadCurrentSkin())) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.rulerVisible && (bitmap2 = this.rulerBitmap) != null) {
            if (this.mOrientation == 0) {
                ...
                canvas.drawBitmap(createScaledBitmap, 0.0f, (float) (this.mHeight - calcScale(this.mScale)), (Paint) null);
            } else {
