...
public class FragmentID6CuspFour extends ID6CuspBaseFragment implements View.OnKeyListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ID6CuspFragmentFour iD6CuspFragmentFour = (ID6CuspFragmentFour) DataBindingUtil.inflate(inflater, R.layout.id6_cusp_fragment_four, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.binding.id6CuspPhoneIamgeView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            /* class com.wits.ksw.launcher.view.id6_cusp.FragmentID6CuspFour.AnonymousClass1 */
        ...
        this.binding.id6CuspPhoneIamgeView.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.id6_cusp.FragmentID6CuspFour.AnonymousClass2 */
        ...
        this.binding.id6CuspAppsImageView.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.id6_cusp.FragmentID6CuspFour.AnonymousClass3 */
        ...
        this.binding.id6CuspSettingImageView.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.id6_cusp.FragmentID6CuspFour.AnonymousClass4 */
