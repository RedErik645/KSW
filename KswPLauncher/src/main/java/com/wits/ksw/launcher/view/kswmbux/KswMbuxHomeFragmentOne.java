...
public class KswMbuxHomeFragmentOne extends Fragment implements View.OnFocusChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        KswmbuxHomeOneBindingImpl kswmbuxHomeOneBindingImpl = (KswmbuxHomeOneBindingImpl) DataBindingUtil.inflate(inflater, R.layout.kswmbux_home_one, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.mainActivity.select.observe(getActivity(), new Observer<UgPager>() {
            /* class com.wits.ksw.launcher.view.kswmbux.KswMbuxHomeFragmentOne.AnonymousClass1 */
