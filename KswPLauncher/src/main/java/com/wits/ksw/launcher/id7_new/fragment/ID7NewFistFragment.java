...
public class ID7NewFistFragment extends RelativeLayout implements View.OnClickListener {
    ...
    private void init() {
        ...
        try {
            ...
            oils = String.format(getResources().getString(R.string.oil_size), McuImpl.getInstance().carInfo.oilValue.get());
    ...
    public void setSpeedRotation(ImageView imageView, int rota, int delay) {
        ...
        if (objectAnimator == null) {
            objectAnimator = ObjectAnimator.ofFloat(imageView, "rotation", (float) rota);
        ...
        objectAnimator.setFloatValues((float) rota);
    ...
    private void registerBtContentObserver() {
        this.contentResolver.registerContentObserver(Settings.System.getUriFor("ksw_bluetooth"), false, new ContentObserver(new Handler()) {
            /* class com.wits.ksw.launcher.id7_new.fragment.ID7NewFistFragment.AnonymousClass1 */
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.rel_firtNav /*{ENCODED_INT: 2131232433}*/:
                oncheckID(2);
                return;
            case R.id.rel_firtaps /*{ENCODED_INT: 2131232434}*/:
                oncheckID(4);
                return;
            case R.id.rel_firtbt /*{ENCODED_INT: 2131232435}*/:
                oncheckID(3);
                return;
            case R.id.rel_firtci /*{ENCODED_INT: 2131232436}*/:
                oncheckID(0);
                return;
            case R.id.rel_firtfm /*{ENCODED_INT: 2131232437}*/:
            case R.id.rel_firtie /*{ENCODED_INT: 2131232438}*/:
            case R.id.rel_firtset /*{ENCODED_INT: 2131232439}*/:
            case R.id.rel_firtvd /*{ENCODED_INT: 2131232440}*/:
            default:
                return;
            case R.id.rel_firtxc /*{ENCODED_INT: 2131232441}*/:
                oncheckID(1);
                return;
        }
    }
