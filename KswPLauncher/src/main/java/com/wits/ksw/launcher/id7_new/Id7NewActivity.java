...
public class Id7NewActivity extends BaseActivity {
    ...
    Handler uiHandler = new Handler() {
        /* class com.wits.ksw.launcher.id7_new.Id7NewActivity.AnonymousClass1 */
        ...
        public void handleMessage(Message msg) {
            ...
            ID7NewFistFragment iD7NewFistFragment = Id7NewActivity.this.id7NewFistFragment;
            if (bluetooth == 0) {
                z = true;
            }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_id7_new_launch);
        initView();
    ...
    private void initView() {
        ...
        this.img_IndexLeft.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.id7_new.Id7NewActivity.AnonymousClass2 */
        ...
        this.img_IndexRight.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.id7_new.Id7NewActivity.AnonymousClass3 */
        ...
        this.vpIndex.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            /* class com.wits.ksw.launcher.id7_new.Id7NewActivity.AnonymousClass4 */
        ...
        McuImpl.getInstance().carInfoMutableLiveData.observe(this, new Observer<CarInfo>() {
            /* class com.wits.ksw.launcher.id7_new.Id7NewActivity.AnonymousClass5 */
        ...
        MediaImpl.getInstance().mediaInfoMutableLiveData.observe(this, new Observer<MediaInfo>() {
            /* class com.wits.ksw.launcher.id7_new.Id7NewActivity.AnonymousClass6 */
