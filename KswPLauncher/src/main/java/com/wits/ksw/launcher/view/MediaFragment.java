...
public class MediaFragment extends Fragment {
    ...
    private IContentObserver.Stub topAppContentObserver = new IContentObserver.Stub() {
        /* class com.wits.ksw.launcher.view.MediaFragment.AnonymousClass1 */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        com.wits.ksw.databinding.MediaFragment mediaFragment = (com.wits.ksw.databinding.MediaFragment) DataBindingUtil.inflate(inflater, R.layout.id7_fragment_media, null, false);
