...
public class BenzNtg6FyFragmentOne extends BenzMbux2021BaseFragment implements View.OnKeyListener, View.OnClickListener {
    ...
    private IContentObserver.Stub topAppContentObserver = new IContentObserver.Stub() {
        /* class com.wits.ksw.launcher.view.benzntg6fy.BenzNtg6FyFragmentOne.AnonymousClass2 */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        BenzNtg6FyFragmentOneCls benzNtg6FyFragmentOneCls = (BenzNtg6FyFragmentOneCls) DataBindingUtil.inflate(inflater, R.layout.benz_ntg6_fy_fragment_one, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.binding.setItemview.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            /* class com.wits.ksw.launcher.view.benzntg6fy.BenzNtg6FyFragmentOne.AnonymousClass1 */
