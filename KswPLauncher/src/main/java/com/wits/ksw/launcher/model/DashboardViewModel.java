...
public class DashboardViewModel extends LauncherViewModel {
    ...
    public ObservableInt ntg6v3MiddleViewModel = new ObservableInt(0);
    public ObservableBoolean ntg6v3showSevenMenu = new ObservableBoolean(false);
    public ObservableBoolean showAls = new ObservableBoolean();
    public ObservableBoolean showSevenMenu = new ObservableBoolean(false);

    public void onNtg6v3MiddleViewClick(int mode) {
        this.ntg6v3MiddleViewModel.set(mode);
        try {
            PowerManagerApp.setSettingsInt("Ntg6v3MiddleViewModel", mode);
    ...
    public void onNtg6v3SevenModeClick(int mode) {
        carInfo.ntg6v3SevenMode.set(mode);
        try {
            PowerManagerApp.setSettingsInt("Ntg6v3SevenModel", mode);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
    ...
    public void initNtg6v3MiddleViewModel() {
        try {
            this.ntg6v3MiddleViewModel.set(PowerManagerApp.getSettingsInt("Ntg6v3MiddleViewModel"));
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }

    public int getNtg6v3SevenModel() {
        try {
            return PowerManagerApp.getSettingsInt("Ntg6v3SevenModel");
        } catch (RemoteException e) {
            e.printStackTrace();
            return 0;
        }
