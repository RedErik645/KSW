...
public class Benzmbux2021newAdapter extends BaseMultiItemQuickAdapter<BenzCardMenu, BaseViewHolder> {
    private static final String TAG = "Benzmbux2021newAdapter";
    private BcVieModel mBcVieModel;
    private List<BenzCardMenu> mBenzCardMenuList;

    public Benzmbux2021newAdapter(List<BenzCardMenu> data) {
        super(data);
        this.mBenzCardMenuList = data;
        addItemType(1, R.layout.benz_mbux_2021_ksw_new_recycle_item);
        addItemType(2, R.layout.benz_mbux_2021_ksw_new_recycle_item_third);
    }
