...
public class BenzMbux2021KswFragmentThree extends BenzMbux2021KswBaseFragment implements View.OnKeyListener, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        Benz2021KswFragmentThree benz2021KswFragmentThree = (Benz2021KswFragmentThree) DataBindingUtil.inflate(inflater, R.layout.fragment_benz_mbux2021_ksw_three, null, false);
