...
public class UgHomeFragmentThree extends Fragment implements View.OnFocusChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (UiThemeUtils.isCommon_UI_GS_UG_1024(getActivity())) {
            UgHomeThree2BindingImpl ugHomeThree2BindingImpl = (UgHomeThree2BindingImpl) DataBindingUtil.inflate(inflater, R.layout.ug_home_three2, null, false);
        ...
        UgHomeThreeBindingImpl ugHomeThreeBindingImpl = (UgHomeThreeBindingImpl) DataBindingUtil.inflate(inflater, R.layout.ug_home_three, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (UiThemeUtils.isCommon_UI_GS_UG_1024(getActivity())) {
            ...
            this.mainActivity.select.observe(getActivity(), new Observer<UgPager>() {
                /* class com.wits.ksw.launcher.view.ug.UgHomeFragmentThree.AnonymousClass1 */
        ...
        this.mainActivity.select.observe(getActivity(), new Observer<UgPager>() {
            /* class com.wits.ksw.launcher.view.ug.UgHomeFragmentThree.AnonymousClass2 */
