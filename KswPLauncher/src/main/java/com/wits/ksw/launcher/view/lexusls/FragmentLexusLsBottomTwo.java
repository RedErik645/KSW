...
public class FragmentLexusLsBottomTwo extends LexusLsBaseBottomFragment implements View.OnKeyListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        LexusLsBottomFragmentTwo lexusLsBottomFragmentTwo = (LexusLsBottomFragmentTwo) DataBindingUtil.inflate(inflater, R.layout.lexus_ls_bottom_fragment_two, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.binding.ivLexusLsDvr.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomTwo.AnonymousClass1 */
        ...
        this.binding.ivLexusLsDvr.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomTwo.AnonymousClass2 */
        ...
        this.binding.ivLexusLsDashboard.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomTwo.AnonymousClass3 */
        ...
        this.binding.ivLexusLsPhonelink.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomTwo.AnonymousClass4 */
        ...
        this.binding.ivLexusLsFile.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomTwo.AnonymousClass5 */
        ...
        this.binding.ivLexusLsAdd.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomTwo.AnonymousClass6 */
