...
public class DragGridView extends GridView {
    ...
    public DragGridView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.dragRunnable = new Runnable() {
            /* class com.wits.ksw.launcher.view.DragGridView.AnonymousClass1 */
        ...
        this.scrollRunnable = new Runnable() {
            /* class com.wits.ksw.launcher.view.DragGridView.AnonymousClass2 */
    ...
    private void createDragImage(Bitmap mDragBitmap2, int mDownX2, int mDownY2) {
