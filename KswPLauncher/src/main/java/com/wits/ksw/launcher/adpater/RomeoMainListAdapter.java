...
public class RomeoMainListAdapter<T> extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.adpater.RomeoMainListAdapter.AnonymousClass1 */
        ...
        viewHolder.itemView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            /* class com.wits.ksw.launcher.adpater.RomeoMainListAdapter.AnonymousClass2 */
        ...
        viewHolder.itemView.setOnTouchListener(new View.OnTouchListener() {
            /* class com.wits.ksw.launcher.adpater.RomeoMainListAdapter.AnonymousClass3 */
        ...
        viewHolder.itemView.setOnKeyListener(new View.OnKeyListener() {
            /* class com.wits.ksw.launcher.adpater.RomeoMainListAdapter.AnonymousClass4 */
