...
public class AudiMib3FragmentOne extends AudiMib3BaseFragment implements View.OnKeyListener {
    ...
    private View.OnFocusChangeListener mFocusChangeListener = new View.OnFocusChangeListener() {
        /* class com.wits.ksw.launcher.view.audimib3.AudiMib3FragmentOne.AnonymousClass2 */
    ...
    private View.OnClickListener mItemClickListener = new View.OnClickListener() {
        /* class com.wits.ksw.launcher.view.audimib3.AudiMib3FragmentOne.AnonymousClass3 */
    ...
    private IContentObserver.Stub topAppContentObserver = new IContentObserver.Stub() {
        /* class com.wits.ksw.launcher.view.audimib3.AudiMib3FragmentOne.AnonymousClass4 */
    ...
    @Override // com.wits.ksw.launcher.view.audimib3.AudiMib3BaseFragment, android.support.v4.app.Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        AudiMib3OneDataCls audiMib3OneDataCls = (AudiMib3OneDataCls) DataBindingUtil.inflate(inflater, R.layout.audi_mib3_fragment_one, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        bindingOne.setItemview.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            /* class com.wits.ksw.launcher.view.audimib3.AudiMib3FragmentOne.AnonymousClass1 */
