...
public class ID8GsEditActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_id8_gs_launcher_edit);
        HorizontalScrollView horizontalScrollView = (HorizontalScrollView) findViewById(R.id.scrollView);
        this.scrollView = horizontalScrollView;
        horizontalScrollView.setOnScrollChangeListener(new View.OnScrollChangeListener() {
            /* class com.wits.ksw.launcher.bmw_id8_ui.ID8GsEditActivity.AnonymousClass1 */
        ...
        this.scrollView.setOnDragListener(new View.OnDragListener() {
            /* class com.wits.ksw.launcher.bmw_id8_ui.ID8GsEditActivity.AnonymousClass2 */
        ...
        LinearLayout linearLayout = (LinearLayout) findViewById(R.id.ll_containe);
        this.llContainer = linearLayout;
        linearLayout.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.bmw_id8_ui.ID8GsEditActivity.AnonymousClass3 */
        ...
        GSID8BarOnDragListener barOnDragListener = new GSID8BarOnDragListener(this);
