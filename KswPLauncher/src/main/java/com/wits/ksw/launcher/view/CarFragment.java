...
public class CarFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (UiThemeUtils.isBMW_EVO_ID7_HiCar(getContext())) {
            ...
            HicarCarInfo hicarCarInfo = (HicarCarInfo) DataBindingUtil.inflate(inflater, R.layout.id7_fragment_car_hicar, null, false);
            this.hicarBinding = hicarCarInfo;
            return hicarCarInfo.getRoot();
        }
        this.viewModel.hicar.set(false);
        CarInfo carInfo = (CarInfo) DataBindingUtil.inflate(inflater, R.layout.id7_fragment_car, null, false);
