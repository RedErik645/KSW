...
public class NaviFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (UiThemeUtils.isBMW_EVO_ID7_HiCar(getContext())) {
            ...
            HicarNaviFragment hicarNaviFragment = (HicarNaviFragment) DataBindingUtil.inflate(inflater, R.layout.id7_fragment_navi_hicar, null, false);
            this.hicarBinding = hicarNaviFragment;
            return hicarNaviFragment.getRoot();
        }
        this.viewModel.hicar.set(false);
        com.wits.ksw.databinding.NaviFragment naviFragment = (com.wits.ksw.databinding.NaviFragment) DataBindingUtil.inflate(inflater, R.layout.id7_fragment_navi, null, false);
