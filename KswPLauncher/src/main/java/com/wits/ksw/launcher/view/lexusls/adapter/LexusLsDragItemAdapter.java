...
public class LexusLsDragItemAdapter extends RecyclerView.Adapter<mBaseViewHolder> implements DragListener {
    ...
    private ArrayList<LexusLsAppSelBean> mList = new ArrayList<>();
    ...
    public class mItemOnclick implements View.OnClickListener {
        View mView;
        int pos;
        ...
        public void onClick(View v) {
            ...
            if (UiThemeUtils.isLEXUS_LS_UI(LexusLsDragItemAdapter.this.mContext)) {
                if (!LexusLsDragItemAdapter.isMenu(appItem)) {
                    ...
                    if (!AppInfoUtils.openFactorySettingApp(componentName)) {
                ...
                if (!AppInfoUtils.openFactorySettingApp(componentName2)) {
