...
public class FragmentID6CuspTwo extends ID6CuspBaseFragment implements View.OnKeyListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ID6CuspFragmentTow iD6CuspFragmentTow = (ID6CuspFragmentTow) DataBindingUtil.inflate(inflater, R.layout.id6_cusp_fragment_tow, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.binding.id6CuspVideoIamgeView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            /* class com.wits.ksw.launcher.view.id6_cusp.FragmentID6CuspTwo.AnonymousClass1 */
        ...
        this.binding.id6CuspBrowserImageView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            /* class com.wits.ksw.launcher.view.id6_cusp.FragmentID6CuspTwo.AnonymousClass2 */
        ...
        this.binding.id6CuspVideoIamgeView.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.id6_cusp.FragmentID6CuspTwo.AnonymousClass3 */
        ...
        this.binding.id6CuspCarImageView.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.id6_cusp.FragmentID6CuspTwo.AnonymousClass4 */
        ...
        this.binding.id6CuspBrowserImageView.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.id6_cusp.FragmentID6CuspTwo.AnonymousClass5 */
