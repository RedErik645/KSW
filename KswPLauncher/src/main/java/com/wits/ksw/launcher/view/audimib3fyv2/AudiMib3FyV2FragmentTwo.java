...
public class AudiMib3FyV2FragmentTwo extends AudiMib3FyBaseFragment implements View.OnKeyListener {
    ...
    private View.OnFocusChangeListener mFocusChangeListener = new View.OnFocusChangeListener() {
        /* class com.wits.ksw.launcher.view.audimib3fyv2.AudiMib3FyV2FragmentTwo.AnonymousClass1 */
    ...
    private View.OnClickListener mItemClickListener = new View.OnClickListener() {
        /* class com.wits.ksw.launcher.view.audimib3fyv2.AudiMib3FyV2FragmentTwo.AnonymousClass2 */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        AudiMib3FyV2TwoDataCls audiMib3FyV2TwoDataCls = (AudiMib3FyV2TwoDataCls) DataBindingUtil.inflate(inflater, R.layout.fragment_audi_mib3_fy_v2_two, null, false);
