...
public class FragmentLexusLsBottomOne extends LexusLsBaseBottomFragment implements View.OnKeyListener {
    ...
    private IContentObserver.Stub topAppContentObserver = new IContentObserver.Stub() {
        /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomOne.AnonymousClass10 */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        LexusLsBottomFragmentOne lexusLsBottomFragmentOne = (LexusLsBottomFragmentOne) DataBindingUtil.inflate(inflater, R.layout.lexus_ls_bottom_fragment_one, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.binding.ivLexusLsAir.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomOne.AnonymousClass1 */
        ...
        this.binding.ivLexusLsNavi.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomOne.AnonymousClass2 */
        ...
        this.binding.ivLexusLsMusic.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomOne.AnonymousClass3 */
        ...
        this.binding.ivLexusLsBt.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomOne.AnonymousClass4 */
        ...
        this.binding.ivLexusLsApp.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomOne.AnonymousClass5 */
        ...
        this.binding.ivLexusLsVideo.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomOne.AnonymousClass6 */
        ...
        this.binding.ivLexusLsCar.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomOne.AnonymousClass7 */
        ...
        this.binding.ivLexusLsSet.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomOne.AnonymousClass8 */
        ...
        this.binding.ivLexusLsAir.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomOne.AnonymousClass9 */
