...
public class ID8FragmentHelper {
    ...
    private ID8Fragment3rdApp.TrdAppRemoveListener trdAppRemoveListener = new ID8Fragment3rdApp.TrdAppRemoveListener() {
        /* class com.wits.ksw.launcher.bmw_id8_ui.fragment.ID8FragmentHelper.AnonymousClass1 */
    ...
    private ID8FragmentWeather.WeatherRemoveListener weatherRemoveListener = new ID8FragmentWeather.WeatherRemoveListener() {
        /* class com.wits.ksw.launcher.bmw_id8_ui.fragment.ID8FragmentHelper.AnonymousClass2 */
