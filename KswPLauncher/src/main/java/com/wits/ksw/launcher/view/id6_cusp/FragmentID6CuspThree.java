...
public class FragmentID6CuspThree extends ID6CuspBaseFragment implements View.OnKeyListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ID6CuspFragmentThree iD6CuspFragmentThree = (ID6CuspFragmentThree) DataBindingUtil.inflate(inflater, R.layout.id6_cusp_fragment_three, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.binding.id6CuspFileIamgeView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            /* class com.wits.ksw.launcher.view.id6_cusp.FragmentID6CuspThree.AnonymousClass1 */
        ...
        this.binding.id6CuspDashboardImageView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            /* class com.wits.ksw.launcher.view.id6_cusp.FragmentID6CuspThree.AnonymousClass2 */
        ...
        this.binding.id6CuspFileIamgeView.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.id6_cusp.FragmentID6CuspThree.AnonymousClass3 */
        ...
        this.binding.id6CuspDvrImageView.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.id6_cusp.FragmentID6CuspThree.AnonymousClass4 */
        ...
        this.binding.id6CuspDashboardImageView.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.id6_cusp.FragmentID6CuspThree.AnonymousClass5 */
