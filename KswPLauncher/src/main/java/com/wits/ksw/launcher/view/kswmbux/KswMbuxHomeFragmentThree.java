...
public class KswMbuxHomeFragmentThree extends Fragment implements View.OnFocusChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        KswmbuxHomeThreeBindingImpl kswmbuxHomeThreeBindingImpl = (KswmbuxHomeThreeBindingImpl) DataBindingUtil.inflate(inflater, R.layout.kswmbux_home_three, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.mainActivity.select.observe(getActivity(), new Observer<UgPager>() {
            /* class com.wits.ksw.launcher.view.kswmbux.KswMbuxHomeFragmentThree.AnonymousClass1 */
