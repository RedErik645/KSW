...
public class MarqueeTextView extends AppCompatTextView implements SkinCompatSupportable {
    ...
    public MarqueeTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (UiThemeUtils.isBMW_ID8_UI(context) || UiThemeUtils.isUI_PEMP_ID8(context) || UiThemeUtils.isALS_ID7_UI(context) || UiThemeUtils.isUI_GS_ID8(context) || UiThemeUtils.isEVOID8_UG(context)) {
