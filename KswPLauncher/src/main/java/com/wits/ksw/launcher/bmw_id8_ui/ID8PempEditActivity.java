...
public class ID8PempEditActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pemp_id8_launcher_edit);
        HorizontalScrollView horizontalScrollView = (HorizontalScrollView) findViewById(R.id.scrollView);
        this.scrollView = horizontalScrollView;
        horizontalScrollView.setOnScrollChangeListener(new View.OnScrollChangeListener() {
            /* class com.wits.ksw.launcher.bmw_id8_ui.ID8PempEditActivity.AnonymousClass1 */
        ...
        this.scrollView.setOnDragListener(new View.OnDragListener() {
            /* class com.wits.ksw.launcher.bmw_id8_ui.ID8PempEditActivity.AnonymousClass2 */
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.bmw_id8_ui.ID8PempEditActivity.AnonymousClass3 */
