...
public class FragmentLexusLsBottomTwoV2 extends LexusLsBaseBottomFragment implements View.OnKeyListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        LexusLsBottomFragmentTwo_V2 lexusLsBottomFragmentTwo_V2 = (LexusLsBottomFragmentTwo_V2) DataBindingUtil.inflate(inflater, R.layout.lexus_ls_bottom_fragment_two_v2, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.binding.ivLexusLsDvr.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomTwoV2.AnonymousClass1 */
        ...
        this.binding.ivLexusLsDvr.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomTwoV2.AnonymousClass2 */
        ...
        this.binding.ivLexusLsDashboard.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomTwoV2.AnonymousClass3 */
        ...
        this.binding.ivLexusLsPhonelink.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomTwoV2.AnonymousClass4 */
        ...
        this.binding.ivLexusLsFile.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomTwoV2.AnonymousClass5 */
        ...
        this.binding.ivLexusLsWeather.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomTwoV2.AnonymousClass6 */
        ...
        this.binding.ivLexusLsAdd.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.lexusls.FragmentLexusLsBottomTwoV2.AnonymousClass7 */
