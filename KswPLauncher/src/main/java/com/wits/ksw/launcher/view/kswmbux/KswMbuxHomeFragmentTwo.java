...
public class KswMbuxHomeFragmentTwo extends Fragment implements View.OnFocusChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        KswmbuxHomeTwoBindingImpl kswmbuxHomeTwoBindingImpl = (KswmbuxHomeTwoBindingImpl) DataBindingUtil.inflate(inflater, R.layout.kswmbux_home_two, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.mainActivity.select.observe(getActivity(), new Observer<UgPager>() {
            /* class com.wits.ksw.launcher.view.kswmbux.KswMbuxHomeFragmentTwo.AnonymousClass1 */
