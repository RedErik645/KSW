...
public class BenzMbux2021KswV2FragmentTwo extends BenzMbux2021KswBaseFragment implements View.OnKeyListener, View.OnClickListener, View.OnFocusChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        Benz2021KswV2FragmentTwo benz2021KswV2FragmentTwo = (Benz2021KswV2FragmentTwo) DataBindingUtil.inflate(inflater, R.layout.fragment_benz_mbux2021_ksw_v2_two, null, false);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.video_itemview /*{ENCODED_INT: 2131232848}*/:
                ...
                setItemSelected(this.binding.videoItemview);
                return;
            case R.id.iv_weather1 /*{ENCODED_INT: 2131231841}*/:
            case R.id.iv_weather2 /*{ENCODED_INT: 2131231842}*/:
