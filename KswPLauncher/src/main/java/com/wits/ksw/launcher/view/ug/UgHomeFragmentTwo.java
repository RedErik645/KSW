...
public class UgHomeFragmentTwo extends Fragment implements View.OnFocusChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (UiThemeUtils.isCommon_UI_GS_UG_1024(getActivity())) {
            UgHomeTwo2BindingImpl ugHomeTwo2BindingImpl = (UgHomeTwo2BindingImpl) DataBindingUtil.inflate(inflater, R.layout.ug_home_two2, null, false);
        ...
        UgHomeTwoBindingImpl ugHomeTwoBindingImpl = (UgHomeTwoBindingImpl) DataBindingUtil.inflate(inflater, R.layout.ug_home_two, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (UiThemeUtils.isCommon_UI_GS_UG_1024(getActivity())) {
            ...
            this.mainActivity.select.observe(getActivity(), new Observer<UgPager>() {
                /* class com.wits.ksw.launcher.view.ug.UgHomeFragmentTwo.AnonymousClass1 */
        ...
        this.mainActivity.select.observe(getActivity(), new Observer<UgPager>() {
            /* class com.wits.ksw.launcher.view.ug.UgHomeFragmentTwo.AnonymousClass2 */
