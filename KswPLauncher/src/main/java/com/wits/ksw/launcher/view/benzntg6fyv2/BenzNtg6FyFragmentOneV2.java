...
public class BenzNtg6FyFragmentOneV2 extends BenzMbux2021BaseFragment implements View.OnKeyListener, View.OnClickListener {
    ...
    private IContentObserver.Stub topAppContentObserver = new IContentObserver.Stub() {
        /* class com.wits.ksw.launcher.view.benzntg6fyv2.BenzNtg6FyFragmentOneV2.AnonymousClass2 */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        BenzNtg6FyFragmentOneClsV2 benzNtg6FyFragmentOneClsV2 = (BenzNtg6FyFragmentOneClsV2) DataBindingUtil.inflate(inflater, R.layout.benz_ntg6_fy_fragment_one_v2, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.binding.carItemview.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            /* class com.wits.ksw.launcher.view.benzntg6fyv2.BenzNtg6FyFragmentOneV2.AnonymousClass1 */
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.bt_iv1 /*{ENCODED_INT: 2131231266}*/:
            case R.id.bt_iv2 /*{ENCODED_INT: 2131231267}*/:
                this.viewModel.openBtApp();
                setItemSelected(this.binding.btItemview);
                return;
            case R.id.car_itemview /*{ENCODED_INT: 2131231298}*/:
            case R.id.car_iv1 /*{ENCODED_INT: 2131231300}*/:
            case R.id.car_iv2 /*{ENCODED_INT: 2131231301}*/:
            ...
            case R.id.music_itemview /*{ENCODED_INT: 2131232151}*/:
                ...
                setItemSelected(this.binding.musicItemview);
                return;
            case R.id.music_iv1 /*{ENCODED_INT: 2131232153}*/:
                this.viewModel.btnMusicNext();
                setItemSelected(this.binding.musicItemview);
                return;
            case R.id.music_iv2 /*{ENCODED_INT: 2131232154}*/:
                this.viewModel.btnMusicPrev();
                setItemSelected(this.binding.musicItemview);
                return;
            case R.id.navi_itemview /*{ENCODED_INT: 2131232174}*/:
            case R.id.navi_iv1 /*{ENCODED_INT: 2131232176}*/:
            case R.id.navi_iv2 /*{ENCODED_INT: 2131232177}*/:
                this.viewModel.openNaviApp(v);
                setItemSelected(this.binding.naviItemview);
                return;
            case R.id.weather_itemview /*{ENCODED_INT: 2131232877}*/:
            case R.id.weather_iv1 /*{ENCODED_INT: 2131232879}*/:
            case R.id.weather_iv2 /*{ENCODED_INT: 2131232880}*/:
