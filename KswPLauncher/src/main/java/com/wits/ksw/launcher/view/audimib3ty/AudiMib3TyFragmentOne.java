...
public class AudiMib3TyFragmentOne extends AudiMib3TyBaseFragment implements View.OnKeyListener {
    ...
    private View.OnClickListener mItemClickListener = new View.OnClickListener() {
        /* class com.wits.ksw.launcher.view.audimib3ty.AudiMib3TyFragmentOne.AnonymousClass2 */
    ...
    private IContentObserver.Stub topAppContentObserver = new IContentObserver.Stub() {
        /* class com.wits.ksw.launcher.view.audimib3ty.AudiMib3TyFragmentOne.AnonymousClass3 */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        AudiMib3TyOneBinding audiMib3TyOneBinding = (AudiMib3TyOneBinding) DataBindingUtil.inflate(inflater, R.layout.fragment_audi_mib3_ty_one, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        bindingOne.phonelinkItemview.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            /* class com.wits.ksw.launcher.view.audimib3ty.AudiMib3TyFragmentOne.AnonymousClass1 */
