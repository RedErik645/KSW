...
public class DashVideoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (UiThemeUtils.isID7_ALS_V2(getContext())) {
            DashVideoFragment_V2 dashVideoFragment_V2 = (DashVideoFragment_V2) DataBindingUtil.inflate(inflater, R.layout.als_id7_fragment_dash_video_v2, null, false);
            this.binding_v2 = dashVideoFragment_V2;
            return dashVideoFragment_V2.getRoot();
        }
        com.wits.ksw.databinding.DashVideoFragment dashVideoFragment = (com.wits.ksw.databinding.DashVideoFragment) DataBindingUtil.inflate(inflater, R.layout.als_id7_fragment_dash_video, null, false);
