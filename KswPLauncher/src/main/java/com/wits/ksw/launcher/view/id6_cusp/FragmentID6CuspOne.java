...
public class FragmentID6CuspOne extends ID6CuspBaseFragment implements View.OnKeyListener {
    ...
    private IContentObserver.Stub topAppContentObserver = new IContentObserver.Stub() {
        /* class com.wits.ksw.launcher.view.id6_cusp.FragmentID6CuspOne.AnonymousClass5 */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ID6CuspFragmentOne iD6CuspFragmentOne = (ID6CuspFragmentOne) DataBindingUtil.inflate(inflater, R.layout.id6_cusp_fragment_one, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.binding.id6CuspBtImageView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            /* class com.wits.ksw.launcher.view.id6_cusp.FragmentID6CuspOne.AnonymousClass1 */
        ...
        this.binding.id6CuspMusicIamgeView.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.id6_cusp.FragmentID6CuspOne.AnonymousClass2 */
        ...
        this.binding.id6CuspNavImageView.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.id6_cusp.FragmentID6CuspOne.AnonymousClass3 */
        ...
        this.binding.id6CuspBtImageView.setOnClickListener(new View.OnClickListener() {
            /* class com.wits.ksw.launcher.view.id6_cusp.FragmentID6CuspOne.AnonymousClass4 */
