...
public class UgHomeFragmentFour extends Fragment implements View.OnFocusChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (UiThemeUtils.isCommon_UI_GS_UG_1024(getActivity())) {
            UgHomeFour2BindingImpl ugHomeFour2BindingImpl = (UgHomeFour2BindingImpl) DataBindingUtil.inflate(inflater, R.layout.ug_home_four2, null, false);
            this.binding2 = ugHomeFour2BindingImpl;
            return ugHomeFour2BindingImpl.getRoot();
        }
        UgHomeFourBindingImpl ugHomeFourBindingImpl = (UgHomeFourBindingImpl) DataBindingUtil.inflate(inflater, R.layout.ug_home_four, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (UiThemeUtils.isCommon_UI_GS_UG_1024(getActivity())) {
            ...
            this.mainActivity.select.observe(getActivity(), new Observer<UgPager>() {
                /* class com.wits.ksw.launcher.view.ug.UgHomeFragmentFour.AnonymousClass1 */
        ...
        this.mainActivity.select.observe(getActivity(), new Observer<UgPager>() {
            /* class com.wits.ksw.launcher.view.ug.UgHomeFragmentFour.AnonymousClass2 */
