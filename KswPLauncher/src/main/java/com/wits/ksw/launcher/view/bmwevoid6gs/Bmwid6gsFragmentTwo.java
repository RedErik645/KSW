...
public class Bmwid6gsFragmentTwo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        FraBmwEvoId6GsTwoBinding fraBmwEvoId6GsTwoBinding = (FraBmwEvoId6GsTwoBinding) DataBindingUtil.inflate(inflater, R.layout.fra_bmw_evo_id6_gs_two, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < this.childViews.size(); i++) {
            ...
            this.childViews.get(i).setOnClickListener(new View.OnClickListener() {
                /* class com.wits.ksw.launcher.view.bmwevoid6gs.Bmwid6gsFragmentTwo.AnonymousClass1 */
