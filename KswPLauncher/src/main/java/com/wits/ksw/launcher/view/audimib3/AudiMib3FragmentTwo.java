...
public class AudiMib3FragmentTwo extends AudiMib3BaseFragment implements View.OnKeyListener {
    ...
    private View.OnFocusChangeListener mFocusChangeListener = new View.OnFocusChangeListener() {
        /* class com.wits.ksw.launcher.view.audimib3.AudiMib3FragmentTwo.AnonymousClass1 */
    ...
    private View.OnClickListener mItemClickListener = new View.OnClickListener() {
        /* class com.wits.ksw.launcher.view.audimib3.AudiMib3FragmentTwo.AnonymousClass2 */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        AudiMib3TwoDataCls audiMib3TwoDataCls = (AudiMib3TwoDataCls) DataBindingUtil.inflate(inflater, R.layout.audi_mib3_fragment_two, null, false);
