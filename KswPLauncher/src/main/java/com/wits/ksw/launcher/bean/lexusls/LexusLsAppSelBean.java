...
public class LexusLsAppSelBean {
    ...
    public String toString() {
        return "LexusLsAppSelBean{appIcon=" + this.appIcon + ", appName='" + this.appName + '\'' + ", appPkg='" + this.appPkg + '\'' + ", appMainAty='" + this.appMainAty + '\'' + ", isChecked=" + this.isChecked + ", deletable=" + this.deletable + ", itemPos=" + this.itemPos + ", action='" + this.action + '\'' + '}';
    }
}
