...
public class AudiMib3TyFragmentTwo extends AudiMib3TyBaseFragment implements View.OnKeyListener {
    ...
    private View.OnClickListener mItemClickListener = new View.OnClickListener() {
        /* class com.wits.ksw.launcher.view.audimib3ty.AudiMib3TyFragmentTwo.AnonymousClass1 */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        AudiMib3TyTwoBinding audiMib3TyTwoBinding = (AudiMib3TyTwoBinding) DataBindingUtil.inflate(inflater, R.layout.fragment_audi_mib3_ty_two, null, false);
    ...
    public void onResume() {
        ...
        if (bindingTwo != null) {
            bindingTwo.dashboardContent.setText(String.format(getResources().getString(R.string.oil_size), McuImpl.getInstance().getCarInfo().oilValue.get()));
        }
    }
