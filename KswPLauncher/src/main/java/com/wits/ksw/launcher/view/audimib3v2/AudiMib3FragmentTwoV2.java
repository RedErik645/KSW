...
public class AudiMib3FragmentTwoV2 extends AudiMib3BaseFragmentV2 implements View.OnKeyListener {
    ...
    private View.OnFocusChangeListener mFocusChangeListener = new View.OnFocusChangeListener() {
        /* class com.wits.ksw.launcher.view.audimib3v2.AudiMib3FragmentTwoV2.AnonymousClass1 */
    ...
    private View.OnClickListener mItemClickListener = new View.OnClickListener() {
        /* class com.wits.ksw.launcher.view.audimib3v2.AudiMib3FragmentTwoV2.AnonymousClass2 */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        AudiMib3TwoDataClsV2 audiMib3TwoDataClsV2 = (AudiMib3TwoDataClsV2) DataBindingUtil.inflate(inflater, R.layout.audi_mib3_fragment_two_v2, null, false);
