...
public class ID8PempFragmentHelper {
    ...
    private final ID8PempFragment3rdApp.TrdAppRemoveListener trdAppRemoveListener = new ID8PempFragment3rdApp.TrdAppRemoveListener() {
        /* class com.wits.ksw.launcher.bmw_id8_ui.fragment.ID8PempFragmentHelper.AnonymousClass1 */
    ...
    private final ID8PempFragmentWeather.WeatherRemoveListener weatherRemoveListener = new ID8PempFragmentWeather.WeatherRemoveListener() {
        /* class com.wits.ksw.launcher.bmw_id8_ui.fragment.ID8PempFragmentHelper.AnonymousClass2 */
    ...
    private void clear(FragmentManager manager2, HashMap<String, Fragment> systemFragmentHashMap2, HashMap<String, Fragment> trdFragmentHashMap2) {
        ...
        for (Fragment fragment : systemFragmentHashMap2.values()) {
            transaction.remove(fragment);
        }
        for (Fragment fragment2 : trdFragmentHashMap2.values()) {
    ...
    private void initFragment() {
        ...
        arrayList.add(Integer.valueOf((int) R.id.fl_content1));
        this.flList.add(Integer.valueOf((int) R.id.fl_content2));
        this.flList.add(Integer.valueOf((int) R.id.fl_content3));
        this.flList.add(Integer.valueOf((int) R.id.fl_content4));
        this.flList.add(Integer.valueOf((int) R.id.fl_content5));
        this.flList.add(Integer.valueOf((int) R.id.fl_content6));
        this.flList.add(Integer.valueOf((int) R.id.fl_content7));
        this.flList.add(Integer.valueOf((int) R.id.fl_content8));
        this.flList.add(Integer.valueOf((int) R.id.fl_content9));
        this.flList.add(Integer.valueOf((int) R.id.fl_content10));
        this.flList.add(Integer.valueOf((int) R.id.fl_content11));
        this.flList.add(Integer.valueOf((int) R.id.fl_content12));
        this.flList.add(Integer.valueOf((int) R.id.fl_content13));
        this.flList.add(Integer.valueOf((int) R.id.fl_content14));
    }
}
