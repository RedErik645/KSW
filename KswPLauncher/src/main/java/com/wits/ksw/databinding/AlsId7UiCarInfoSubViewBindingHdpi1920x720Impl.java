...
public class AlsId7UiCarInfoSubViewBindingHdpi1920x720Impl extends AlsId7UiCarInfoSubViewBinding implements OnClickListener.Listener {
    ...
    public AlsId7UiCarInfoSubViewBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private AlsId7UiCarInfoSubViewBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (ConstraintLayout) bindings[0], (CustomSkinImageView) bindings[1], (ImageView) bindings[2], (TextView) bindings[3], (TextView) bindings[4]);
        this.mDirtyFlags = -1;
    ...
    @Override // com.wits.ksw.databinding.AlsId7UiCarInfoSubViewBinding
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.carImageView.setOnClickListener(this.mCallback31);
        }
        if ((3 & dirtyFlags) != 0) {
