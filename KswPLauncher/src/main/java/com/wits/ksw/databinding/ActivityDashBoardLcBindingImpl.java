...
public class ActivityDashBoardLcBindingImpl extends ActivityDashBoardLcBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.audi_lc_dashboard_speed_highlight_ImageView, 13);
        sparseIntArray.put(R.id.tachometerImageView, 14);
        sparseIntArray.put(R.id.audi_lc_dashboard_tachometer_highlight_imageView, 15);
    }

    public ActivityDashBoardLcBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 16, sIncludes, sViewsWithIds));
    }

    private ActivityDashBoardLcBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 12, (ImageView) bindings[13], (ImageView) bindings[15], (ImageView) bindings[11], (ImageView) bindings[5], (ImageView) bindings[10], (ImageView) bindings[6], (ImageView) bindings[7], (ImageView) bindings[8], (ImageView) bindings[9], (ConstraintLayout) bindings[0], (ImageView) bindings[12], (ID7SpeedImageView) bindings[3], (ID7SpeedImageView) bindings[2], (ImageView) bindings[14], (TextView) bindings[1], (ImageView) bindings[4]);
        this.mDirtyFlags = -1;
    ...
    @Override // com.wits.ksw.databinding.ActivityDashBoardLcBinding
