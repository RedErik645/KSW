...
public class LexusLsBottomFragmentTwo_V2Impl extends LexusLsBottomFragmentTwo_V2 {
    ...
    private LexusLsBottomFragmentTwo_V2Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (ImageView) bindings[6], (ImageView) bindings[2], (ImageView) bindings[1], (ImageView) bindings[4], (ImageView) bindings[3], (ImageView) bindings[5], (LinearLayout) bindings[0]);
        this.mDirtyFlags = -1;
    ...
    @Override // com.wits.ksw.databinding.LexusLsBottomFragmentTwo_V2
