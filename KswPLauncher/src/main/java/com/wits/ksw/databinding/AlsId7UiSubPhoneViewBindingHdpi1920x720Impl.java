...
public class AlsId7UiSubPhoneViewBindingHdpi1920x720Impl extends AlsId7UiSubPhoneViewBinding implements OnClickListener.Listener {
    ...
    static {
        ...
        sparseIntArray.put(R.id.als_id7_main_phone_img, 5);
        sparseIntArray.put(R.id.textView2, 6);
    }

    public AlsId7UiSubPhoneViewBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }

    private AlsId7UiSubPhoneViewBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 3, (ImageView) bindings[5], (TextView) bindings[4], (TextView) bindings[3], (TextView) bindings[2], (ConstraintLayout) bindings[0], (CustomSkinImageView) bindings[1], (TextView) bindings[6]);
        this.mDirtyFlags = -1;
    ...
    @Override // com.wits.ksw.databinding.AlsId7UiSubPhoneViewBinding
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags & 16) != 0) {
            this.phoneImageView.setOnClickListener(this.mCallback284);
        }
        if ((dirtyFlags & 24) != 0) {
