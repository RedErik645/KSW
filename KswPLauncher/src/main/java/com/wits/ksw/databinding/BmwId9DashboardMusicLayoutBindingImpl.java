...
public class BmwId9DashboardMusicLayoutBindingImpl extends BmwId9DashboardMusicLayoutBinding {
    ...
    public BmwId9DashboardMusicLayoutBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }

    private BmwId9DashboardMusicLayoutBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 8, (TextView) bindings[4], (CustomizeSeekBar) bindings[7]);
        this.mDirtyFlags = -1;
        this.bmwId9DashboardMusicName.setTag(null);
        this.bmwId9DashboardMusicSeekbar.setTag(null);
    ...
    @Override // com.wits.ksw.databinding.BmwId9DashboardMusicLayoutBinding
    ...
    public void executeBindings() {
        ...
        String viewModelMediaInfoMusicNameJavaLangObjectNullBmwId9DashboardMusicNameAndroidStringKswIdf7UnkonwSoungViewModelMediaInfoMusicName;
        ...
        String viewModelMediaInfoMusicAtistJavaLangObjectNullMboundView5AndroidStringKswIdf7UnknowArtisViewModelMediaInfoMusicAtist = null;
        ...
        if ((dirtyFlags & 516) != 0) {
            viewModelMediaInfoMusicNameJavaLangObjectNullBmwId9DashboardMusicNameAndroidStringKswIdf7UnkonwSoungViewModelMediaInfoMusicName = viewModelMediaInfoMusicNameJavaLangObjectNull ? this.bmwId9DashboardMusicName.getResources().getString(R.string.ksw_idf7_unkonw_soung) : viewModelMediaInfoMusicNameGet;
        } else {
            viewModelMediaInfoMusicNameJavaLangObjectNullBmwId9DashboardMusicNameAndroidStringKswIdf7UnkonwSoungViewModelMediaInfoMusicName = null;
        }
        if ((dirtyFlags & 516) != 0) {
            TextViewBindingAdapter.setText(this.bmwId9DashboardMusicName, viewModelMediaInfoMusicNameJavaLangObjectNullBmwId9DashboardMusicNameAndroidStringKswIdf7UnkonwSoungViewModelMediaInfoMusicName);
        }
        if ((dirtyFlags & 528) != 0) {
            CustomizeSeekBar.setProgress(this.bmwId9DashboardMusicSeekbar, viewModelMediaInfoProgressPercentGet);
        }
        if ((dirtyFlags & 513) != 0) {
        ...
        if ((dirtyFlags & 576) != 0) {
            BaseBindingModel.setID9AlbumIcon(this.mboundView2, viewModelMediaInfoPicGet);
        }
        if ((dirtyFlags & 520) != 0) {
