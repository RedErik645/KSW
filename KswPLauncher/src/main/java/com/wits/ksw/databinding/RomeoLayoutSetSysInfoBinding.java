...
public final class RomeoLayoutSetSysInfoBinding implements ViewBinding {
    public final LinearLayout romeoSysInfoLl;
    ...
    private RomeoLayoutSetSysInfoBinding(ScrollView rootView2, LinearLayout romeoSysInfoLl2, TextView tvInfoAppv2, MarqueeTextView tvInfoCpu2, TextView tvInfoMcuUp2, TextView tvInfoMcuv2, TextView tvInfoSysRest2, TextView tvInfoSysUpDate2, TextView tvInfoSysv2, TextView tvSystemInfo3, TextView tvSystemInfo22) {
        this.rootView = rootView2;
        this.romeoSysInfoLl = romeoSysInfoLl2;
    ...
    public static RomeoLayoutSetSysInfoBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static RomeoLayoutSetSysInfoBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.romeo_layout_set_sys_info, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static RomeoLayoutSetSysInfoBinding bind(View rootView2) {
        int id = R.id.romeo_sys_info_ll;
        LinearLayout romeoSysInfoLl2 = (LinearLayout) rootView2.findViewById(R.id.romeo_sys_info_ll);
        if (romeoSysInfoLl2 != null) {
            id = R.id.tv_infoAppv;
                                    ...
                                    if (tvInfoSysv2 != null) {
                                        ...
                                        if (tvSystemInfo3 != null) {
                                            ...
                                            if (tvSystemInfo22 != null) {
                                                return new RomeoLayoutSetSysInfoBinding((ScrollView) rootView2, romeoSysInfoLl2, tvInfoAppv2, tvInfoCpu2, tvInfoMcuUp2, tvInfoMcuv2, tvInfoSysRest2, tvInfoSysUpDate2, tvInfoSysv2, tvSystemInfo3, tvSystemInfo22);
                                            }
                                        }
                                    }
                                }
