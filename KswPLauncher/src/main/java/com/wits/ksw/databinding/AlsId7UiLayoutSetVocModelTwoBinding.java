...
public final class AlsId7UiLayoutSetVocModelTwoBinding implements ViewBinding {
    ...
    private AlsId7UiLayoutSetVocModelTwoBinding(LinearLayout rootView2, SeekBar seekbarMdi2, SeekBar seekbarMgo2, SeekBar seekbarMzh2, TextView tvMdiSize2, TextView tvMgoSize2, TextView tvMzhSize2) {
    ...
    public static AlsId7UiLayoutSetVocModelTwoBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static AlsId7UiLayoutSetVocModelTwoBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.als_id7_ui_layout_set_voc_model_two, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static AlsId7UiLayoutSetVocModelTwoBinding bind(View rootView2) {
                ...
                if (seekbarMzh2 != null) {
                    ...
                    if (tvMdiSize2 != null) {
                        ...
                        if (tvMgoSize2 != null) {
                            ...
                            if (tvMzhSize2 != null) {
                                return new AlsId7UiLayoutSetVocModelTwoBinding((LinearLayout) rootView2, seekbarMdi2, seekbarMgo2, seekbarMzh2, tvMdiSize2, tvMgoSize2, tvMzhSize2);
                            }
                        }
                    }
                }
