...
public class ViewId9AlsModelBindingImpl extends ViewId9AlsModelBinding {
    ...
    public ViewId9AlsModelBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private ViewId9AlsModelBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.ViewId9AlsModelBinding
