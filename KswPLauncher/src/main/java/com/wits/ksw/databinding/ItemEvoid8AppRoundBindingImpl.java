...
public class ItemEvoid8AppRoundBindingImpl extends ItemEvoid8AppRoundBinding {
    ...
    public ItemEvoid8AppRoundBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private ItemEvoid8AppRoundBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.ItemEvoid8AppRoundBinding
