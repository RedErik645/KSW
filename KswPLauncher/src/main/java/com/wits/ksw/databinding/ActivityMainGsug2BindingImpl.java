...
public class ActivityMainGsug2BindingImpl extends ActivityMainGsug2Binding implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.mboundView4.setOnClickListener(this.mCallback335);
            this.musicButton.setOnClickListener(this.mCallback332);
            this.naviButton.setOnClickListener(this.mCallback333);
            this.settingButton.setOnClickListener(this.mCallback334);
        }
    }
