...
public class BenzNtg6FyFragmentOneClsV21024x600Impl extends BenzNtg6FyFragmentOneClsV2 {
    ...
    public BenzNtg6FyFragmentOneClsV21024x600Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 36, sIncludes, sViewsWithIds));
    }

    private BenzNtg6FyFragmentOneClsV21024x600Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
