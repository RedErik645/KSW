...
public final class AlsId7UiFactoryRawCarshowBinding implements ViewBinding {
    ...
    private AlsId7UiFactoryRawCarshowBinding(ScrollView rootView2, CheckBox cboxDcld2, RecyclerView rawCarRecycle2, TextView tvRawCarSele2, TextView tvrawCarTite2) {
    ...
    public static AlsId7UiFactoryRawCarshowBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static AlsId7UiFactoryRawCarshowBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.als_id7_ui_factory_raw_carshow, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static AlsId7UiFactoryRawCarshowBinding bind(View rootView2) {
            ...
            if (rawCarRecycle2 != null) {
                ...
                if (tvRawCarSele2 != null) {
                    ...
                    if (tvrawCarTite2 != null) {
                        return new AlsId7UiFactoryRawCarshowBinding((ScrollView) rootView2, cboxDcld2, rawCarRecycle2, tvRawCarSele2, tvrawCarTite2);
                    }
                }
            }
        }
