...
public class AudiMib3OneDataClsV2Hdpi1920x720Impl extends AudiMib3OneDataClsV2 {
    ...
    public AudiMib3OneDataClsV2Hdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 25, sIncludes, sViewsWithIds));
    }

    private AudiMib3OneDataClsV2Hdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (BenzMbuxItemView) bindings[7], (ImageView) bindings[8], (TextView) bindings[9], (BenzMbuxItemView) bindings[16], (ImageView) bindings[17], (TextView) bindings[18], (LinearLayout) bindings[0], (BenzMbuxItemView) bindings[4], (ImageView) bindings[5], (TextView) bindings[6], (BenzMbuxItemView) bindings[10], (ImageView) bindings[11], (TextView) bindings[12], (BenzMbuxItemView) bindings[13], (ImageView) bindings[14], (TextView) bindings[15], (BenzMbuxItemView) bindings[22], (ImageView) bindings[23], (TextView) bindings[24], (BenzMbuxItemView) bindings[1], (ImageView) bindings[2], (TextView) bindings[3], (BenzMbuxItemView) bindings[19], (ImageView) bindings[20], (TextView) bindings[21]);
        this.mDirtyFlags = -1;
    ...
    @Override // com.wits.ksw.databinding.AudiMib3OneDataClsV2
