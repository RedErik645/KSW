...
public abstract class NavigatePempDataBinding extends ViewDataBinding {
    ...
    protected NavigatePempDataBinding(Object _bindingComponent, View _root, int _localFieldCount, ImageView ivMask2, RelativeLayout llContainer2, TextView tvDesc2) {
    ...
    public static NavigatePempDataBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (NavigatePempDataBinding) ViewDataBinding.inflateInternal(inflater, R.layout.fragment_pemp_navigate, root, attachToRoot, component);
    }
    ...
    public static NavigatePempDataBinding inflate(LayoutInflater inflater, Object component) {
        return (NavigatePempDataBinding) ViewDataBinding.inflateInternal(inflater, R.layout.fragment_pemp_navigate, null, false, component);
    }
    ...
    public static NavigatePempDataBinding bind(View view, Object component) {
        return (NavigatePempDataBinding) bind(component, view, R.layout.fragment_pemp_navigate);
    }
}
