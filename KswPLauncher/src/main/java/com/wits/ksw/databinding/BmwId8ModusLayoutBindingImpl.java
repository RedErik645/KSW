...
public class BmwId8ModusLayoutBindingImpl extends BmwId8ModusLayoutBinding implements OnClickListener.Listener {
    ...
    static {
        ...
        includedLayouts.setIncludes(0, new String[]{"id8_launcher_left_bar"}, new int[]{10}, new int[]{R.layout.id8_launcher_left_bar});
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags & 32) != 0) {
            this.llModusEfficientImg.setOnClickListener(this.mCallback297);
            this.llModusPersonalImg.setOnClickListener(this.mCallback295);
            this.llModusSportImg.setOnClickListener(this.mCallback296);
        }
        if ((dirtyFlags & 50) != 0) {
