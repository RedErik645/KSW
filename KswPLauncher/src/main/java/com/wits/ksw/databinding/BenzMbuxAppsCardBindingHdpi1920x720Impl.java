...
public class BenzMbuxAppsCardBindingHdpi1920x720Impl extends BenzMbuxAppsCardBinding implements OnClickListener.Listener {
    ...
    public BenzMbuxAppsCardBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzMbuxAppsCardBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.BenzMbuxAppsCardBinding
    ...
    public void executeBindings() {
        ...
        Drawable viewModelItemIconClassicalBenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeAppSelector1BenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeAppSelector2 = null;
        ...
        if ((dirtyFlags & 7) != 0) {
            ...
            viewModelItemIconClassicalBenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeAppSelector1BenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeAppSelector2 = AppCompatResources.getDrawable(this.benzMbuxLocalCardBg.getContext(), viewModelItemIconClassicalGet ? R.drawable.benz_mbux_2021_ksw_home_app_selector1 : R.drawable.benz_mbux_2021_ksw_home_app_selector2);
        }
        if ((7 & dirtyFlags) != 0) {
            ImageViewBindingAdapter.setImageDrawable(this.benzMbuxLocalCardBg, viewModelItemIconClassicalBenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeAppSelector1BenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeAppSelector2);
        }
        if ((4 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback243);
            this.mboundView2.setOnClickListener(this.mCallback244);
            this.mboundView3.setOnClickListener(this.mCallback245);
        }
    }
        ...
        switch (sourceId) {
            case 1:
                ...
                if (viewModelJavaLangObjectNull) {
                    viewModel.openApps(callbackArg_0);
                    return;
                }
                return;
            case 2:
                ...
                if (viewModelJavaLangObjectNull) {
                    viewModel2.addWidget(callbackArg_0);
                    return;
                }
                return;
            case 3:
