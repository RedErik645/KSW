...
public class BenzMbux2021ItemBindingImpl extends BenzMbux2021ItemBinding implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((4 & dirtyFlags) != 0) {
            this.benzMbux2021ImageView.setOnClickListener(this.mCallback136);
            this.benzMbux2021Tip.setOnClickListener(this.mCallback137);
            this.mboundView4.setOnClickListener(this.mCallback138);
            this.mboundView5.setOnClickListener(this.mCallback139);
        }
        if ((5 & dirtyFlags) != 0) {
