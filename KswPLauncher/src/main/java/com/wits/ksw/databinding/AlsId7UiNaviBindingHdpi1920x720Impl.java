...
public class AlsId7UiNaviBindingHdpi1920x720Impl extends AlsId7UiNaviBinding {
    ...
    static {
        ...
        includedLayouts.setIncludes(0, new String[]{"als_id7_ui_sub_navi_view", "als_id7_ui_sub_phone_view"}, new int[]{1, 2}, new int[]{R.layout.als_id7_ui_sub_navi_view, R.layout.als_id7_ui_sub_phone_view});
    }

    public AlsId7UiNaviBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }

    private AlsId7UiNaviBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean hasPendingBindings() {
        ...
        L_0x0021:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.wits.ksw.databinding.AlsId7UiNaviBindingHdpi1920x720Impl.hasPendingBindings():boolean");
    }
