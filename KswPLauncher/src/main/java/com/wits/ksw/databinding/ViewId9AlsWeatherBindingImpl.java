...
public class ViewId9AlsWeatherBindingImpl extends ViewId9AlsWeatherBinding {
    ...
    public ViewId9AlsWeatherBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private ViewId9AlsWeatherBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.ViewId9AlsWeatherBinding
