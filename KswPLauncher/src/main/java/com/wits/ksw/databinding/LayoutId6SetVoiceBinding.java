...
public final class LayoutId6SetVoiceBinding implements ViewBinding {
    ...
    private LayoutId6SetVoiceBinding(ScrollView rootView2, SeekBar seekDaohvoicb2, SeekBar seekMtb2, SeekBar seekTonghb2, SeekBar seekYuancthb2, TextView tvDaohvoicsize2, TextView tvHouzvoc2, TextView tvMtsize2, TextView tvTonghsize2, TextView tvYuancthsize2, TextView tvYuancvoc2) {
    ...
    public static LayoutId6SetVoiceBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static LayoutId6SetVoiceBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.layout_id6_set_voice, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static LayoutId6SetVoiceBinding bind(View rootView2) {
                                ...
                                if (tvMtsize2 != null) {
                                    ...
                                    if (tvTonghsize2 != null) {
                                        ...
                                        if (tvYuancthsize2 != null) {
                                            ...
                                            if (tvYuancvoc2 != null) {
                                                return new LayoutId6SetVoiceBinding((ScrollView) rootView2, seekDaohvoicb2, seekMtb2, seekTonghb2, seekYuancthb2, tvDaohvoicsize2, tvHouzvoc2, tvMtsize2, tvTonghsize2, tvYuancthsize2, tvYuancvoc2);
                                            }
                                        }
                                    }
                                }
