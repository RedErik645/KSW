...
public abstract class BenzNtgFyDashboardCardBinding extends ViewDataBinding {
    ...
    protected BenzNtgFyDashboardCardBinding(Object _bindingComponent, View _root, int _localFieldCount, AppCompatImageView benzMbuxLocalCardBg2, AppCompatTextView benzMbuxLocalCardContent2, AppCompatTextView benzMbuxLocalCardTitle2) {
    ...
    public static BenzNtgFyDashboardCardBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (BenzNtgFyDashboardCardBinding) ViewDataBinding.inflateInternal(inflater, R.layout.benz_ntg_fy_dashboard_card, root, attachToRoot, component);
    }
    ...
    public static BenzNtgFyDashboardCardBinding inflate(LayoutInflater inflater, Object component) {
        return (BenzNtgFyDashboardCardBinding) ViewDataBinding.inflateInternal(inflater, R.layout.benz_ntg_fy_dashboard_card, null, false, component);
    }
    ...
    public static BenzNtgFyDashboardCardBinding bind(View view, Object component) {
        return (BenzNtgFyDashboardCardBinding) bind(component, view, R.layout.benz_ntg_fy_dashboard_card);
    }
}
