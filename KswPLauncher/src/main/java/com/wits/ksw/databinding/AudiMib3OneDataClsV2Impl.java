...
public class AudiMib3OneDataClsV2Impl extends AudiMib3OneDataClsV2 {
    ...
    public AudiMib3OneDataClsV2Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 25, sIncludes, sViewsWithIds));
    }

    private AudiMib3OneDataClsV2Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
