...
public class MediaFragmentImpl extends MediaFragment {
    ...
    public MediaFragmentImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }

    private MediaFragmentImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean hasPendingBindings() {
        ...
        L_0x000c:
            monitor-exit(r4)     // Catch:{ all -> 0x0021 }
            com.wits.ksw.databinding.Id7SubMusicViewBinding r0 = r4.mboundView0
            boolean r0 = r0.hasPendingBindings()
            if (r0 == 0) goto L_0x0016
            return r1
        L_0x0016:
            com.wits.ksw.databinding.Id7SubVideoViewBinding r0 = r4.mboundView02
            boolean r0 = r0.hasPendingBindings()
        ...
        L_0x0021:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.wits.ksw.databinding.MediaFragmentImpl.hasPendingBindings():boolean");
    }
