...
public class BenzMbuxDashboardCardBindingHdpi1920x720Impl extends BenzMbuxDashboardCardBinding implements OnClickListener.Listener {
    ...
    public BenzMbuxDashboardCardBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzMbuxDashboardCardBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((4 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback319);
            this.mboundView2.setOnClickListener(this.mCallback320);
