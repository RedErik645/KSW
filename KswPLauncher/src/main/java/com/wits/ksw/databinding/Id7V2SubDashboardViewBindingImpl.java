...
public class Id7V2SubDashboardViewBindingImpl extends Id7V2SubDashboardViewBinding implements OnClickListener.Listener {
    ...
    public Id7V2SubDashboardViewBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }

    private Id7V2SubDashboardViewBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags & 256) != 0) {
            this.dashboardImageView.setOnClickListener(this.mCallback19);
        }
        if ((dirtyFlags & 288) != 0) {
