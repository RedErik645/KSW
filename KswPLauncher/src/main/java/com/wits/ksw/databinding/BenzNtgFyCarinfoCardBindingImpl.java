...
public class BenzNtgFyCarinfoCardBindingImpl extends BenzNtgFyCarinfoCardBinding implements OnClickListener.Listener {
    ...
    public BenzNtgFyCarinfoCardBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzNtgFyCarinfoCardBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback107);
