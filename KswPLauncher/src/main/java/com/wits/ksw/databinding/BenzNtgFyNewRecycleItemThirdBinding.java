...
public final class BenzNtgFyNewRecycleItemThirdBinding implements ViewBinding {
    ...
    public static BenzNtgFyNewRecycleItemThirdBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static BenzNtgFyNewRecycleItemThirdBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.benz_ntg_fy_new_recycle_item_third, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static BenzNtgFyNewRecycleItemThirdBinding bind(View rootView2) {
                                ...
                                if (benzMbuxEditLeftBtn2 != null) {
                                    ...
                                    if (benzMbuxEditOkBtn2 != null) {
                                        ...
                                        if (benzMbuxEditRightBtn2 != null) {
                                            return new BenzNtgFyNewRecycleItemThirdBinding((ConstraintLayout) rootView2, benzMbux2021KswNewItemBg2, benzMbux2021KswNewItemContent2, benzMbux2021KswNewItemImg2, benzMbux2021KswNewItemTitle2, benzMbuxEditDeleteBtn2, benzMbuxEditLay2, benzMbuxEditLeftBtn2, benzMbuxEditOkBtn2, benzMbuxEditRightBtn2);
                                        }
                                    }
                                }
                            }
