...
public class AudiMib3MainLeftBindingImpl extends AudiMib3MainLeftBinding {
    ...
    public AudiMib3MainLeftBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private AudiMib3MainLeftBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
