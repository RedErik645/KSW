...
public class Id7V2SubPhoneViewBindingSw600dpLandImpl extends Id7V2SubPhoneViewBinding implements OnClickListener.Listener {
    ...
    public Id7V2SubPhoneViewBindingSw600dpLandImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private Id7V2SubPhoneViewBindingSw600dpLandImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.phoneImageView1.setTag(null);
        setRootTag(root);
    ...
    @Override // com.wits.ksw.databinding.Id7V2SubPhoneViewBinding
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags & 16) != 0) {
            this.phoneImageView1.setOnClickListener(this.mCallback331);
        }
        if ((dirtyFlags & 24) != 0) {
