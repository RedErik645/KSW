...
public abstract class AudiMib3SysinfoBinding extends ViewDataBinding {
    ...
    public final MarqueeTextView audiSysInfoCpu;
    ...
    public static AudiMib3SysinfoBinding inflate(LayoutInflater inflater, Object component) {
        return (AudiMib3SysinfoBinding) ViewDataBinding.inflateInternal(inflater, R.layout.audi_mib3_sysinfo, null, false, component);
    }
