...
public class Benz2021KswFragmentThreeHdpi1280x720Impl extends Benz2021KswFragmentThree {
    ...
    static {
        ...
        sparseIntArray.put(R.id.phonelink_rl, 9);
        sparseIntArray.put(R.id.phonelink_tv, 10);
        sparseIntArray.put(R.id.phonelink_tip, 11);
        sparseIntArray.put(R.id.iv_phone1, 12);
        sparseIntArray.put(R.id.iv_phone2, 13);
    ...
    public Benz2021KswFragmentThreeHdpi1280x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 19, sIncludes, sViewsWithIds));
    }

    private Benz2021KswFragmentThreeHdpi1280x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1, (BenzMbuxItemView) bindings[1], (RelativeLayout) bindings[4], (TextView) bindings[6], (TextView) bindings[5], (BenzMbuxItemView) bindings[3], (RelativeLayout) bindings[14], (TextView) bindings[16], (TextView) bindings[15], (LinearLayout) bindings[0], (ImageView) bindings[7], (ImageView) bindings[8], (ImageView) bindings[17], (ImageView) bindings[18], (ImageView) bindings[12], (ImageView) bindings[13], (BenzMbuxItemView) bindings[2], (RelativeLayout) bindings[9], (TextView) bindings[11], (TextView) bindings[10], null, null, null);
        this.mDirtyFlags = -1;
