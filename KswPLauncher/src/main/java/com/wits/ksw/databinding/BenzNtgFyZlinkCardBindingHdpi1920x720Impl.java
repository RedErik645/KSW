...
public class BenzNtgFyZlinkCardBindingHdpi1920x720Impl extends BenzNtgFyZlinkCardBinding implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback337);
            this.mboundView2.setOnClickListener(this.mCallback338);
            this.mboundView3.setOnClickListener(this.mCallback339);
        }
    }
