...
public class LandroverTwoFragment1920x660Impl extends LandroverTwoFragment implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.landroverMainIconApp.setOnClickListener(this.mCallback326);
            this.landroverMainIconBrowser.setOnClickListener(this.mCallback327);
            this.landroverMainIconBt.setOnClickListener(this.mCallback322);
            this.landroverMainIconDashboard.setOnClickListener(this.mCallback324);
            this.landroverMainIconFile.setOnClickListener(this.mCallback323);
            this.landroverMainIconPhonelink.setOnClickListener(this.mCallback325);
        }
        if ((3 & dirtyFlags) != 0) {
