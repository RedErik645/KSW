...
public class Benz2021FragmentTwoHdpi1280x720Impl extends Benz2021FragmentTwo {
    ...
    public Benz2021FragmentTwoHdpi1280x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 24, sIncludes, sViewsWithIds));
    }

    private Benz2021FragmentTwoHdpi1280x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    /* JADX WARN: Type inference failed for: r69v0, types: [com.wits.ksw.databinding.Benz2021FragmentTwoHdpi1280x720Impl] */
    /* access modifiers changed from: protected */
    @Override // android.databinding.ViewDataBinding
    public void executeBindings() {
        ...
        BcVieModel viewModel = ((Benz2021FragmentTwoHdpi1280x720Impl) this).mViewModel;
        ...
        if ((dirtyFlags & 127) != 0) {
            ...
            if ((dirtyFlags & 126) != 0) {
                ...
                if ((dirtyFlags & 80) != 0) {
                    ...
                    if (viewModelMediaInfoPicJavaLangObjectNull) {
                        context3 = ((Benz2021FragmentTwoHdpi1280x720Impl) this).musicItemview.getContext();
        ...
        if ((dirtyFlags & 65) == 0) {
            ...
            viewModelMediaInfoPicJavaLangObjectNullViewModelItemIconClassicalMboundView4AndroidDrawableBenzMbux2021HomeMusicSelector1MboundView4AndroidDrawableBenzMbux2021HomeMusicSelector2ViewModelMediaInfoPicZoom = null;
            viewModelMediaInfoSongInfoJavaLangObjectNullMusicTipAndroidStringKswIdf7UnkonwSoungViewModelMediaInfoSongInfo = ((Benz2021FragmentTwoHdpi1280x720Impl) this).musicTip.getResources().getString(R.string.ksw_idf7_unkonw_soung);
        } else {
            viewModelMediaInfoPicJavaLangObjectNullViewModelItemIconClassicalMboundView4AndroidDrawableBenzMbux2021HomeMusicSelector1MboundView4AndroidDrawableBenzMbux2021HomeMusicSelector2ViewModelMediaInfoPicZoom = null;
        ...
        if ((dirtyFlags & 268713984) != 0) {
            ...
            if ((dirtyFlags & PlaybackStateCompat.ACTION_PREPARE) != 0) {
                if (viewModelIsYOGet) {
                    context2 = ((Benz2021FragmentTwoHdpi1280x720Impl) this).setItemview.getContext();
        ...
        if ((dirtyFlags & 80) != 0) {
            ...
            ViewBindingAdapter.setBackground(((Benz2021FragmentTwoHdpi1280x720Impl) this).musicItemview, viewModelMediaInfoPicJavaLangObjectNullMusicItemviewAndroidDrawableTranspMusicItemviewAndroidDrawableBenzMbux2021AlbumSelector);
        }
        if ((dirtyFlags & 122) != 0) {
        ...
        if ((dirtyFlags & 65) != 0) {
            TextViewBindingAdapter.setText(((Benz2021FragmentTwoHdpi1280x720Impl) this).musicTip, viewModelMediaInfoSongInfoJavaLangObjectNullMusicTipAndroidStringKswIdf7UnkonwSoungViewModelMediaInfoSongInfo);
        }
        if ((dirtyFlags & 102) != 0) {
            ImageViewBindingAdapter.setImageDrawable(((Benz2021FragmentTwoHdpi1280x720Impl) this).setItemview, viewModelItemIconClassicalViewModelIsYOSetItemviewAndroidDrawableBenzMbuxYoHomeSettingSelector1SetItemviewAndroidDrawableBenzMbux2021HomeSettingSelector1SetItemviewAndroidDrawableBenzMbux2021HomeSettingSelector2);
            ImageViewBindingAdapter.setImageDrawable(((Benz2021FragmentTwoHdpi1280x720Impl) this).videoItemview, viewModelItemIconClassicalViewModelIsYOVideoItemviewAndroidDrawableBenzMbuxYoHomeVideoSelector1VideoItemviewAndroidDrawableBenzMbux2021HomeVideoSelector1VideoItemviewAndroidDrawableBenzMbux2021HomeVideoSelector2);
        }
    }
}
