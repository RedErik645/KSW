...
public final class BenzMbux2021KswNewRecycleItemBinding implements ViewBinding {
    ...
    public static BenzMbux2021KswNewRecycleItemBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static BenzMbux2021KswNewRecycleItemBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.benz_mbux_2021_ksw_new_recycle_item, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static BenzMbux2021KswNewRecycleItemBinding bind(View rootView2) {
