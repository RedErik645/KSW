...
public abstract class BenzNtgFyAppsCardBinding extends ViewDataBinding {
    ...
    protected BenzNtgFyAppsCardBinding(Object _bindingComponent, View _root, int _localFieldCount, AppCompatImageView benzMbuxLocalCardBg2, AppCompatTextView benzMbuxLocalCardContent2, AppCompatTextView benzMbuxLocalCardTitle2) {
    ...
    public static BenzNtgFyAppsCardBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (BenzNtgFyAppsCardBinding) ViewDataBinding.inflateInternal(inflater, R.layout.benz_ntg_fy_apps_card, root, attachToRoot, component);
    }
    ...
    public static BenzNtgFyAppsCardBinding inflate(LayoutInflater inflater, Object component) {
        return (BenzNtgFyAppsCardBinding) ViewDataBinding.inflateInternal(inflater, R.layout.benz_ntg_fy_apps_card, null, false, component);
    }
    ...
    public static BenzNtgFyAppsCardBinding bind(View view, Object component) {
        return (BenzNtgFyAppsCardBinding) bind(component, view, R.layout.benz_ntg_fy_apps_card);
    }
}
