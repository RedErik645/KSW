...
public final class LayoutSetVocModelBinding implements ViewBinding {
    ...
    private LayoutSetVocModelBinding(ScrollView rootView2, RtlRadioButton rdbVocmd12, RtlRadioButton rdbVocmd22, RtlRadioButton rdbVocmd32, RtlRadioButton rdbVocmd42, RtlRadioButton rdbVocmd52, RtlRadioButton rdbVocmd62, RadioGroup rdgVocmd2) {
    ...
    public static LayoutSetVocModelBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static LayoutSetVocModelBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.layout_set_voc_model, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static LayoutSetVocModelBinding bind(View rootView2) {
                    ...
                    if (rdbVocmd42 != null) {
                        ...
                        if (rdbVocmd52 != null) {
                            ...
                            if (rdbVocmd62 != null) {
                                ...
                                if (rdgVocmd2 != null) {
                                    return new LayoutSetVocModelBinding((ScrollView) rootView2, rdbVocmd12, rdbVocmd22, rdbVocmd32, rdbVocmd42, rdbVocmd52, rdbVocmd62, rdgVocmd2);
                                }
                            }
                        }
                    }
