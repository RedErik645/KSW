...
public class AudiMib3TwoDataClsHdpi1560x700Impl extends AudiMib3TwoDataCls {
    ...
    public AudiMib3TwoDataClsHdpi1560x700Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds));
    }

    private AudiMib3TwoDataClsHdpi1560x700Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.AudiMib3TwoDataCls
