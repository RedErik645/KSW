...
public class Id7SubVideoViewBindingImpl extends Id7SubVideoViewBinding implements OnClickListener.Listener {
    ...
    private Id7SubVideoViewBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.Id7SubVideoViewBinding
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.videoImageView.setOnClickListener(this.mCallback24);
        }
        if ((3 & dirtyFlags) != 0) {
