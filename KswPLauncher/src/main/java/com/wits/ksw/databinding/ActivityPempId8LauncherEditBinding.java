...
public final class ActivityPempId8LauncherEditBinding implements ViewBinding {
    ...
    public static ActivityPempId8LauncherEditBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityPempId8LauncherEditBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.activity_pemp_id8_launcher_edit, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static ActivityPempId8LauncherEditBinding bind(View rootView2) {
                                                        ...
                                                        if (flContent82 != null) {
                                                            ...
                                                            if (flContent92 != null) {
                                                                ...
                                                                if (llContaine2 != null) {
                                                                    ...
                                                                    if (scrollView2 != null) {
                                                                        return new ActivityPempId8LauncherEditBinding((RelativeLayout) rootView2, flContent15, flContent102, flContent112, flContent122, flContent132, flContent142, flContent22, flContent32, flContent42, flContent52, flContent62, flContent72, flContent82, flContent92, llContaine2, scrollView2);
                                                                    }
                                                                }
                                                            }
                                                        }
