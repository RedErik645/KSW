...
public final class FactoryCanBusBinding implements ViewBinding {
    public final RecyclerView rawCarRecycle;
    private final ScrollView rootView;
    public final TextView tvRawCarSele;
    public final TextView tvRawSeleTitle;

    private FactoryCanBusBinding(ScrollView rootView2, RecyclerView rawCarRecycle2, TextView tvRawCarSele2, TextView tvRawSeleTitle2) {
    ...
    public static FactoryCanBusBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FactoryCanBusBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.factory_can_bus, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static FactoryCanBusBinding bind(View rootView2) {
        ...
        if (rawCarRecycle2 != null) {
            ...
            if (tvRawCarSele2 != null) {
                ...
                if (tvRawSeleTitle2 != null) {
                    return new FactoryCanBusBinding((ScrollView) rootView2, rawCarRecycle2, tvRawCarSele2, tvRawSeleTitle2);
                }
            }
        }
