...
public final class LandRoverLayoutSetSystemTwoBinding implements ViewBinding {
    ...
    public static LandRoverLayoutSetSystemTwoBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static LandRoverLayoutSetSystemTwoBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.land_rover_layout_set_system_two, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static LandRoverLayoutSetSystemTwoBinding bind(View rootView2) {
                                                                            ...
                                                                            if (tvBeigSize2 != null) {
                                                                                ...
                                                                                if (tvCauxSize3 != null) {
                                                                                    ...
                                                                                    if (tvCauxSize22 != null) {
                                                                                        ...
                                                                                        if (tvTebgld2 != null) {
                                                                                            return new LandRoverLayoutSetSystemTwoBinding((RelativeLayout) rootView2, imgTwoDefaul2, listviewMusic2, listviewVideo2, rdbShext12, rdbShext22, rdbShext32, rdbShext42, rdgShext2, rdgTempGroup3, rdgTempGroup12, rdgTempGroup22, relateAuxweiz2, relateBeigld2, relateShext2, seekbarBrightness2, seekbarCaux3, seekbarCaux22, tvBeigSize2, tvCauxSize3, tvCauxSize22, tvTebgld2);
                                                                                        }
                                                                                    }
                                                                                }
                                                                            }
