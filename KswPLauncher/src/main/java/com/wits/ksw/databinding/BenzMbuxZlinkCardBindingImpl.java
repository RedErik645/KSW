...
public class BenzMbuxZlinkCardBindingImpl extends BenzMbuxZlinkCardBinding implements OnClickListener.Listener {
    ...
    public BenzMbuxZlinkCardBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzMbuxZlinkCardBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        this.mCallback505 = new OnClickListener(this, 1);
        this.mCallback507 = new OnClickListener(this, 3);
        this.mCallback506 = new OnClickListener(this, 2);
        invalidateAll();
    }
    ...
    @Override // com.wits.ksw.databinding.BenzMbuxZlinkCardBinding
    ...
    public void executeBindings() {
        ...
        Drawable viewModelItemIconClassicalBenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeEasySelector1BenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeEasySelector2 = null;
        ...
        if ((dirtyFlags & 7) != 0) {
            ...
            viewModelItemIconClassicalBenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeEasySelector1BenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeEasySelector2 = AppCompatResources.getDrawable(this.benzMbuxLocalCardBg.getContext(), viewModelItemIconClassicalGet ? R.drawable.benz_mbux_2021_ksw_home_easy_selector1 : R.drawable.benz_mbux_2021_ksw_home_easy_selector2);
        }
        if ((7 & dirtyFlags) != 0) {
            ImageViewBindingAdapter.setImageDrawable(this.benzMbuxLocalCardBg, viewModelItemIconClassicalBenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeEasySelector1BenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeEasySelector2);
        }
        if ((4 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback505);
            this.mboundView2.setOnClickListener(this.mCallback506);
            this.mboundView3.setOnClickListener(this.mCallback507);
        }
    }
