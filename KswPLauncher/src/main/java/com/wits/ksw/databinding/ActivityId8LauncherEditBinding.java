...
public final class ActivityId8LauncherEditBinding implements ViewBinding {
    ...
    private ActivityId8LauncherEditBinding(RelativeLayout rootView2, FrameLayout flContent15, FrameLayout flContent102, FrameLayout flContent112, FrameLayout flContent122, FrameLayout flContent132, FrameLayout flContent142, FrameLayout flContent22, FrameLayout flContent32, FrameLayout flContent42, FrameLayout flContent52, FrameLayout flContent62, FrameLayout flContent72, FrameLayout flContent82, FrameLayout flContent92, LinearLayout llContainer2, HorizontalScrollView scrollView2) {
    ...
    public static ActivityId8LauncherEditBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityId8LauncherEditBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.activity_id8_launcher_edit, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static ActivityId8LauncherEditBinding bind(View rootView2) {
                                                        ...
                                                        if (flContent82 != null) {
                                                            ...
                                                            if (flContent92 != null) {
                                                                ...
                                                                if (llContainer2 != null) {
                                                                    ...
                                                                    if (scrollView2 != null) {
                                                                        return new ActivityId8LauncherEditBinding((RelativeLayout) rootView2, flContent15, flContent102, flContent112, flContent122, flContent132, flContent142, flContent22, flContent32, flContent42, flContent52, flContent62, flContent72, flContent82, flContent92, llContainer2, scrollView2);
                                                                    }
                                                                }
                                                            }
                                                        }
