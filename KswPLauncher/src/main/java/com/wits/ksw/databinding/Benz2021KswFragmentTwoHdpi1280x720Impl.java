...
public class Benz2021KswFragmentTwoHdpi1280x720Impl extends Benz2021KswFragmentTwo {
    ...
    static {
        ...
        sparseIntArray.put(R.id.car_rl, 8);
        sparseIntArray.put(R.id.car_tv, 9);
        sparseIntArray.put(R.id.car_tip, 10);
        sparseIntArray.put(R.id.iv_car1, 11);
        sparseIntArray.put(R.id.iv_car2, 12);
        ...
        sparseIntArray.put(R.id.phonelink_rl, 29);
        sparseIntArray.put(R.id.phonelink_tv, 30);
        sparseIntArray.put(R.id.phonelink_tip, 31);
        sparseIntArray.put(R.id.iv_phone1, 32);
        sparseIntArray.put(R.id.space3, 33);
        sparseIntArray.put(R.id.iv_phone2, 34);
