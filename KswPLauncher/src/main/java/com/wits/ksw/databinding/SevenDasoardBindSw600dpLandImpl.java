...
public class SevenDasoardBindSw600dpLandImpl extends SevenDasoardBind implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags & PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH) != 0) {
            this.mboundView17.setOnClickListener(this.mCallback426);
            this.mboundView18.setOnClickListener(this.mCallback427);
            this.mboundView19.setOnClickListener(this.mCallback428);
            this.mboundView20.setOnClickListener(this.mCallback429);
            this.mboundView21.setOnClickListener(this.mCallback430);
            this.mboundView22.setOnClickListener(this.mCallback431);
            this.mboundView23.setOnClickListener(this.mCallback432);
        }
