...
public class BenzMbuxVideoCardBindingHdpi1920x720Impl extends BenzMbuxVideoCardBinding implements OnClickListener.Listener {
    ...
    public BenzMbuxVideoCardBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzMbuxVideoCardBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((4 & dirtyFlags) != 0) {
            ...
            this.mboundView2.setOnClickListener(this.mCallback308);
            this.mboundView3.setOnClickListener(this.mCallback309);
        }
    }
