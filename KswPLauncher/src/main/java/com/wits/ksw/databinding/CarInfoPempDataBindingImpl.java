...
public class CarInfoPempDataBindingImpl extends CarInfoPempDataBinding implements OnClickListener.Listener {
    ...
    public CarInfoPempDataBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }

    private CarInfoPempDataBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.CarInfoPempDataBinding
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.ivMask.setOnClickListener(this.mCallback580);
        }
        if ((3 & dirtyFlags) != 0) {
