...
public class AlsId7UiMusicSubViewBindingHdpi1920x720Impl extends AlsId7UiMusicSubViewBinding implements OnClickListener.Listener {
    ...
    public AlsId7UiMusicSubViewBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 23, sIncludes, sViewsWithIds));
    }

    private AlsId7UiMusicSubViewBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags & 512) != 0) {
            this.imageFrameLayout.setOnClickListener(this.mCallback560);
        }
        if ((dirtyFlags & 768) != 0) {
