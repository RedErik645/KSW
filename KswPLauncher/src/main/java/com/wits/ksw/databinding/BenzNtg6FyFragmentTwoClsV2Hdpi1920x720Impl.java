...
public class BenzNtg6FyFragmentTwoClsV2Hdpi1920x720Impl extends BenzNtg6FyFragmentTwoClsV2 {
    ...
    public BenzNtg6FyFragmentTwoClsV2Hdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 36, sIncludes, sViewsWithIds));
    }

    private BenzNtg6FyFragmentTwoClsV2Hdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
