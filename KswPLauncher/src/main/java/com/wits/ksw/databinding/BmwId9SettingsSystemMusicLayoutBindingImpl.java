...
public class BmwId9SettingsSystemMusicLayoutBindingImpl extends BmwId9SettingsSystemMusicLayoutBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.bmw_id9_settings_music_recycle, 2);
    }

    public BmwId9SettingsSystemMusicLayoutBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }

    private BmwId9SettingsSystemMusicLayoutBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.BmwId9SettingsSystemMusicLayoutBinding
