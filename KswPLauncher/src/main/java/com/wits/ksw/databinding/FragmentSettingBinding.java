...
public final class FragmentSettingBinding implements ViewBinding {
    ...
    private FragmentSettingBinding(RelativeLayout rootView2, ImageView ivMask2, RelativeLayout llContainer2, TextView tvDesc2) {
    ...
    public static FragmentSettingBinding bind(View rootView2) {
        int id = R.id.iv_mask;
        ...
        if (ivMask2 != null) {
            ...
            if (tvDesc2 != null) {
                return new FragmentSettingBinding((RelativeLayout) rootView2, ivMask2, llContainer2, tvDesc2);
            }
        }
