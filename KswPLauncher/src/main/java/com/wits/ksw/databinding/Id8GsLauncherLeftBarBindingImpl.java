...
public class Id8GsLauncherLeftBarBindingImpl extends Id8GsLauncherLeftBarBinding implements OnClickListener.Listener {
    ...
    @Override // com.wits.ksw.databinding.Id8GsLauncherLeftBarBinding
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.llLeft1.setOnClickListener(this.mCallback209);
            this.llLeft2.setOnClickListener(this.mCallback210);
        }
    }
