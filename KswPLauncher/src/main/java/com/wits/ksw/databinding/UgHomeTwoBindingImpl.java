...
public class UgHomeTwoBindingImpl extends UgHomeTwoBinding implements OnClickListener.Listener {
    ...
    @Override // com.wits.ksw.databinding.UgHomeTwoBinding
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.ugHomeAppVaiw.setOnClickListener(this.mCallback7);
            this.ugHomeEasyVaiw.setOnClickListener(this.mCallback8);
            this.ugHomeHdvideoVaiw.setOnClickListener(this.mCallback6);
        }
    }
