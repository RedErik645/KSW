...
public class BenzMbuxDashboardCardBindingImpl extends BenzMbuxDashboardCardBinding implements OnClickListener.Listener {
    ...
    public BenzMbuxDashboardCardBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzMbuxDashboardCardBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.BenzMbuxDashboardCardBinding
    ...
    public void executeBindings() {
        ...
        Drawable viewModelItemIconClassicalBenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeDashboardSelector1BenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeDashboardSelector2 = null;
        ...
        if ((dirtyFlags & 7) != 0) {
            ...
            viewModelItemIconClassicalBenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeDashboardSelector1BenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeDashboardSelector2 = AppCompatResources.getDrawable(this.benzMbuxLocalCardBg.getContext(), viewModelItemIconClassicalGet ? R.drawable.benz_mbux_2021_ksw_home_dashboard_selector1 : R.drawable.benz_mbux_2021_ksw_home_dashboard_selector2);
        }
        if ((7 & dirtyFlags) != 0) {
            ImageViewBindingAdapter.setImageDrawable(this.benzMbuxLocalCardBg, viewModelItemIconClassicalBenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeDashboardSelector1BenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeDashboardSelector2);
        }
        if ((4 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback573);
            this.mboundView2.setOnClickListener(this.mCallback574);
            this.mboundView3.setOnClickListener(this.mCallback575);
        }
    }
