...
public class Benz2021KswFragmentTwoImpl extends Benz2021KswFragmentTwo {
    ...
    static {
        ...
        sparseIntArray.put(R.id.space7, 12);
        sparseIntArray.put(R.id.iv_car2, 13);
        sparseIntArray.put(R.id.setting_rl, 14);
        sparseIntArray.put(R.id.set_tv, 15);
        sparseIntArray.put(R.id.set_tip, 16);
        sparseIntArray.put(R.id.iv_set1, 17);
        sparseIntArray.put(R.id.space6, 18);
        sparseIntArray.put(R.id.iv_set2, 19);
        sparseIntArray.put(R.id.video_rl, 20);
        sparseIntArray.put(R.id.video_tv, 21);
        sparseIntArray.put(R.id.bt_tip, 22);
        sparseIntArray.put(R.id.iv_video1, 23);
        sparseIntArray.put(R.id.space1, 24);
        sparseIntArray.put(R.id.iv_video2, 25);
        sparseIntArray.put(R.id.app_rl, 26);
        sparseIntArray.put(R.id.app_tv, 27);
        sparseIntArray.put(R.id.app_tip, 28);
        sparseIntArray.put(R.id.iv_apps1, 29);
        sparseIntArray.put(R.id.space2, 30);
        sparseIntArray.put(R.id.iv_apps2, 31);
        sparseIntArray.put(R.id.phonelink_rl, 32);
        sparseIntArray.put(R.id.phonelink_tv, 33);
        sparseIntArray.put(R.id.phonelink_tip, 34);
        sparseIntArray.put(R.id.iv_phone1, 35);
        sparseIntArray.put(R.id.space3, 36);
        sparseIntArray.put(R.id.iv_phone2, 37);
        sparseIntArray.put(R.id.dashboard_rl, 38);
        sparseIntArray.put(R.id.dashboard_tv, 39);
        sparseIntArray.put(R.id.dashboard_tip, 40);
        sparseIntArray.put(R.id.iv_dash1, 41);
        sparseIntArray.put(R.id.space, 42);
        sparseIntArray.put(R.id.iv_dash2, 43);
        sparseIntArray.put(R.id.dvr_rl, 44);
        sparseIntArray.put(R.id.dvr_tv, 45);
        sparseIntArray.put(R.id.dvr_tip, 46);
        sparseIntArray.put(R.id.iv_dvr1, 47);
        sparseIntArray.put(R.id.space5, 48);
        sparseIntArray.put(R.id.iv_dvr2, 49);
    }
