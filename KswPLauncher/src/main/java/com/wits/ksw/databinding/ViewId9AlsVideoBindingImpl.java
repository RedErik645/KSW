...
public class ViewId9AlsVideoBindingImpl extends ViewId9AlsVideoBinding {
    ...
    public ViewId9AlsVideoBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private ViewId9AlsVideoBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.ViewId9AlsVideoBinding
