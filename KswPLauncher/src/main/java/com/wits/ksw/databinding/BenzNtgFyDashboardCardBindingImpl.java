...
public class BenzNtgFyDashboardCardBindingImpl extends BenzNtgFyDashboardCardBinding implements OnClickListener.Listener {
    ...
    public BenzNtgFyDashboardCardBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzNtgFyDashboardCardBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.BenzNtgFyDashboardCardBinding
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback218);
            this.mboundView2.setOnClickListener(this.mCallback219);
            this.mboundView3.setOnClickListener(this.mCallback220);
        }
    }
