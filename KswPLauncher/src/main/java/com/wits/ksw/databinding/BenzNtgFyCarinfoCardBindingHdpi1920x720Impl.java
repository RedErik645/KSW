...
public class BenzNtgFyCarinfoCardBindingHdpi1920x720Impl extends BenzNtgFyCarinfoCardBinding implements OnClickListener.Listener {
    ...
    public BenzNtgFyCarinfoCardBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzNtgFyCarinfoCardBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.BenzNtgFyCarinfoCardBinding
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback201);
            this.mboundView2.setOnClickListener(this.mCallback202);
            this.mboundView3.setOnClickListener(this.mCallback203);
        }
    }
