...
public abstract class BenzNtgFyBtCardBinding extends ViewDataBinding {
    ...
    protected BenzNtgFyBtCardBinding(Object _bindingComponent, View _root, int _localFieldCount, AppCompatImageView benzMbuxLocalCardBg2, AppCompatTextView benzMbuxLocalCardContent2, AppCompatTextView benzMbuxLocalCardTitle2) {
    ...
    public static BenzNtgFyBtCardBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (BenzNtgFyBtCardBinding) ViewDataBinding.inflateInternal(inflater, R.layout.benz_ntg_fy_bt_card, root, attachToRoot, component);
    }
    ...
    public static BenzNtgFyBtCardBinding inflate(LayoutInflater inflater, Object component) {
        return (BenzNtgFyBtCardBinding) ViewDataBinding.inflateInternal(inflater, R.layout.benz_ntg_fy_bt_card, null, false, component);
    }
    ...
    public static BenzNtgFyBtCardBinding bind(View view, Object component) {
        return (BenzNtgFyBtCardBinding) bind(component, view, R.layout.benz_ntg_fy_bt_card);
    }
}
