...
public class BenzNtg6FyFragmentOneClsImpl extends BenzNtg6FyFragmentOneCls {
    ...
    public BenzNtg6FyFragmentOneClsImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 36, sIncludes, sViewsWithIds));
    }

    private BenzNtg6FyFragmentOneClsImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
