...
public class BenzNtgFyAppsCardBindingHdpi1920x720Impl extends BenzNtgFyAppsCardBinding implements OnClickListener.Listener {
    ...
    public BenzNtgFyAppsCardBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzNtgFyAppsCardBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.BenzNtgFyAppsCardBinding
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback310);
            this.mboundView2.setOnClickListener(this.mCallback311);
            this.mboundView3.setOnClickListener(this.mCallback312);
        }
    }
