...
public final class LandRoverLayoutSetSysInfoBinding implements ViewBinding {
    ...
    private LandRoverLayoutSetSysInfoBinding(ScrollView rootView2, TextView tvInfoAppv2, MarqueeTextView tvInfoCpu2, TextView tvInfoMcuUp2, TextView tvInfoMcuv2, TextView tvInfoSysRest2, TextView tvInfoSysUpDate2, TextView tvInfoSysv2, TextView tvSystemInfo3, TextView tvSystemInfo22) {
    ...
    public static LandRoverLayoutSetSysInfoBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static LandRoverLayoutSetSysInfoBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.land_rover_layout_set_sys_info, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static LandRoverLayoutSetSysInfoBinding bind(View rootView2) {
                                ...
                                if (tvInfoSysv2 != null) {
                                    ...
                                    if (tvSystemInfo3 != null) {
                                        ...
                                        if (tvSystemInfo22 != null) {
                                            return new LandRoverLayoutSetSysInfoBinding((ScrollView) rootView2, tvInfoAppv2, tvInfoCpu2, tvInfoMcuUp2, tvInfoMcuv2, tvInfoSysRest2, tvInfoSysUpDate2, tvInfoSysv2, tvSystemInfo3, tvSystemInfo22);
                                        }
                                    }
                                }
                            }
