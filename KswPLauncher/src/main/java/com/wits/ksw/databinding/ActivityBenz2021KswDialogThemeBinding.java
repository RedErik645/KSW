...
public final class ActivityBenz2021KswDialogThemeBinding implements ViewBinding {
    ...
    public static ActivityBenz2021KswDialogThemeBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityBenz2021KswDialogThemeBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.activity_benz2021_ksw_dialog_theme, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static ActivityBenz2021KswDialogThemeBinding bind(View rootView2) {
                                        ...
                                        if (rbIconSelModern2 != null) {
                                            ...
                                            if (tvIconSelClassical2 != null) {
                                                ...
                                                if (tvIconSelModern2 != null) {
                                                    return new ActivityBenz2021KswDialogThemeBinding((LinearLayout) rootView2, rbBenzMbux2021CoatBg12, rbBenzMbux2021CoatBg22, rbBenzMbux2021CoatBg32, rbBenzMbux2021CoatBg42, rbBenzMbux2021CoatBg52, rbBenzMbux2021CoatBg62, rbBenzMbux2021CoatBg72, rbIconSelClassical2, rbIconSelModern2, tvIconSelClassical2, tvIconSelModern2);
                                                }
                                            }
                                        }
                                    }
