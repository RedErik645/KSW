...
public class ALSDasoardBindHdpi1280x720Impl extends ALSDasoardBind {
    ...
    public ALSDasoardBindHdpi1280x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 24, sIncludes, sViewsWithIds));
    }

    private ALSDasoardBindHdpi1280x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
