...
public abstract class BenzNtgFySetCardBinding extends ViewDataBinding {
    ...
    protected BenzNtgFySetCardBinding(Object _bindingComponent, View _root, int _localFieldCount, AppCompatImageView benzMbuxLocalCardBg2, AppCompatTextView benzMbuxLocalCardContent2, AppCompatTextView benzMbuxLocalCardTitle2) {
    ...
    public static BenzNtgFySetCardBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (BenzNtgFySetCardBinding) ViewDataBinding.inflateInternal(inflater, R.layout.benz_ntg_fy_set_card, root, attachToRoot, component);
    }
    ...
    public static BenzNtgFySetCardBinding inflate(LayoutInflater inflater, Object component) {
        return (BenzNtgFySetCardBinding) ViewDataBinding.inflateInternal(inflater, R.layout.benz_ntg_fy_set_card, null, false, component);
    }
    ...
    public static BenzNtgFySetCardBinding bind(View view, Object component) {
        return (BenzNtgFySetCardBinding) bind(component, view, R.layout.benz_ntg_fy_set_card);
    }
}
