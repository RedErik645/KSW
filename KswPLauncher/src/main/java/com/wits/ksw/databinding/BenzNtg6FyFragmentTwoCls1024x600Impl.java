...
public class BenzNtg6FyFragmentTwoCls1024x600Impl extends BenzNtg6FyFragmentTwoCls {
    ...
    public BenzNtg6FyFragmentTwoCls1024x600Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 36, sIncludes, sViewsWithIds));
    }

    private BenzNtg6FyFragmentTwoCls1024x600Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
