...
public class BenzNtg6FyBindClsImpl extends BenzNtg6FyBindCls {
    ...
    public BenzNtg6FyBindClsImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }

    private BenzNtg6FyBindClsImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
