...
public final class LayoutSetTimeTwoBinding implements ViewBinding {
    ...
    private LayoutSetTimeTwoBinding(ScrollView rootView2, RtlRadioButton rdbSync12, RtlRadioButton rdbSync22, RtlRadioButton rdbZhis12, RtlRadioButton rdbZhis22, RadioGroup rdgTimeSy2, RadioGroup rdgTimeZhis2, RelativeLayout relateTimeSync2, RelativeLayout relateTimeZhis2) {
    ...
    public static LayoutSetTimeTwoBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static LayoutSetTimeTwoBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.layout_set_time_two, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static LayoutSetTimeTwoBinding bind(View rootView2) {
                            ...
                            if (rdgTimeZhis2 != null) {
                                ...
                                if (relateTimeSync2 != null) {
                                    ...
                                    if (relateTimeZhis2 != null) {
                                        return new LayoutSetTimeTwoBinding((ScrollView) rootView2, rdbSync12, rdbSync22, rdbZhis12, rdbZhis22, rdgTimeSy2, rdgTimeZhis2, relateTimeSync2, relateTimeZhis2);
                                    }
                                }
                            }
                        }
