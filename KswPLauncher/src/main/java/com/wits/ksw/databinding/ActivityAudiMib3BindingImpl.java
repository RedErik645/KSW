...
public class ActivityAudiMib3BindingImpl extends ActivityAudiMib3Binding {
    ...
    public ActivityAudiMib3BindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }

    private ActivityAudiMib3BindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
