...
public class BmwId8PempModusLayoutBindingImpl extends BmwId8PempModusLayoutBinding implements OnClickListener.Listener {
    ...
    static {
        ...
        includedLayouts.setIncludes(0, new String[]{"id8_pemp_launcher_left_bar"}, new int[]{10}, new int[]{R.layout.id8_pemp_launcher_left_bar});
    ...
    public BmwId8PempModusLayoutBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 16, sIncludes, sViewsWithIds));
    }

    private BmwId8PempModusLayoutBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 4, (Id8PempLauncherLeftBarBinding) bindings[10], (RelativeLayout) bindings[15], (ImageView) bindings[7], (RelativeLayout) bindings[13], (ImageView) bindings[1], (RelativeLayout) bindings[14], (ImageView) bindings[4], (RelativeLayout) bindings[11], (TextView) bindings[12]);
        this.mDirtyFlags = -1;
        setContainedBinding(this.bmwId8PempModusMainLeftBar);
    ...
    public void invalidateAll() {
        ...
        this.bmwId8PempModusMainLeftBar.invalidateAll();
        requestRebind();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:8:0x0013, code lost:
        if (r4.bmwId8PempModusMainLeftBar.hasPendingBindings() == false) goto L_0x0016;
     */
    ...
    public boolean hasPendingBindings() {
        ...
        L_0x000c:
            monitor-exit(r4)     // Catch:{ all -> 0x0018 }
            com.wits.ksw.databinding.Id8PempLauncherLeftBarBinding r0 = r4.bmwId8PempModusMainLeftBar
        ...
        L_0x0018:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.wits.ksw.databinding.BmwId8PempModusLayoutBindingImpl.hasPendingBindings():boolean");
    }
    ...
    @Override // com.wits.ksw.databinding.BmwId8PempModusLayoutBinding
    ...
    public void setLifecycleOwner(LifecycleOwner lifecycleOwner) {
        ...
        this.bmwId8PempModusMainLeftBar.setLifecycleOwner(lifecycleOwner);
    }
    ...
    public boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0:
                return onChangeBmwId8PempModusMainLeftBar((Id8PempLauncherLeftBarBinding) object, fieldId);
            case 1:
    ...
    private boolean onChangeBmwId8PempModusMainLeftBar(Id8PempLauncherLeftBarBinding BmwId8PempModusMainLeftBar, int fieldId) {
        if (fieldId != 0) {
            return false;
        }
        synchronized (this) {
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags & 62) != 0) {
            int launcherViewModelIsSportModusViewVISIBLEViewGONE2 = 0;
            if ((dirtyFlags & 50) != 0) {
                if (launcherViewModel != null) {
                    launcherViewModelIsEfficientModus = launcherViewModel.isEfficientModus;
                }
                updateRegistration(1, launcherViewModelIsEfficientModus);
            ...
            if ((dirtyFlags & 52) != 0) {
                ...
                updateRegistration(2, launcherViewModelIsPersonalModus);
            ...
            if ((dirtyFlags & 56) != 0) {
                ...
                if (!androidDatabindingViewDataBindingSafeUnboxLauncherViewModelIsSportModusGet) {
                    launcherViewModelIsSportModusViewVISIBLEViewGONE2 = 8;
                }
        ...
        if ((dirtyFlags & 48) != 0) {
            this.bmwId8PempModusMainLeftBar.setLeftViewModel(launcherViewModel);
        }
        if ((dirtyFlags & 32) != 0) {
            this.llModusEfficientImg.setOnClickListener(this.mCallback504);
            this.llModusPersonalImg.setOnClickListener(this.mCallback502);
            this.llModusSportImg.setOnClickListener(this.mCallback503);
        }
        if ((dirtyFlags & 52) != 0) {
        ...
        executeBindingsOn(this.bmwId8PempModusMainLeftBar);
    }
