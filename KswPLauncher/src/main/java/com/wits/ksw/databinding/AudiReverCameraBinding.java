...
public abstract class AudiReverCameraBinding extends ViewDataBinding {
    ...
    protected AudiReverCameraBinding(Object _bindingComponent, View _root, int _localFieldCount, RadioButton RadioButton12, RadioButton RadioButton22, RadioButton RadioButton32, RadioButton RadioButton42, RadioGroup timeRadioGroup2) {
    ...
    public static AudiReverCameraBinding inflate(LayoutInflater inflater, Object component) {
        return (AudiReverCameraBinding) ViewDataBinding.inflateInternal(inflater, R.layout.audi_rever_camera, null, false, component);
    }
