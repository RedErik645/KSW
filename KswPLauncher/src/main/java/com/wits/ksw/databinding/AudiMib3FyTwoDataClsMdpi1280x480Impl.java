...
public class AudiMib3FyTwoDataClsMdpi1280x480Impl extends AudiMib3FyTwoDataCls {
    ...
    public AudiMib3FyTwoDataClsMdpi1280x480Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds));
    }

    private AudiMib3FyTwoDataClsMdpi1280x480Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
