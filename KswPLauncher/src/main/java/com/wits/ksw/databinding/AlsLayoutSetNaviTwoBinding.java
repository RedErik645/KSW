...
public final class AlsLayoutSetNaviTwoBinding implements ViewBinding {
    ...
    public static AlsLayoutSetNaviTwoBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static AlsLayoutSetNaviTwoBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.als_layout_set_navi_two, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static AlsLayoutSetNaviTwoBinding bind(View rootView2) {
                                    ...
                                    if (rdgNaviv2 != null) {
                                        ...
                                        if (relateApp2 != null) {
                                            ...
                                            if (relateNaviv2 != null) {
                                                return new AlsLayoutSetNaviTwoBinding((ScrollView) rootView2, naviRecycle2, rdbNaviv12, rdbNaviv22, rdbNaviv32, rdbNaviv42, rdbNaviv52, rdbNaviv62, rdgNaviv2, relateApp2, relateNaviv2);
                                            }
                                        }
                                    }
                                }
