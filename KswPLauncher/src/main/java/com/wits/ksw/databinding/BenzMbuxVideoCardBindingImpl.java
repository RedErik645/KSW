...
public class BenzMbuxVideoCardBindingImpl extends BenzMbuxVideoCardBinding implements OnClickListener.Listener {
    ...
    public BenzMbuxVideoCardBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzMbuxVideoCardBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.BenzMbuxVideoCardBinding
    ...
    public void executeBindings() {
        ...
        Drawable viewModelItemIconClassicalBenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeVideoSelector1BenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeVideoSelector2 = null;
        ...
        if ((dirtyFlags & 7) != 0) {
            ...
            viewModelItemIconClassicalBenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeVideoSelector1BenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeVideoSelector2 = AppCompatResources.getDrawable(this.benzMbuxLocalCardBg.getContext(), viewModelItemIconClassicalGet ? R.drawable.benz_mbux_2021_ksw_home_video_selector1 : R.drawable.benz_mbux_2021_ksw_home_video_selector2);
        }
        if ((7 & dirtyFlags) != 0) {
            ImageViewBindingAdapter.setImageDrawable(this.benzMbuxLocalCardBg, viewModelItemIconClassicalBenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeVideoSelector1BenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeVideoSelector2);
        }
        if ((4 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback452);
            this.mboundView2.setOnClickListener(this.mCallback453);
            this.mboundView3.setOnClickListener(this.mCallback454);
        }
    }
    ...
    public final void _internalCallbackOnClick(int sourceId, View callbackArg_0) {
        ...
        switch (sourceId) {
            ...
            case 3:
                ...
                if (viewModelJavaLangObjectNull) {
                    viewModel3.openVideoMulti(callbackArg_0);
                    return;
                }
                return;
            default:
