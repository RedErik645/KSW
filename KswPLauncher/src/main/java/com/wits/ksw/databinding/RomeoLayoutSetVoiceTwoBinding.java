...
public final class RomeoLayoutSetVoiceTwoBinding implements ViewBinding {
    ...
    private RomeoLayoutSetVoiceTwoBinding(FrameLayout rootView2, ImageView imgTwoDefaul2, LinearLayout llBv2, LinearLayout llOv2, RelativeLayout relateBeigld2, SeekBar seekDaohvoicb2, SeekBar seekMtb2, SeekBar seekTonghb2, SeekBar seekYuancthb2, TextView tvDaohvoicsize2, TextView tvMtsize2, TextView tvTonghsize2, TextView tvYuancthsize2) {
    ...
    public static RomeoLayoutSetVoiceTwoBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static RomeoLayoutSetVoiceTwoBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.romeo_layout_set_voice_two, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static RomeoLayoutSetVoiceTwoBinding bind(View rootView2) {
                                            ...
                                            if (tvMtsize2 != null) {
                                                ...
                                                if (tvTonghsize2 != null) {
                                                    ...
                                                    if (tvYuancthsize2 != null) {
                                                        return new RomeoLayoutSetVoiceTwoBinding((FrameLayout) rootView2, imgTwoDefaul2, llBv2, llOv2, relateBeigld2, seekDaohvoicb2, seekMtb2, seekTonghb2, seekYuancthb2, tvDaohvoicsize2, tvMtsize2, tvTonghsize2, tvYuancthsize2);
                                                    }
                                                }
                                            }
                                        }
