...
public final class LandRoverLayoutSetTimeBinding implements ViewBinding {
    ...
    private LandRoverLayoutSetTimeBinding(ScrollView rootView2, RtlRadioButton rdbSync12, RtlRadioButton rdbSync22, RtlRadioButton rdbZhis12, RtlRadioButton rdbZhis22, RadioGroup rdgTimeSy2, RadioGroup rdgTimeZhis2, TextView tvTimeSync2, TextView tvTimeZhis2) {
    ...
    public static LandRoverLayoutSetTimeBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static LandRoverLayoutSetTimeBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.land_rover_layout_set_time, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static LandRoverLayoutSetTimeBinding bind(View rootView2) {
                        ...
                        if (rdgTimeSy2 != null) {
                            ...
                            if (rdgTimeZhis2 != null) {
                                ...
                                if (tvTimeSync2 != null) {
                                    ...
                                    if (tvTimeZhis2 != null) {
                                        return new LandRoverLayoutSetTimeBinding((ScrollView) rootView2, rdbSync12, rdbSync22, rdbZhis12, rdbZhis22, rdgTimeSy2, rdgTimeZhis2, tvTimeSync2, tvTimeZhis2);
                                    }
                                }
                            }
                        }
