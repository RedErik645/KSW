...
public final class LayoutSetSystemBinding implements ViewBinding {
    ...
    private LayoutSetSystemBinding(ScrollView rootView2, RtlCheckBox cboxSysDcgj2, RtlCheckBox cboxSysDcjy2, RtlCheckBox cboxSysDcld2, RtlCheckBox cboxSysHjs2, RtlCheckBox cboxSysXcjz2, TextView tvMusicApp2, TextView tvSysBgld2, TextView tvSysCaux2, TextView tvSysDcsxt2, TextView tvSysFuelUnit2, TextView tvSysTempUnit2, TextView tvVideoApp2) {
    ...
    public static LayoutSetSystemBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static LayoutSetSystemBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.layout_set_system, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static LayoutSetSystemBinding bind(View rootView2) {
                                        ...
                                        if (tvSysDcsxt2 != null) {
                                            ...
                                            if (tvSysFuelUnit2 != null) {
                                                ...
                                                if (tvSysTempUnit2 != null) {
                                                    ...
                                                    if (tvVideoApp2 != null) {
                                                        return new LayoutSetSystemBinding((ScrollView) rootView2, cboxSysDcgj2, cboxSysDcjy2, cboxSysDcld2, cboxSysHjs2, cboxSysXcjz2, tvMusicApp2, tvSysBgld2, tvSysCaux2, tvSysDcsxt2, tvSysFuelUnit2, tvSysTempUnit2, tvVideoApp2);
                                                    }
                                                }
                                            }
                                        }
