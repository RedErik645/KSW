...
public class AudiMib3TyOneBindingMdpi1280x480Impl extends AudiMib3TyOneBinding {
    ...
    public AudiMib3TyOneBindingMdpi1280x480Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 26, sIncludes, sViewsWithIds));
    }

    private AudiMib3TyOneBindingMdpi1280x480Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
