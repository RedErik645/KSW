...
public abstract class BmwId8SettingsSystemCameraLayoutBinding extends ViewDataBinding {
    ...
    protected BmwId8SettingsSystemCameraLayoutBinding(Object _bindingComponent, View _root, int _localFieldCount, RelativeLayout bmwId8SettingsSystemCamera3602, RelativeLayout bmwId8SettingsSystemCamera360Built2, RelativeLayout bmwId8SettingsSystemCameraAfter2, RelativeLayout bmwId8SettingsSystemCameraLay2, RelativeLayout bmwId8SettingsSystemCameraOem2) {
    ...
    public static BmwId8SettingsSystemCameraLayoutBinding inflate(LayoutInflater inflater, Object component) {
        return (BmwId8SettingsSystemCameraLayoutBinding) ViewDataBinding.inflateInternal(inflater, R.layout.bmw_id8_settings_system_camera_layout, null, false, component);
    }
