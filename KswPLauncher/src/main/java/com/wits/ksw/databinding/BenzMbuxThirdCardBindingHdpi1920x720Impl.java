...
public class BenzMbuxThirdCardBindingHdpi1920x720Impl extends BenzMbuxThirdCardBinding implements OnClickListener.Listener {
    ...
    public BenzMbuxThirdCardBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }

    private BenzMbuxThirdCardBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.BenzMbuxThirdCardBinding
