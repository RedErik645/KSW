...
public abstract class ActivityAudiMib3SoundAndroidBinding extends ViewDataBinding {
    ...
    protected ActivityAudiMib3SoundAndroidBinding(Object _bindingComponent, View _root, int _localFieldCount, SeekBar audioSeekbar2, TextView audioSeekbarRightText2, TextView audioSeekbarTitle2, View hzCallLinearLayout2, View hzMediaLinearLayout2, ConstraintLayout linearLayout42, ImageView soundIcon2, ImageView soundSetIv2, TextView soundTv2, TextView soundVolumTv2, ScrollView svSound2, AppCompatTextView title2, View titleDivider2, View vDivider2) {
        ...
        this.soundIcon = soundIcon2;
        this.soundSetIv = soundSetIv2;
        this.soundTv = soundTv2;
        this.soundVolumTv = soundVolumTv2;
    ...
    public static ActivityAudiMib3SoundAndroidBinding inflate(LayoutInflater inflater, Object component) {
        return (ActivityAudiMib3SoundAndroidBinding) ViewDataBinding.inflateInternal(inflater, R.layout.activity_audi_mib3_sound_android, null, false, component);
    }
