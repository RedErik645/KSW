...
public class ID6FragmentThreeImpl extends ID6FragmentThree {
    ...
    public ID6FragmentThreeImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }

    private ID6FragmentThreeImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
