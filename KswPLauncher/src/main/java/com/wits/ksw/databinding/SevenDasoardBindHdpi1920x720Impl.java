...
public class SevenDasoardBindHdpi1920x720Impl extends SevenDasoardBind implements OnClickListener.Listener {
    ...
    public SevenDasoardBindHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 27, sIncludes, sViewsWithIds));
    }

    private SevenDasoardBindHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags & PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH) != 0) {
            this.mboundView17.setOnClickListener(this.mCallback236);
            this.mboundView18.setOnClickListener(this.mCallback237);
            this.mboundView19.setOnClickListener(this.mCallback238);
            this.mboundView20.setOnClickListener(this.mCallback239);
            this.mboundView21.setOnClickListener(this.mCallback240);
            this.mboundView22.setOnClickListener(this.mCallback241);
            this.mboundView23.setOnClickListener(this.mCallback242);
        }
