...
public class BenzNtg6FyFragmentOneClsV2Hdpi1920x720Impl extends BenzNtg6FyFragmentOneClsV2 {
    ...
    static {
        ...
        sparseIntArray.put(R.id.weather_rl, 22);
        sparseIntArray.put(R.id.weather_itemview, 23);
        sparseIntArray.put(R.id.weather_tv, 24);
        sparseIntArray.put(R.id.weather_tip, 25);
        sparseIntArray.put(R.id.weather_iv1, 26);
        sparseIntArray.put(R.id.space4, 27);
        sparseIntArray.put(R.id.weather_iv2, 28);
        sparseIntArray.put(R.id.car_rl, 29);
        sparseIntArray.put(R.id.car_itemview, 30);
        sparseIntArray.put(R.id.car_tv, 31);
        sparseIntArray.put(R.id.car_tip, 32);
        sparseIntArray.put(R.id.car_iv1, 33);
        sparseIntArray.put(R.id.space5, 34);
        sparseIntArray.put(R.id.car_iv2, 35);
    }

    public BenzNtg6FyFragmentOneClsV2Hdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 36, sIncludes, sViewsWithIds));
    }

    private BenzNtg6FyFragmentOneClsV2Hdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2, (BenzMbuxItemView) bindings[17], (ImageView) bindings[19], (ImageView) bindings[21], (RelativeLayout) bindings[16], (TextView) bindings[2], (TextView) bindings[18], (BenzMbuxItemView) bindings[30], (ImageView) bindings[33], (ImageView) bindings[35], (RelativeLayout) bindings[29], (TextView) bindings[32], (TextView) bindings[31], (LinearLayout) bindings[0], (BenzMbuxItemView) bindings[11], (ImageView) bindings[15], (ImageView) bindings[13], (RelativeLayout) bindings[10], (TextView) bindings[1], (TextView) bindings[12], (BenzMbuxItemView) bindings[4], (ImageView) bindings[7], (ImageView) bindings[9], (RelativeLayout) bindings[3], (TextView) bindings[6], (TextView) bindings[5], (View) bindings[8], (View) bindings[14], (View) bindings[20], (View) bindings[27], (View) bindings[34], (BenzMbuxItemView) bindings[23], (ImageView) bindings[26], (ImageView) bindings[28], (RelativeLayout) bindings[22], (TextView) bindings[25], (CapitalizeTextView) bindings[24]);
        this.mDirtyFlags = -1;
    ...
    @Override // com.wits.ksw.databinding.BenzNtg6FyFragmentOneClsV2
