...
public class BenzNtg6FyFragmentTwoClsImpl extends BenzNtg6FyFragmentTwoCls {
    ...
    public BenzNtg6FyFragmentTwoClsImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 36, sIncludes, sViewsWithIds));
    }

    private BenzNtg6FyFragmentTwoClsImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
