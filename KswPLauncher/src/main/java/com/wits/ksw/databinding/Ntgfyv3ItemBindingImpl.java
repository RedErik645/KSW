...
public class Ntgfyv3ItemBindingImpl extends Ntgfyv3ItemBinding implements OnClickListener.Listener {
    ...
    public Ntgfyv3ItemBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private Ntgfyv3ItemBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (LinearLayout) bindings[0], (LinearLayout) bindings[1]);
        this.mDirtyFlags = -1;
    ...
    @Override // com.wits.ksw.databinding.Ntgfyv3ItemBinding
    ...
    public void executeBindings() {
        ...
        if ((4 & dirtyFlags) != 0) {
            this.ntgfyv3ItemIv.setOnClickListener(this.mCallback336);
        }
    }
