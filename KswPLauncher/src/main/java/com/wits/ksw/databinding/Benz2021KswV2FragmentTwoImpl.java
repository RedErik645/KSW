...
public class Benz2021KswV2FragmentTwoImpl extends Benz2021KswV2FragmentTwo {
    ...
    static {
        ...
        sparseIntArray.put(R.id.space1, 22);
        sparseIntArray.put(R.id.iv_video2, 23);
        sparseIntArray.put(R.id.app_rl, 24);
        sparseIntArray.put(R.id.app_tv, 25);
        sparseIntArray.put(R.id.app_tip, 26);
        sparseIntArray.put(R.id.iv_apps1, 27);
        sparseIntArray.put(R.id.space2, 28);
        sparseIntArray.put(R.id.iv_apps2, 29);
        sparseIntArray.put(R.id.car_rl, 30);
        sparseIntArray.put(R.id.car_tv, 31);
        sparseIntArray.put(R.id.car_tip, 32);
        sparseIntArray.put(R.id.iv_car1, 33);
        sparseIntArray.put(R.id.space4, 34);
        sparseIntArray.put(R.id.iv_car2, 35);
        sparseIntArray.put(R.id.dashboard_rl, 36);
        sparseIntArray.put(R.id.dashboard_tv, 37);
        sparseIntArray.put(R.id.dashboard_tip, 38);
        sparseIntArray.put(R.id.iv_dash1, 39);
        sparseIntArray.put(R.id.space, 40);
        sparseIntArray.put(R.id.iv_dash2, 41);
        sparseIntArray.put(R.id.dvr_rl, 42);
        sparseIntArray.put(R.id.dvr_tv, 43);
        sparseIntArray.put(R.id.dvr_tip, 44);
        sparseIntArray.put(R.id.iv_dvr1, 45);
        sparseIntArray.put(R.id.space5, 46);
        sparseIntArray.put(R.id.iv_dvr2, 47);
    }
