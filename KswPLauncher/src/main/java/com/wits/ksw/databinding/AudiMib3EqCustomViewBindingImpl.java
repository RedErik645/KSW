...
public class AudiMib3EqCustomViewBindingImpl extends AudiMib3EqCustomViewBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.linearLayout6, 12);
        sparseIntArray.put(R.id.v_divider, 13);
    }

    public AudiMib3EqCustomViewBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 14, sIncludes, sViewsWithIds));
    }

    private AudiMib3EqCustomViewBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 7, (EqSeekBar) bindings[1], null, null, null, null, null, null, null, (View) bindings[10], (AudiConstraintLayout) bindings[9], (View) bindings[11], (View) bindings[12], (EqSeekBar) bindings[3], null, (AppCompatTextView) bindings[7], (View) bindings[8], (EqSeekBar) bindings[5], null, (View) bindings[13]);
        this.mDirtyFlags = -1;
