...
public final class LandRoverLayoutSetVoiceBinding implements ViewBinding {
    ...
    private LandRoverLayoutSetVoiceBinding(ScrollView rootView2, SeekBar seekDaohvoicb2, SeekBar seekMtb2, SeekBar seekTonghb2, SeekBar seekYuancthb2, TextView tvDaohvoicsize2, TextView tvEq2, TextView tvHouzvoc2, TextView tvMtsize2, TextView tvTonghsize2, TextView tvYuancthsize2, TextView tvYuancvoc2) {
    ...
    public static LandRoverLayoutSetVoiceBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static LandRoverLayoutSetVoiceBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.land_rover_layout_set_voice, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static LandRoverLayoutSetVoiceBinding bind(View rootView2) {
                                    ...
                                    if (tvMtsize2 != null) {
                                        ...
                                        if (tvTonghsize2 != null) {
                                            ...
                                            if (tvYuancthsize2 != null) {
                                                ...
                                                if (tvYuancvoc2 != null) {
                                                    return new LandRoverLayoutSetVoiceBinding((ScrollView) rootView2, seekDaohvoicb2, seekMtb2, seekTonghb2, seekYuancthb2, tvDaohvoicsize2, tvEq2, tvHouzvoc2, tvMtsize2, tvTonghsize2, tvYuancthsize2, tvYuancvoc2);
                                                }
                                            }
                                        }
                                    }
