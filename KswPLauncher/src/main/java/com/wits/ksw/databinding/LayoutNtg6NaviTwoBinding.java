...
public final class LayoutNtg6NaviTwoBinding implements ViewBinding {
    public final ImageView imgTwoBack;
    public final ImageView naviBgImageView;
    ...
    public final ScrollView relateNaviv;
    private final RelativeLayout rootView;
    public final MarqueeTextView tvTwoMsg;

    private LayoutNtg6NaviTwoBinding(RelativeLayout rootView2, ImageView imgTwoBack2, ImageView naviBgImageView2, RecyclerView naviRecycle2, RtlRadioButton rdbNaviv12, RtlRadioButton rdbNaviv22, RtlRadioButton rdbNaviv32, RtlRadioButton rdbNaviv42, RtlRadioButton rdbNaviv52, RtlRadioButton rdbNaviv62, RadioGroup rdgNaviv2, RelativeLayout relateApp2, ScrollView relateNaviv2, MarqueeTextView tvTwoMsg2) {
        this.rootView = rootView2;
        this.imgTwoBack = imgTwoBack2;
        this.naviBgImageView = naviBgImageView2;
    ...
    public static LayoutNtg6NaviTwoBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static LayoutNtg6NaviTwoBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.layout_ntg6_navi_two, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static LayoutNtg6NaviTwoBinding bind(View rootView2) {
        int id = R.id.img_TwoBack;
        ImageView imgTwoBack2 = (ImageView) rootView2.findViewById(R.id.img_TwoBack);
        if (imgTwoBack2 != null) {
            id = R.id.naviBgImageView;
            ImageView naviBgImageView2 = (ImageView) rootView2.findViewById(R.id.naviBgImageView);
            if (naviBgImageView2 != null) {
                id = R.id.navi_recycle;
                                        ...
                                        if (rdbNaviv62 != null) {
                                            ...
                                            if (rdgNaviv2 != null) {
                                                ...
                                                if (relateApp2 != null) {
                                                    ...
                                                    ScrollView relateNaviv2 = (ScrollView) rootView2.findViewById(R.id.relate_naviv);
                                                    if (relateNaviv2 != null) {
                                                        id = R.id.tv_TwoMsg;
                                                        MarqueeTextView tvTwoMsg2 = (MarqueeTextView) rootView2.findViewById(R.id.tv_TwoMsg);
                                                        if (tvTwoMsg2 != null) {
                                                            return new LayoutNtg6NaviTwoBinding((RelativeLayout) rootView2, imgTwoBack2, naviBgImageView2, naviRecycle2, rdbNaviv12, rdbNaviv22, rdbNaviv32, rdbNaviv42, rdbNaviv52, rdbNaviv62, rdgNaviv2, relateApp2, relateNaviv2, tvTwoMsg2);
                                                        }
                                                    }
                                                }
                                            }
