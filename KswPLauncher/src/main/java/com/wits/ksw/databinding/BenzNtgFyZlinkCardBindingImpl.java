...
public class BenzNtgFyZlinkCardBindingImpl extends BenzNtgFyZlinkCardBinding implements OnClickListener.Listener {
    ...
    public BenzNtgFyZlinkCardBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzNtgFyZlinkCardBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback280);
