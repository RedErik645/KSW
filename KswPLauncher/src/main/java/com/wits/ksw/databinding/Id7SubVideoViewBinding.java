...
public abstract class Id7SubVideoViewBinding extends ViewDataBinding {
    ...
    protected Id7SubVideoViewBinding(Object _bindingComponent, View _root, int _localFieldCount, TextView textView22, TextView textView32, ConstraintLayout videoConstraintLayout2, CustomBmwImageView videoImageView2) {
    ...
    public static Id7SubVideoViewBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (Id7SubVideoViewBinding) ViewDataBinding.inflateInternal(inflater, R.layout.id7_sub_video_view, root, attachToRoot, component);
    }
    ...
    public static Id7SubVideoViewBinding inflate(LayoutInflater inflater, Object component) {
        return (Id7SubVideoViewBinding) ViewDataBinding.inflateInternal(inflater, R.layout.id7_sub_video_view, null, false, component);
    }
