...
public class BenzMbuxBtCardBindingImpl extends BenzMbuxBtCardBinding implements OnClickListener.Listener {
    ...
    public BenzMbuxBtCardBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzMbuxBtCardBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((8 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback304);
            this.mboundView3.setOnClickListener(this.mCallback305);
