...
public class ActivityMainBcBindingHdpi1280x720Impl extends ActivityMainBcBinding implements OnClickListener.Listener {
    ...
    public ActivityMainBcBindingHdpi1280x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }

    private ActivityMainBcBindingHdpi1280x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((16 & dirtyFlags) != 0) {
            this.bcArrowLeftButton.setOnClickListener(this.mCallback90);
            this.bcArrowRightButton.setOnClickListener(this.mCallback91);
        }
        if ((dirtyFlags & 26) != 0) {
