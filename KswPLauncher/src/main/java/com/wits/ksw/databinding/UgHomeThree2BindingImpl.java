...
public class UgHomeThree2BindingImpl extends UgHomeThree2Binding implements OnClickListener.Listener {
    ...
    @Override // com.wits.ksw.databinding.UgHomeThree2Binding
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.ugHomeCarVaiw.setOnClickListener(this.mCallback395);
            this.ugHomeDashboradVaiw.setOnClickListener(this.mCallback396);
            this.ugHomeSettingVaiw.setOnClickListener(this.mCallback397);
        }
    }
