...
public class AlsId7UiDashBoardSubViewBindingHdpi1920x720Impl extends AlsId7UiDashBoardSubViewBinding implements OnClickListener.Listener {
    ...
    public AlsId7UiDashBoardSubViewBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }

    private AlsId7UiDashBoardSubViewBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags & 256) != 0) {
            this.dashboardImageView.setOnClickListener(this.mCallback75);
        }
        if ((dirtyFlags & 288) != 0) {
