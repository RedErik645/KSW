...
public class BenzMbux2021ItemBindingHdpi1280x720Impl extends BenzMbux2021ItemBinding implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((4 & dirtyFlags) != 0) {
            this.benzMbux2021ImageView.setOnClickListener(this.mCallback494);
            this.benzMbux2021Tip.setOnClickListener(this.mCallback495);
            this.mboundView4.setOnClickListener(this.mCallback496);
            this.mboundView5.setOnClickListener(this.mCallback497);
        }
        if ((5 & dirtyFlags) != 0) {
