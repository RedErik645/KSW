...
public class AppThirdItemLandroverBindingImpl extends AppThirdItemLandroverBinding {
    ...
    public AppThirdItemLandroverBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private AppThirdItemLandroverBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.AppThirdItemLandroverBinding
