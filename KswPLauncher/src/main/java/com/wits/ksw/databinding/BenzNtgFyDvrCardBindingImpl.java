...
public class BenzNtgFyDvrCardBindingImpl extends BenzNtgFyDvrCardBinding implements OnClickListener.Listener {
    ...
    public BenzNtgFyDvrCardBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzNtgFyDvrCardBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback372);
            this.mboundView2.setOnClickListener(this.mCallback373);
            this.mboundView3.setOnClickListener(this.mCallback374);
        }
    }
