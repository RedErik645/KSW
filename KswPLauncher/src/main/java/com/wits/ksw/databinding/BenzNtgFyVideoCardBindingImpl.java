...
public class BenzNtgFyVideoCardBindingImpl extends BenzNtgFyVideoCardBinding implements OnClickListener.Listener {
    ...
    public BenzNtgFyVideoCardBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzNtgFyVideoCardBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.BenzNtgFyVideoCardBinding
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback536);
            this.mboundView2.setOnClickListener(this.mCallback537);
            this.mboundView3.setOnClickListener(this.mCallback538);
        }
    }
