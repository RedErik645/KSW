...
public class BenzNtgFyDashboardCardBindingHdpi1920x720Impl extends BenzNtgFyDashboardCardBinding implements OnClickListener.Listener {
    ...
    public BenzNtgFyDashboardCardBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzNtgFyDashboardCardBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback112);
