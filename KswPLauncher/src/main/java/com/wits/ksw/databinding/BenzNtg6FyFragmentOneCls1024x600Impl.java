...
public class BenzNtg6FyFragmentOneCls1024x600Impl extends BenzNtg6FyFragmentOneCls {
    ...
    public BenzNtg6FyFragmentOneCls1024x600Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 36, sIncludes, sViewsWithIds));
    }

    private BenzNtg6FyFragmentOneCls1024x600Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
