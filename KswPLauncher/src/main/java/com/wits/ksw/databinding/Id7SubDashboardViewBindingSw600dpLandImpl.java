...
public class Id7SubDashboardViewBindingSw600dpLandImpl extends Id7SubDashboardViewBinding implements OnClickListener.Listener {
    ...
    public Id7SubDashboardViewBindingSw600dpLandImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }

    private Id7SubDashboardViewBindingSw600dpLandImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.Id7SubDashboardViewBinding
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags & 256) != 0) {
            this.dashboardImageView.setOnClickListener(this.mCallback105);
        }
        if ((dirtyFlags & 288) != 0) {
