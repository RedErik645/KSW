...
public class BenzMbuxCarinfoCardBindingImpl extends BenzMbuxCarinfoCardBinding implements OnClickListener.Listener {
    ...
    public BenzMbuxCarinfoCardBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzMbuxCarinfoCardBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((4 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback251);
