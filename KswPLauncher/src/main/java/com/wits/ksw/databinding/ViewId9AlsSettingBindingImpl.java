...
public class ViewId9AlsSettingBindingImpl extends ViewId9AlsSettingBinding {
    ...
    public ViewId9AlsSettingBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private ViewId9AlsSettingBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.ViewId9AlsSettingBinding
