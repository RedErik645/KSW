...
public abstract class Benz2021FragmentThree extends ViewDataBinding {
    ...
    protected Benz2021FragmentThree(Object _bindingComponent, View _root, int _localFieldCount, BenzMbuxItemView appItemview2, BenzMbuxItemView appItemviewYo2, RelativeLayout appRl2, TextView appTip2, TextView appTv2, BenzMbuxItemView dashboardItemview2, BenzMbuxItemView dashboardItemviewYo2, RelativeLayout dashboardRl2, TextView dashboardTip2, TextView dashboardTv2, LinearLayout fragmentTwoLl2, ImageView ivApps12, ImageView ivApps22, ImageView ivDash12, ImageView ivDash22, ImageView ivPhone12, ImageView ivPhone22, BenzMbuxItemView phonelinkItemview2, BenzMbuxItemView phonelinkItemviewYo2, RelativeLayout phonelinkRl2, TextView phonelinkTip2, TextView phonelinkTv2, View space3, View space12, View space22) {
        super(_bindingComponent, _root, _localFieldCount);
        this.appItemview = appItemview2;
        this.appItemviewYo = appItemviewYo2;
        this.appRl = appRl2;
        this.appTip = appTip2;
        this.appTv = appTv2;
        this.dashboardItemview = dashboardItemview2;
        this.dashboardItemviewYo = dashboardItemviewYo2;
        ...
        this.phonelinkItemviewYo = phonelinkItemviewYo2;
    ...
    public static Benz2021FragmentThree inflate(LayoutInflater inflater, Object component) {
        return (Benz2021FragmentThree) ViewDataBinding.inflateInternal(inflater, R.layout.benz_mbux_2021_fragment_three, null, false, component);
    }
