...
public class ActivityMainAlsId7V2BindingImpl extends ActivityMainAlsId7V2Binding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.btn_apps, 14);
        sparseIntArray.put(R.id.btn_settings, 15);
        sparseIntArray.put(R.id.btn_shut_1, 16);
        sparseIntArray.put(R.id.btn_shut_2, 17);
        sparseIntArray.put(R.id.btn_shut_3, 18);
    }

    public ActivityMainAlsId7V2BindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 19, sIncludes, sViewsWithIds));
    }

    private ActivityMainAlsId7V2BindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 6, (LinearLayout) bindings[14], (LinearLayout) bindings[15], (LinearLayout) bindings[16], (LinearLayout) bindings[17], (LinearLayout) bindings[18], (Guideline) bindings[7], (ImageView) bindings[8], (ImageView) bindings[11], (ImageView) bindings[9], (ImageView) bindings[10], (LinearLayout) bindings[13], (ViewPager) bindings[12]);
        this.mDirtyFlags = -1;
    ...
    @Override // com.wits.ksw.databinding.ActivityMainAlsId7V2Binding
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags & 224) != 0) {
            launcherViewModelShortCutName3JavaLangObjectNullMboundView6AndroidStringKswId7HdVideoLauncherViewModelShortCutName3 = launcherViewModelShortCutName3JavaLangObjectNull ? this.mboundView6.getResources().getString(R.string.ksw_id7_hd_video) : launcherViewModelShortCutName3Get;
        } else {
            launcherViewModelShortCutName3JavaLangObjectNullMboundView6AndroidStringKswId7HdVideoLauncherViewModelShortCutName3 = null;
        }
        if ((dirtyFlags & 194) != 0) {
            launcherViewModelShortCutIcon2JavaLangObjectNullMboundView3AndroidDrawableId7MainMusicNLauncherViewModelShortCutIcon2 = launcherViewModelShortCutIcon2JavaLangObjectNull ? AppCompatResources.getDrawable(this.mboundView3.getContext(), R.drawable.id7_main_music_n) : launcherViewModelShortCutIcon2Get;
        } else {
