...
public class BmwId8SettingsSystemCameraLayoutBindingImpl extends BmwId8SettingsSystemCameraLayoutBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.bmw_id8_settings_system_camera_lay, 10);
    }
        ...
        if ((dirtyFlags & 15) != 0) {
            ...
            if ((dirtyFlags & 14) != 0) {
                ...
                if (viewModelRearCameraTypeInt3) {
                    ...
                    viewModelRearCameraTypeInt3MboundView9AndroidDrawableId8SettingsSystemSelectSelMboundView9AndroidDrawableId8SettingsSystemSelectN = AppCompatResources.getDrawable(this.mboundView9.getContext(), R.drawable.id8_settings_system_select_sel);
                } else {
                    viewModelRearCameraType2 = viewModelRearCameraType;
                    viewModelRearCameraTypeInt3MboundView9AndroidDrawableId8SettingsSystemSelectSelMboundView9AndroidDrawableId8SettingsSystemSelectN = AppCompatResources.getDrawable(this.mboundView9.getContext(), R.drawable.id8_settings_system_select_n);
                }
                if (viewModelRearCameraTypeInt1) {
                ...
                viewModelRearCameraTypeInt2MboundView7AndroidDrawableId8SettingsSystemSelectSelMboundView7AndroidDrawableId8SettingsSystemSelectN2 = AppCompatResources.getDrawable(this.mboundView7.getContext(), viewModelRearCameraTypeInt2 ? R.drawable.id8_settings_system_select_sel : R.drawable.id8_settings_system_select_n);
