...
public class Benz2021KswV2FragmentTwoHdpi1280x720Impl extends Benz2021KswV2FragmentTwo {
    ...
    static {
        ...
        sparseIntArray.put(R.id.weather_rl, 8);
        sparseIntArray.put(R.id.weather_tv, 9);
        sparseIntArray.put(R.id.weather_tip, 10);
        sparseIntArray.put(R.id.iv_weather1, 11);
        sparseIntArray.put(R.id.iv_weather2, 12);
        sparseIntArray.put(R.id.setting_rl, 13);
        sparseIntArray.put(R.id.set_tv, 14);
        sparseIntArray.put(R.id.set_tip, 15);
        sparseIntArray.put(R.id.iv_set1, 16);
        sparseIntArray.put(R.id.iv_set2, 17);
        sparseIntArray.put(R.id.video_rl, 18);
        sparseIntArray.put(R.id.video_tv, 19);
        sparseIntArray.put(R.id.bt_tip, 20);
        sparseIntArray.put(R.id.iv_video1, 21);
        sparseIntArray.put(R.id.iv_video2, 22);
        sparseIntArray.put(R.id.app_rl, 23);
        sparseIntArray.put(R.id.app_tv, 24);
        sparseIntArray.put(R.id.app_tip, 25);
        sparseIntArray.put(R.id.iv_apps1, 26);
        sparseIntArray.put(R.id.space2, 27);
        sparseIntArray.put(R.id.iv_apps2, 28);
        sparseIntArray.put(R.id.car_rl, 29);
        sparseIntArray.put(R.id.car_tv, 30);
        sparseIntArray.put(R.id.car_tip, 31);
        sparseIntArray.put(R.id.iv_car1, 32);
        sparseIntArray.put(R.id.space4, 33);
        sparseIntArray.put(R.id.iv_car2, 34);
        sparseIntArray.put(R.id.dashboard_rl, 35);
        sparseIntArray.put(R.id.dashboard_tv, 36);
        sparseIntArray.put(R.id.dashboard_tip, 37);
        sparseIntArray.put(R.id.iv_dash1, 38);
        sparseIntArray.put(R.id.space, 39);
        sparseIntArray.put(R.id.iv_dash2, 40);
        sparseIntArray.put(R.id.dvr_rl, 41);
        sparseIntArray.put(R.id.dvr_tv, 42);
        sparseIntArray.put(R.id.dvr_tip, 43);
        sparseIntArray.put(R.id.iv_dvr1, 44);
        sparseIntArray.put(R.id.space5, 45);
        sparseIntArray.put(R.id.iv_dvr2, 46);
    }

    public Benz2021KswV2FragmentTwoHdpi1280x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 47, sIncludes, sViewsWithIds));
    }

    private Benz2021KswV2FragmentTwoHdpi1280x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1, (BenzMbuxItemView) bindings[4], (RelativeLayout) bindings[23], (TextView) bindings[25], (TextView) bindings[24], (TextView) bindings[20], (BenzMbuxItemView) bindings[5], (RelativeLayout) bindings[29], (TextView) bindings[31], (TextView) bindings[30], (BenzMbuxItemView) bindings[6], (RelativeLayout) bindings[35], (TextView) bindings[37], (TextView) bindings[36], (BenzMbuxItemView) bindings[7], (RelativeLayout) bindings[41], (TextView) bindings[43], (TextView) bindings[42], (LinearLayout) bindings[0], (ImageView) bindings[26], (ImageView) bindings[28], (ImageView) bindings[32], (ImageView) bindings[34], (ImageView) bindings[38], (ImageView) bindings[40], (ImageView) bindings[44], (ImageView) bindings[46], (ImageView) bindings[16], (ImageView) bindings[17], (ImageView) bindings[21], (ImageView) bindings[22], (ImageView) bindings[11], (ImageView) bindings[12], (BenzMbuxItemView) bindings[2], (TextView) bindings[15], (TextView) bindings[14], (RelativeLayout) bindings[13], (View) bindings[39], null, (View) bindings[27], (View) bindings[33], (View) bindings[45], (BenzMbuxItemView) bindings[3], (RelativeLayout) bindings[18], (TextView) bindings[19], (BenzMbuxItemView) bindings[1], (RelativeLayout) bindings[8], (TextView) bindings[10], (TextView) bindings[9]);
        this.mDirtyFlags = -1;
