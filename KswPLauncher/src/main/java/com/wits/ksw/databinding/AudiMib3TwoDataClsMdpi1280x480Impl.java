...
public class AudiMib3TwoDataClsMdpi1280x480Impl extends AudiMib3TwoDataCls {
    ...
    public AudiMib3TwoDataClsMdpi1280x480Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds));
    }

    private AudiMib3TwoDataClsMdpi1280x480Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
