...
public class AudiMib3OneDataClsHdpi1920x720Impl extends AudiMib3OneDataCls {
    ...
    public AudiMib3OneDataClsHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 25, sIncludes, sViewsWithIds));
    }

    private AudiMib3OneDataClsHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
