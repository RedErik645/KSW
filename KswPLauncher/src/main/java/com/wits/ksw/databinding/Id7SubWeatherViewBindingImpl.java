...
public class Id7SubWeatherViewBindingImpl extends Id7SubWeatherViewBinding implements OnClickListener.Listener {
    ...
    /* JADX INFO: Multiple debug info for r0v15 'weatherViewModelWeatherInfoErrorMessageGet'  java.lang.String: [D('weatherViewModelWeatherInfoErrorMessageGet' java.lang.String), D('weatherViewModelWeatherInfoPhraseGet' java.lang.String)] */
    /* JADX INFO: Multiple debug info for r0v17 'weatherViewModelWeatherInfoCardDetailText1Get'  java.lang.String: [D('weatherViewModelWeatherInfoErrorMessageGet' java.lang.String), D('weatherViewModelWeatherInfoCardDetailText1Get' java.lang.String)] */
    /* access modifiers changed from: protected */
    @Override // android.databinding.ViewDataBinding
    public void executeBindings() {
        ...
        if ((dirtyFlags & 69636) != 0) {
            weatherViewModelWeatherInfoIsLoadSuccessWeatherViewModelWeatherInfoCityTextView2AndroidStringKswId8Weather = androidDatabindingViewDataBindingSafeUnboxWeatherViewModelWeatherInfoIsLoadSuccessGet ? weatherViewModelWeatherInfoCityGet : this.textView2.getResources().getString(R.string.ksw_id8_weather);
        } else {
        ...
        if ((dirtyFlags & PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH) != 0) {
            this.phoneImageView.setOnClickListener(this.mCallback378);
        }
