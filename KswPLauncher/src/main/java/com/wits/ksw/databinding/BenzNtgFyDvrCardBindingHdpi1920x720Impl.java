...
public class BenzNtgFyDvrCardBindingHdpi1920x720Impl extends BenzNtgFyDvrCardBinding implements OnClickListener.Listener {
    ...
    public BenzNtgFyDvrCardBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzNtgFyDvrCardBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.BenzNtgFyDvrCardBinding
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback291);
            this.mboundView2.setOnClickListener(this.mCallback292);
            this.mboundView3.setOnClickListener(this.mCallback293);
        }
    }
