...
public class AudiPasswordBindingImpl extends AudiPasswordBinding implements OnClickListener.Listener {
    ...
    private AudiPasswordBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.mCallback514 = new OnClickListener(this, 3);
        this.mCallback520 = new OnClickListener(this, 9);
        this.mCallback516 = new OnClickListener(this, 5);
        this.mCallback518 = new OnClickListener(this, 7);
        this.mCallback513 = new OnClickListener(this, 2);
        this.mCallback521 = new OnClickListener(this, 10);
        this.mCallback519 = new OnClickListener(this, 8);
        this.mCallback515 = new OnClickListener(this, 4);
        this.mCallback517 = new OnClickListener(this, 6);
        invalidateAll();
    }
    ...
    public void executeBindings() {
        ...
        if ((4 & dirtyFlags) != 0) {
            this.audiKey0.setOnClickListener(this.mCallback512);
            this.audiKey1.setOnClickListener(this.mCallback513);
            this.audiKey2.setOnClickListener(this.mCallback514);
            this.audiKey3.setOnClickListener(this.mCallback515);
            this.audiKey4.setOnClickListener(this.mCallback516);
            this.audiKey5.setOnClickListener(this.mCallback517);
            this.audiKey6.setOnClickListener(this.mCallback518);
            this.audiKey7.setOnClickListener(this.mCallback519);
            this.audiKey8.setOnClickListener(this.mCallback520);
            this.audiKey9.setOnClickListener(this.mCallback521);
        }
        if ((dirtyFlags & 6) != 0) {
