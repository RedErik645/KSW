...
public class KswmbuxHomeTwoBindingImpl extends KswmbuxHomeTwoBinding implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.kswmbuxHomeAppVaiw.setOnClickListener(this.mCallback267);
            this.kswmbuxHomeHdvideoVaiw.setOnClickListener(this.mCallback266);
            this.kswmbuxHomeSettingVaiw.setOnClickListener(this.mCallback268);
        }
    }
