...
public abstract class AudiMib3TwoDataClsV2 extends ViewDataBinding {
    ...
    public static AudiMib3TwoDataClsV2 inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static AudiMib3TwoDataClsV2 inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (AudiMib3TwoDataClsV2) ViewDataBinding.inflateInternal(inflater, R.layout.audi_mib3_fragment_two_v2, root, attachToRoot, component);
    }

    public static AudiMib3TwoDataClsV2 inflate(LayoutInflater inflater) {
        return inflate(inflater, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static AudiMib3TwoDataClsV2 inflate(LayoutInflater inflater, Object component) {
        return (AudiMib3TwoDataClsV2) ViewDataBinding.inflateInternal(inflater, R.layout.audi_mib3_fragment_two_v2, null, false, component);
    }

    public static AudiMib3TwoDataClsV2 bind(View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static AudiMib3TwoDataClsV2 bind(View view, Object component) {
        return (AudiMib3TwoDataClsV2) bind(component, view, R.layout.audi_mib3_fragment_two_v2);
    }
}
