...
public class AudiMib3TyTwoBindingHdpi1920x720Impl extends AudiMib3TyTwoBinding {
    ...
    public AudiMib3TyTwoBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 22, sIncludes, sViewsWithIds));
    }

    private AudiMib3TyTwoBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
