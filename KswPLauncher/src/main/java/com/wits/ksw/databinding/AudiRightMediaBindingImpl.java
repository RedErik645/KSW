...
public class AudiRightMediaBindingImpl extends AudiRightMediaBinding implements OnClickListener.Listener {
    ...
    public AudiRightMediaBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }

    private AudiRightMediaBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2, (ImageView) bindings[1], (View) bindings[0], (Button) bindings[5], (Button) bindings[4], (Button) bindings[3], (ImageView) bindings[6], null, (TextView) bindings[2]);
        this.mDirtyFlags = -1;
        ...
        setRootTag(root);
        this.mCallback489 = new OnClickListener(this, 3);
        this.mCallback488 = new OnClickListener(this, 2);
        this.mCallback487 = new OnClickListener(this, 1);
        this.mCallback490 = new OnClickListener(this, 4);
        invalidateAll();
    }
    ...
    public void executeBindings() {
        ...
        if ((8 & dirtyFlags) != 0) {
            this.IvRightMusicIcon.setOnClickListener(this.mCallback487);
            this.btnMusicNext.setOnClickListener(this.mCallback490);
            this.btnMusicPlayPause.setOnClickListener(this.mCallback489);
            this.btnMusicPrev.setOnClickListener(this.mCallback488);
        }
        if ((dirtyFlags & 13) != 0) {
