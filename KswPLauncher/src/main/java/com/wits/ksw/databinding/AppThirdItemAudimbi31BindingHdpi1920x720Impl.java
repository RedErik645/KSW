...
public class AppThirdItemAudimbi31BindingHdpi1920x720Impl extends AppThirdItemAudimbi31Binding {
    ...
    public AppThirdItemAudimbi31BindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private AppThirdItemAudimbi31BindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
