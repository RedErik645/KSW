...
public class BenzMbuxDvrCardBindingImpl extends BenzMbuxDvrCardBinding implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((4 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback509);
            this.mboundView2.setOnClickListener(this.mCallback510);
            this.mboundView3.setOnClickListener(this.mCallback511);
        }
    }
