...
public abstract class ModusPempDataBinding extends ViewDataBinding {
    ...
    protected ModusPempDataBinding(Object _bindingComponent, View _root, int _localFieldCount, ImageView ivMask2, RelativeLayout llContainer2) {
    ...
    public static ModusPempDataBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (ModusPempDataBinding) ViewDataBinding.inflateInternal(inflater, R.layout.fragment_pemp_modus, root, attachToRoot, component);
    }
    ...
    public static ModusPempDataBinding inflate(LayoutInflater inflater, Object component) {
        return (ModusPempDataBinding) ViewDataBinding.inflateInternal(inflater, R.layout.fragment_pemp_modus, null, false, component);
    }
    ...
    public static ModusPempDataBinding bind(View view, Object component) {
        return (ModusPempDataBinding) bind(component, view, R.layout.fragment_pemp_modus);
    }
}
