...
public class BcItemBindingSw600dpLandImpl extends BcItemBinding implements OnClickListener.Listener {
    ...
    public BcItemBindingSw600dpLandImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }

    private BcItemBindingSw600dpLandImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
