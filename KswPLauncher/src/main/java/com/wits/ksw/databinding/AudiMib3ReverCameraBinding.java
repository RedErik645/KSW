...
public abstract class AudiMib3ReverCameraBinding extends ViewDataBinding {
    ...
    protected AudiMib3ReverCameraBinding(Object _bindingComponent, View _root, int _localFieldCount, RadioButton RadioButton12, RadioButton RadioButton22, RadioButton RadioButton32, RadioButton RadioButton42, RadioGroup timeRadioGroup2, AppCompatTextView title2, View titleDivider2, View vDivider2) {
        super(_bindingComponent, _root, _localFieldCount);
        this.RadioButton1 = RadioButton12;
        this.RadioButton2 = RadioButton22;
        this.RadioButton3 = RadioButton32;
        this.RadioButton4 = RadioButton42;
    ...
    public static AudiMib3ReverCameraBinding inflate(LayoutInflater inflater, Object component) {
        return (AudiMib3ReverCameraBinding) ViewDataBinding.inflateInternal(inflater, R.layout.audi_mib3_rever_camera, null, false, component);
    }
