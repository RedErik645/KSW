...
public class Benz2021KswV2FragmentOneHdpi1280x720Impl extends Benz2021KswV2FragmentOne {
    ...
    static {
        ...
        sparseIntArray.put(R.id.weather_rl, 23);
        sparseIntArray.put(R.id.weather_tv, 24);
        sparseIntArray.put(R.id.weather_tip, 25);
        sparseIntArray.put(R.id.iv_weather1, 26);
        sparseIntArray.put(R.id.space4, 27);
        sparseIntArray.put(R.id.iv_weather2, 28);
    ...
    public Benz2021KswV2FragmentOneHdpi1280x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 35, sIncludes, sViewsWithIds));
    }

    private Benz2021KswV2FragmentOneHdpi1280x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 4, (BenzMbuxItemView) bindings[6], (RelativeLayout) bindings[19], (TextView) bindings[7], (TextView) bindings[20], (LinearLayout) bindings[0], (ImageView) bindings[21], (ImageView) bindings[22], (ImageView) bindings[17], (ImageView) bindings[18], (ImageView) bindings[13], (ImageView) bindings[14], (ImageView) bindings[32], (ImageView) bindings[34], (ImageView) bindings[26], (ImageView) bindings[28], (FrameLayout) bindings[2], (RelativeLayout) bindings[15], (TextView) bindings[5], (TextView) bindings[16], (BenzMbuxItemView) bindings[1], (RelativeLayout) bindings[10], (TextView) bindings[12], (TextView) bindings[11], (BenzMbuxItemView) bindings[9], (TextView) bindings[31], (TextView) bindings[30], (RelativeLayout) bindings[29], null, null, null, (View) bindings[27], (View) bindings[33], (BenzMbuxItemView) bindings[8], (RelativeLayout) bindings[23], (TextView) bindings[25], (TextView) bindings[24]);
        this.mDirtyFlags = -1;
