...
public final class LandRoverLayoutSetFactoryBinding implements ViewBinding {
    ...
    private LandRoverLayoutSetFactoryBinding(LinearLayout rootView2, ImageView imgBtn02, ImageView imgBtn12, ImageView imgBtn22, ImageView imgBtn32, ImageView imgBtn42, ImageView imgBtn52, ImageView imgBtn62, ImageView imgBtn72, ImageView imgBtn82, ImageView imgBtn92, ImageView imgDel2, ImageView imgEnter2, TextView tvShowPwd2) {
    ...
    public static LandRoverLayoutSetFactoryBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static LandRoverLayoutSetFactoryBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.land_rover_layout_set_factory, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static LandRoverLayoutSetFactoryBinding bind(View rootView2) {
                                            ...
                                            if (imgBtn92 != null) {
                                                ...
                                                if (imgDel2 != null) {
                                                    ...
                                                    if (imgEnter2 != null) {
                                                        ...
                                                        if (tvShowPwd2 != null) {
                                                            return new LandRoverLayoutSetFactoryBinding((LinearLayout) rootView2, imgBtn02, imgBtn12, imgBtn22, imgBtn32, imgBtn42, imgBtn52, imgBtn62, imgBtn72, imgBtn82, imgBtn92, imgDel2, imgEnter2, tvShowPwd2);
                                                        }
                                                    }
                                                }
                                            }
