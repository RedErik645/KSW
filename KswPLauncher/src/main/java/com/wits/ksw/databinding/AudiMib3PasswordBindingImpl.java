...
public class AudiMib3PasswordBindingImpl extends AudiMib3PasswordBinding implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((4 & dirtyFlags) != 0) {
            this.audiKey0.setOnClickListener(this.mCallback278);
            this.audiKey1.setOnClickListener(this.mCallback269);
            this.audiKey2.setOnClickListener(this.mCallback270);
            this.audiKey3.setOnClickListener(this.mCallback271);
            this.audiKey4.setOnClickListener(this.mCallback272);
            this.audiKey5.setOnClickListener(this.mCallback273);
            this.audiKey6.setOnClickListener(this.mCallback274);
            this.audiKey7.setOnClickListener(this.mCallback275);
            this.audiKey8.setOnClickListener(this.mCallback276);
            this.audiKey9.setOnClickListener(this.mCallback277);
        }
        if ((dirtyFlags & 6) != 0) {
