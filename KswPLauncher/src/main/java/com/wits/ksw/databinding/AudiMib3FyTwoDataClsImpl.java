...
public class AudiMib3FyTwoDataClsImpl extends AudiMib3FyTwoDataCls {
    ...
    public AudiMib3FyTwoDataClsImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds));
    }

    private AudiMib3FyTwoDataClsImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
