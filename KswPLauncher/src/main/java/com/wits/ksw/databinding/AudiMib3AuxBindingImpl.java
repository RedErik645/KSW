...
public class AudiMib3AuxBindingImpl extends AudiMib3AuxBinding {
    ...
    public AudiMib3AuxBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }

    private AudiMib3AuxBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
