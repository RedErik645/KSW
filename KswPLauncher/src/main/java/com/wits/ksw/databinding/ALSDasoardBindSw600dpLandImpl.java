...
public class ALSDasoardBindSw600dpLandImpl extends ALSDasoardBind {
    ...
    public ALSDasoardBindSw600dpLandImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 24, sIncludes, sViewsWithIds));
    }

    private ALSDasoardBindSw600dpLandImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 11, (ImageView) bindings[19], (ConstraintLayout) bindings[12], (RadioButton) bindings[21], (RadioButton) bindings[22], (RadioButton) bindings[23], (RadioGroup) bindings[20], (ImageView) bindings[10], (ImageView) bindings[13], (ImageView) bindings[18], (ImageView) bindings[14], (ImageView) bindings[15], (ImageView) bindings[16], (ImageView) bindings[17], (ConstraintLayout) bindings[0], (TextView) bindings[8], (ImageView) bindings[11], (ImageView) bindings[3], (TextView) bindings[4], (ID7SpeedImageView) bindings[2], (ID7SpeedImageView) bindings[5], (TextView) bindings[9], (ImageView) bindings[6], (TextView) bindings[7]);
        this.mDirtyFlags = -1;
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags2 & 4608) != 0) {
            DashboardViewModel.setALSSpeedRotation(this.speedPointerImageView, viewModelCarInfoSpeedGet);
