    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags & 63) != 0) {
            ...
            if ((dirtyFlags & 56) != 0) {
                ...
                viewModelTimeSyncStateInt0MboundView7AndroidDrawableId8SettingsSystemSelectSelMboundView7AndroidDrawableId8SettingsSystemSelectN = viewModelTimeSyncStateInt0 ? AppCompatResources.getDrawable(this.mboundView7.getContext(), R.drawable.id8_settings_system_select_sel) : AppCompatResources.getDrawable(this.mboundView7.getContext(), R.drawable.id8_settings_system_select_n);
