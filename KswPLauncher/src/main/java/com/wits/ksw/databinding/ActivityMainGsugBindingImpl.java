...
public class ActivityMainGsugBindingImpl extends ActivityMainGsugBinding implements OnClickListener.Listener {
    ...
    private ActivityMainGsugBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        this.mCallback501 = new OnClickListener(this, 4);
        this.mCallback500 = new OnClickListener(this, 3);
        this.mCallback499 = new OnClickListener(this, 2);
        this.mCallback498 = new OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.appsButton.setOnClickListener(this.mCallback501);
            this.musicButton.setOnClickListener(this.mCallback498);
            this.naviButton.setOnClickListener(this.mCallback499);
            this.settingButton.setOnClickListener(this.mCallback500);
        }
    }
