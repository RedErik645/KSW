...
public abstract class Id7SubDashboardViewBinding extends ViewDataBinding {
    ...
    public static Id7SubDashboardViewBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static Id7SubDashboardViewBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (Id7SubDashboardViewBinding) ViewDataBinding.inflateInternal(inflater, R.layout.id7_sub_dashboard_view, root, attachToRoot, component);
    }

    public static Id7SubDashboardViewBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static Id7SubDashboardViewBinding inflate(LayoutInflater inflater, Object component) {
        return (Id7SubDashboardViewBinding) ViewDataBinding.inflateInternal(inflater, R.layout.id7_sub_dashboard_view, null, false, component);
    }

    public static Id7SubDashboardViewBinding bind(View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static Id7SubDashboardViewBinding bind(View view, Object component) {
