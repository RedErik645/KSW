...
public class BmwId9SettingsSystemBrightnessLayoutBindingImpl extends BmwId9SettingsSystemBrightnessLayoutBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.bmw_id9_settings_brightness_lay, 2);
        sparseIntArray.put(R.id.bmw_id9_settings_brightness_text, 3);
        sparseIntArray.put(R.id.bmw_id9_settings_brightness_sub_btn, 4);
        sparseIntArray.put(R.id.bmw_id9_settings_brightness_seekbar, 5);
        sparseIntArray.put(R.id.bmw_id9_settings_brightness_add_btn, 6);
    }

    public BmwId9SettingsSystemBrightnessLayoutBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }

    private BmwId9SettingsSystemBrightnessLayoutBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1, (ImageButton) bindings[6], (LinearLayout) bindings[2], (BmwId9ProgressBar) bindings[5], (ImageButton) bindings[4], (TextView) bindings[3]);
        this.mDirtyFlags = -1;
    ...
    @Override // com.wits.ksw.databinding.BmwId9SettingsSystemBrightnessLayoutBinding
