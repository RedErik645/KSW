...
public class DasoardBindHdpi1920x720Impl extends DasoardBind {
    ...
    public DasoardBindHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 16, sIncludes, sViewsWithIds));
    }

    private DasoardBindHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
