...
public class AppThirdItemLexusBindingImpl extends AppThirdItemLexusBinding {
    ...
    public AppThirdItemLexusBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private AppThirdItemLexusBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.AppThirdItemLexusBinding
