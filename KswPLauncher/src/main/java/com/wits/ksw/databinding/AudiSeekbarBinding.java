...
public final class AudiSeekbarBinding implements ViewBinding {
    ...
    private AudiSeekbarBinding(LinearLayout rootView2, SeekBar audioSeekbar2, TextView audioSeekbarLeftText2, TextView audioSeekbarRightText2, TextView audioSeekbarTitle2, Space space2) {
    ...
    public static AudiSeekbarBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static AudiSeekbarBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.audi_seekbar, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static AudiSeekbarBinding bind(View rootView2) {
            ...
            if (audioSeekbarLeftText2 != null) {
                ...
                if (audioSeekbarRightText2 != null) {
                    ...
                    if (audioSeekbarTitle2 != null) {
                        ...
                        if (space2 != null) {
                            return new AudiSeekbarBinding((LinearLayout) rootView2, audioSeekbar2, audioSeekbarLeftText2, audioSeekbarRightText2, audioSeekbarTitle2, space2);
                        }
                    }
                }
            }
