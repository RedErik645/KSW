...
public class ActivityId9AppsBindingImpl extends ActivityId9AppsBinding {
    ...
    public ActivityId9AppsBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }

    private ActivityId9AppsBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1, (CustomGridView) bindings[1], (LinearLayout) bindings[2]);
        this.mDirtyFlags = -1;
    ...
    @Override // com.wits.ksw.databinding.ActivityId9AppsBinding
