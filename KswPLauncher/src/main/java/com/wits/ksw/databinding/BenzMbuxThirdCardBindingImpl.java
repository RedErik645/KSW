...
public class BenzMbuxThirdCardBindingImpl extends BenzMbuxThirdCardBinding implements OnClickListener.Listener {
    ...
    public BenzMbuxThirdCardBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }

    private BenzMbuxThirdCardBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
