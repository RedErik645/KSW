...
public class BenzMbuxCarinfoCardBindingHdpi1920x720Impl extends BenzMbuxCarinfoCardBinding implements OnClickListener.Listener {
    ...
    public BenzMbuxCarinfoCardBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzMbuxCarinfoCardBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.wits.ksw.databinding.BenzMbuxCarinfoCardBinding
    ...
    public void executeBindings() {
        ...
        Drawable viewModelItemIconClassicalBenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeCarSelector1BenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeCarSelector2 = null;
        ...
        if ((dirtyFlags & 7) != 0) {
            ...
            viewModelItemIconClassicalBenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeCarSelector1BenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeCarSelector2 = AppCompatResources.getDrawable(this.benzMbuxLocalCardBg.getContext(), viewModelItemIconClassicalGet ? R.drawable.benz_mbux_2021_ksw_home_car_selector1 : R.drawable.benz_mbux_2021_ksw_home_car_selector2);
        }
        if ((7 & dirtyFlags) != 0) {
            ImageViewBindingAdapter.setImageDrawable(this.benzMbuxLocalCardBg, viewModelItemIconClassicalBenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeCarSelector1BenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeCarSelector2);
        }
        if ((4 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback328);
            this.mboundView2.setOnClickListener(this.mCallback329);
            this.mboundView3.setOnClickListener(this.mCallback330);
        }
    }
    ...
    public final void _internalCallbackOnClick(int sourceId, View callbackArg_0) {
        ...
        switch (sourceId) {
            ...
            case 3:
                ...
                if (viewModelJavaLangObjectNull) {
                    viewModel3.openCar(callbackArg_0);
                    return;
                }
                return;
            default:
