...
public class ActivityDashBoardAudiMib3BindingHdpi1560x700Impl extends ActivityDashBoardAudiMib3Binding {
    ...
    public ActivityDashBoardAudiMib3BindingHdpi1560x700Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 17, sIncludes, sViewsWithIds));
    }

    private ActivityDashBoardAudiMib3BindingHdpi1560x700Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
