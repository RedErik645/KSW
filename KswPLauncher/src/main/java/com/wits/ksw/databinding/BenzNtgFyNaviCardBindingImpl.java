...
public class BenzNtgFyNaviCardBindingImpl extends BenzNtgFyNaviCardBinding implements OnClickListener.Listener {
    ...
    public BenzNtgFyNaviCardBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzNtgFyNaviCardBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
