...
public class MainActivitySw600dpLandImpl extends MainActivity implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.menuButton1.setOnClickListener(this.mCallback227);
            this.menuButton2.setOnClickListener(this.mCallback226);
            this.menuButton3.setOnClickListener(this.mCallback225);
            this.menuButton4.setOnClickListener(this.mCallback228);
            this.menuButton5.setOnClickListener(this.mCallback229);
        }
    }
