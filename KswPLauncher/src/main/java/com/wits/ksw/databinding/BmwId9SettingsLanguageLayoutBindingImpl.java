...
public class BmwId9SettingsLanguageLayoutBindingImpl extends BmwId9SettingsLanguageLayoutBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.bmw_id9_settings_system_Language_lay, 2);
        sparseIntArray.put(R.id.bmw_id9_language_recycle, 3);
    }

    public BmwId9SettingsLanguageLayoutBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private BmwId9SettingsLanguageLayoutBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1, (RecyclerView) bindings[3], (LinearLayout) bindings[2]);
        this.mDirtyFlags = -1;
    ...
    @Override // com.wits.ksw.databinding.BmwId9SettingsLanguageLayoutBinding
