...
public class Id7V2SubMusicViewBindingImpl extends Id7V2SubMusicViewBinding implements OnClickListener.Listener {
    ...
    public Id7V2SubMusicViewBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds));
    }

    private Id7V2SubMusicViewBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.wits.ksw.databinding.Id7V2SubMusicViewBindingImpl.executeBindings():void");
    }
