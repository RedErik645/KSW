...
public class BenzNtgFyAppsCardBindingImpl extends BenzNtgFyAppsCardBinding implements OnClickListener.Listener {
    ...
    public BenzNtgFyAppsCardBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzNtgFyAppsCardBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback358);
            this.mboundView2.setOnClickListener(this.mCallback359);
            this.mboundView3.setOnClickListener(this.mCallback360);
        }
    }
