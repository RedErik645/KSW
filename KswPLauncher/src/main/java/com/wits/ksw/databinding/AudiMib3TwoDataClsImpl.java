...
public class AudiMib3TwoDataClsImpl extends AudiMib3TwoDataCls {
    ...
    public AudiMib3TwoDataClsImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds));
    }

    private AudiMib3TwoDataClsImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
