...
public final class RomeoLayoutSetSystemTwoBinding implements ViewBinding {
    ...
    public final ImageView romeoListR3;
    ...
    private RomeoLayoutSetSystemTwoBinding(RelativeLayout rootView2, ImageView imgTwoDefaul2, RecyclerView listviewMusic2, RecyclerView listviewVideo2, RtlRadioButton rdbShext12, RtlRadioButton rdbShext22, RtlRadioButton rdbShext32, RtlRadioButton rdbShext42, RadioGroup rdgShext2, RadioGroup rdgTempGroup3, RtlRadioButton rdgTempGroup12, RtlRadioButton rdgTempGroup22, LinearLayout relateAuxweiz2, RelativeLayout relateBeigld2, RelativeLayout relateShext2, ImageView romeoListR12, ImageView romeoListR22, ImageView romeoListR32, SeekBar seekbarBrightness2, SeekBar seekbarCaux3, SeekBar seekbarCaux22, TextView tvBeigSize2, TextView tvCauxSize3, TextView tvCauxSize22, TextView tvTebgld2) {
    ...
    public static RomeoLayoutSetSystemTwoBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static RomeoLayoutSetSystemTwoBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.romeo_layout_set_system_two, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static RomeoLayoutSetSystemTwoBinding bind(View rootView2) {
                                                            ...
                                                            if (relateShext2 != null) {
                                                                ...
                                                                if (romeoListR12 != null) {
                                                                    ...
                                                                    if (romeoListR22 != null) {
                                                                        id = R.id.romeo_list_r3;
                                                                        ImageView romeoListR32 = (ImageView) rootView2.findViewById(R.id.romeo_list_r3);
                                                                        if (romeoListR32 != null) {
                                                                                        ...
                                                                                        if (tvBeigSize2 != null) {
                                                                                            ...
                                                                                            if (tvCauxSize3 != null) {
                                                                                                ...
                                                                                                if (tvCauxSize22 != null) {
                                                                                                    ...
                                                                                                    if (tvTebgld2 != null) {
                                                                                                        return new RomeoLayoutSetSystemTwoBinding((RelativeLayout) rootView2, imgTwoDefaul2, listviewMusic2, listviewVideo2, rdbShext12, rdbShext22, rdbShext32, rdbShext42, rdgShext2, rdgTempGroup3, rdgTempGroup12, rdgTempGroup22, relateAuxweiz2, relateBeigld2, relateShext2, romeoListR12, romeoListR22, romeoListR32, seekbarBrightness2, seekbarCaux3, seekbarCaux22, tvBeigSize2, tvCauxSize3, tvCauxSize22, tvTebgld2);
                                                                                                    }
                                                                                                }
                                                                                            }
                                                                                        }
