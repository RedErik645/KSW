...
public class BenzNtgFySetCardBindingImpl extends BenzNtgFySetCardBinding implements OnClickListener.Listener {
    ...
    public BenzNtgFySetCardBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private BenzNtgFySetCardBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback555);
            this.mboundView2.setOnClickListener(this.mCallback556);
            this.mboundView3.setOnClickListener(this.mCallback557);
        }
    }
