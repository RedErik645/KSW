...
public abstract class Id7AppItemBinding extends ViewDataBinding {
    ...
    protected Id7AppItemBinding(Object _bindingComponent, View _root, int _localFieldCount, ConstraintLayout BcItemConstraintLayout2, FrameLayout appIconView2, TextView badgeNumber2, ImageView nameImageView2, TextView textView2) {
    ...
    public static Id7AppItemBinding inflate(LayoutInflater inflater, Object component) {
        return (Id7AppItemBinding) ViewDataBinding.inflateInternal(inflater, R.layout.id7_app_item, null, false, component);
    }
