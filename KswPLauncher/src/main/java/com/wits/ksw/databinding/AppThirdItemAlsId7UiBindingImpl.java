...
public class AppThirdItemAlsId7UiBindingImpl extends AppThirdItemAlsId7UiBinding {
    ...
    public AppThirdItemAlsId7UiBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private AppThirdItemAlsId7UiBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (ImageView) bindings[1], (CustomRadioButton) bindings[3], (TextView) bindings[2]);
        this.mDirtyFlags = -1;
    ...
    @Override // com.wits.ksw.databinding.AppThirdItemAlsId7UiBinding
