...
public class AlsId7UiSubNaviViewBindingImpl extends AlsId7UiSubNaviViewBinding implements OnClickListener.Listener {
    ...
    public AlsId7UiSubNaviViewBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private AlsId7UiSubNaviViewBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.naviImageView.setOnClickListener(this.mCallback464);
        }
    }
