...
public abstract class FragmentPempWeatherEditBinding extends ViewDataBinding {
    ...
    protected FragmentPempWeatherEditBinding(Object _bindingComponent, View _root, int _localFieldCount, TextView btA2, TextView btB2, TextView btC2, ImageView ivDivider2, RelativeLayout layout2, ImageView remove2, RelativeLayout temperature2, TextView temperatureTv2, TextView tvCity2, TextView tvTitle2, TextView unitWeather2, TextView weatherTv2) {
    ...
    public static FragmentPempWeatherEditBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (FragmentPempWeatherEditBinding) ViewDataBinding.inflateInternal(inflater, R.layout.fragment_pemp_weather_edit, root, attachToRoot, component);
    }
    ...
    public static FragmentPempWeatherEditBinding inflate(LayoutInflater inflater, Object component) {
        return (FragmentPempWeatherEditBinding) ViewDataBinding.inflateInternal(inflater, R.layout.fragment_pemp_weather_edit, null, false, component);
    }
    ...
    public static FragmentPempWeatherEditBinding bind(View view, Object component) {
        return (FragmentPempWeatherEditBinding) bind(component, view, R.layout.fragment_pemp_weather_edit);
    }
}
