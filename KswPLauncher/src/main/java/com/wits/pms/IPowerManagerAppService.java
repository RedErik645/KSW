        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    boolean sendCommand = sendCommand(data.readString());
                    reply.writeNoException();
                    reply.writeInt(sendCommand ? 1 : 0);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    boolean sendStatus = sendStatus(data.readString());
                    reply.writeNoException();
                ...
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    boolean statusBoolean = getStatusBoolean(data.readString());
                    reply.writeNoException();
                    reply.writeInt(statusBoolean ? 1 : 0);
                    return true;
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    int _result = getStatusInt(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    String _result2 = getStatusString(data.readString());
                    reply.writeNoException();
                    reply.writeString(_result2);
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    int _result3 = getSettingsInt(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result3);
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    String _result4 = getSettingsString(data.readString());
                    reply.writeNoException();
                ...
                case 18:
                    data.enforceInterface(DESCRIPTOR);
                    String _result5 = getJsonConfig(data.readString());
                    reply.writeNoException();
