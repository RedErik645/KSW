...
public class WitsCommand {
    ...
    public static void sendCommandDelay(final int command2, final int subCommand2, final String arg, final long delayTime) {
        new Thread() {
            /* class com.wits.pms.statuscontrol.WitsCommand.AnonymousClass1 */
