...
public class SimpleDateFormat extends DateFormat {
    ...
    /* access modifiers changed from: protected */
    /* JADX WARNING: Removed duplicated region for block: B:223:0x0653  */
    /* JADX WARNING: Removed duplicated region for block: B:224:0x0662  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:322:0x088c  */
    /* JADX WARNING: Removed duplicated region for block: B:323:0x089b  */
    ...
    /* JADX INFO: Multiple debug info for r1v11 'localMillis'  long: [D('numericFieldStart' int), D('localMillis' long)] */
    /* JADX INFO: Multiple debug info for r8v14 'start'  int: [D('dayPeriod' com.ibm.icu.util.Output<com.ibm.icu.impl.DayPeriodRules$DayPeriod>), D('start' int)] */
    /* JADX INFO: Multiple debug info for r7v16 'items'  java.lang.Object[]: [D('items' java.lang.Object[]), D('tzTimeType' com.ibm.icu.util.Output<com.ibm.icu.text.TimeZoneFormat$TimeType>)] */
    /* JADX INFO: Multiple debug info for r15v6 'backupTZ'  com.ibm.icu.util.TimeZone: [D('cal' com.ibm.icu.util.Calendar), D('backupTZ' com.ibm.icu.util.TimeZone)] */
    /* JADX INFO: Multiple debug info for r15v9 'cal'  com.ibm.icu.util.Calendar: [D('cal' com.ibm.icu.util.Calendar), D('backupTZ' com.ibm.icu.util.TimeZone)] */
    /* JADX WARNING: Code restructure failed: missing block: B:179:0x03fa, code lost:
    ...
    /* JADX WARNING: Removed duplicated region for block: B:155:0x0378 A[SYNTHETIC, Splitter:B:155:0x0378] */
    /* JADX WARNING: Removed duplicated region for block: B:232:0x04f2  */
    /* JADX WARNING: Removed duplicated region for block: B:235:0x0500  */
    /* JADX WARNING: Removed duplicated region for block: B:237:0x0510  */
    /* JADX WARNING: Removed duplicated region for block: B:238:0x0518  */
    /* JADX WARNING: Removed duplicated region for block: B:243:0x0531  */
    ...
    /* JADX INFO: Multiple debug info for r5v60 'currentNumberFormat'  com.ibm.icu.text.NumberFormat: [D('currentNumberFormat' com.ibm.icu.text.NumberFormat), D('patternCharIndex' int)] */
    /* JADX WARNING: Code restructure failed: missing block: B:194:0x038b, code lost:
        if (r5 > r33.formatData.shortYearNames.length) goto L_0x0390;
     */
    ...
    @Override // java.lang.Object, com.ibm.icu.text.DateFormat
    public Object clone() {
    ...
    public final StringBuffer intervalFormatByAlgorithm(Calendar fromCalendar, Calendar toCalendar, StringBuffer appendTo, FieldPosition pos) throws IllegalArgumentException {
        ...
        if (fromCalendar.isEquivalentTo(toCalendar)) {
            ...
            try {
                ...
                if (diffBegin == 0 && i6 == items.length - 1) {
                    format(fromCalendar, appendTo, pos);
                    appendTo.append(str2);
                    format(toCalendar, appendTo, pos);
                    return appendTo;
