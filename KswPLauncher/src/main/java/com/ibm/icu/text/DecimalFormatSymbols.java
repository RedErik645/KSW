...
public class DecimalFormatSymbols implements Cloneable, Serializable {
    ...
    private static final String[] DEF_DIGIT_STRINGS_ARRAY = {TxzMessage.TXZ_DISMISS, "1", "2", "3", "4", Id9AlsConstants.ID9ALS_SELECT_MODEL_VITALITY, Id9AlsConstants.ID9ALS_SELECT_MODEL_MYSTERIOUS, Id9AlsConstants.ID9ALS_SELECT_MODEL_STEADY, "8", "9"};
    ...
    private static final CacheBase<ULocale, CacheData, Void> cachedLocaleData = new SoftCache<ULocale, CacheData, Void>() {
        /* class com.ibm.icu.text.DecimalFormatSymbols.AnonymousClass1 */
