...
public class TimeUnitFormat extends MeasureFormat {
    ...
    /* JADX INFO: Multiple debug info for r3v11 java.lang.Object: [D('temp' java.lang.Number), D('tempObj' java.lang.Object)] */
    ...
    public TimeUnitAmount parseObject(String source, ParsePosition pos) {
        ...
        while (true) {
            ...
            for (Map.Entry<String, Object[]> patternEntry : timeUnitFormat.timeUnitToCountToPatterns.get(timeUnit).entrySet()) {
                ...
                int newPos3 = newPos;
                TimeUnit resultTimeUnit = resultNumber2;
        ...
        pos.setIndex(newPos);
        pos.setErrorIndex(-1);
        return new TimeUnitAmount(resultNumber, resultNumber2);
    }
    ...
    private void setup(String resourceKey, Map<TimeUnit, Map<String, Object[]>> timeUnitToCountToPatterns2, int style2, Set<String> pluralKeywords) {
        ...
        try {
            try {
                try {
                    UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt63b/unit", this.locale).getAllItemsWithFallback(resourceKey, new TimeUnitFormatSetupSink(timeUnitToCountToPatterns2, style2, pluralKeywords, this.locale));
    ...
    private void searchInTree(String resourceKey, int styl, TimeUnit timeUnit, String srcPluralCount, String searchPluralCount, Map<String, Object[]> countToPatterns) {
        ...
        while (parentLocale2 != null) {
            try {
                MessageFormat messageFormat = new MessageFormat(UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt63b/unit", parentLocale2).getWithFallback(resourceKey).getWithFallback(srcTimeUnitName).getStringWithFallback(searchPluralCount), this.locale);
