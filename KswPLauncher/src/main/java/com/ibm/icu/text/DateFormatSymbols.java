...
public class DateFormatSymbols implements Serializable, Cloneable {
    ...
    private static CacheBase<String, DateFormatSymbols, ULocale> DFSCACHE = new SoftCache<String, DateFormatSymbols, ULocale>() {
        /* class com.ibm.icu.text.DateFormatSymbols.AnonymousClass1 */
    ...
    /* JADX INFO: Multiple debug info for r4v14 boolean[]: [D('transforms' boolean[]), D('ssWeekdays' java.lang.String[])] */
    /* access modifiers changed from: protected */
    @Deprecated
