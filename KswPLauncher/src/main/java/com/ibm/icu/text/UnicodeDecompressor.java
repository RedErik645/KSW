...
public final class UnicodeDecompressor implements SCSU {
    ...
    /* JADX INFO: Multiple debug info for r4v0 int: [D('ucPos' int), D('bytePos' int)] */
    /* JADX INFO: Multiple debug info for r0v15 byte: [D('aByte' int), D('bytePos' int)] */
    /* JADX INFO: Multiple debug info for r3v4 int: [D('aByte' int), D('ucPos' int)] */
    ...
    public int decompress(byte[] byteBuffer, int byteBufferStart, int byteBufferLimit, int[] bytesRead, char[] charBuffer, int charBufferStart, int charBufferLimit) {
        ...
        if (i2 > 0) {
            ...
            i = 0;
            ucPos += decompress(bArr2, 0, bArr2.length, null, charBuffer, charBufferStart, charBufferLimit);
            bytePos += newBytes;
        } else {
            i = 0;
        }
                                ...
                                switch (aByte) {
                                    ...
                                    case 8:
                                        if (bytePos2 >= byteBufferLimit) {
                                            ...
                                            int dByte = byteBuffer[bytePos2] & UByte.MAX_VALUE;
                                            int ucPos2 = ucPos + 1;
                                    ...
                                    case 11:
                                        if (bytePos2 + 1 >= byteBufferLimit) {
                                            ...
                                            int aByte2 = byteBuffer[bytePos2] & UByte.MAX_VALUE;
                                            int i5 = (aByte2 & 224) >> 5;
                                            this.fCurrentWindow = i5;
                                            this.fOffsets[i5] = (((byteBuffer[bytePos6] & UByte.MAX_VALUE) | ((aByte2 & 31) << 8)) * 128) + 65536;
                                            bytePos = bytePos6 + 1;
                                        }
                                    case 12:
                                    default:
                                    ...
                                    case 14:
                                        if (bytePos2 + 1 >= byteBufferLimit) {
                                            ...
                                            charBuffer[ucPos] = (char) ((byteBuffer[bytePos8] & UByte.MAX_VALUE) | (byteBuffer[bytePos2] << 8));
                                            ucPos++;
                                            bytePos = bytePos8 + 1;
                                        }
                                    case 15:
                                    ...
                                    case 31:
                                        if (bytePos2 >= byteBufferLimit) {
                                            ...
                                            this.fOffsets[i8] = sOffsetTable[byteBuffer[bytePos2] & UByte.MAX_VALUE];
                                            bytePos = bytePos2 + 1;
                                        }
                                    case 128:
                                    case 129:
                                    case 130:
                                    case 131:
                                    case WitsCommand.SystemCommand.PRE_SEEK_FM /*{ENCODED_INT: 132}*/:
                                    case WitsCommand.SystemCommand.NEXT_DOT_SEEK_FM /*{ENCODED_INT: 133}*/:
                                    case WitsCommand.SystemCommand.PRE_DOT_SEEK_FM /*{ENCODED_INT: 134}*/:
                                    case WitsCommand.SystemCommand.ST_SWITCH /*{ENCODED_INT: 135}*/:
                                    case WitsCommand.SystemCommand.LOC_SWITCH /*{ENCODED_INT: 136}*/:
                                    case 137:
                                    case 138:
                                    case 139:
                                    case 140:
                                    ...
                                    case 148:
                                    case 149:
                                    case Constants.DEFAULT_SIZE /*{ENCODED_INT: 150}*/:
                                    case 151:
                                    case 152:
                                    case 153:
                                    case 154:
                                    ...
                                    case 199:
                                    case 200:
                                    case WitsCommand.SystemCommand.UPDATE_SYSTEM /*{ENCODED_INT: 201}*/:
                                    case WitsCommand.SystemCommand.UPDATE_MCU /*{ENCODED_INT: 202}*/:
                                    case WitsCommand.SystemCommand.UPDATE_POWER_VOLTAGE /*{ENCODED_INT: 203}*/:
                                    case WitsCommand.SystemCommand.LOW_POWER_VOLTAGE_WARNING /*{ENCODED_INT: 204}*/:
                                    case WitsCommand.SystemCommand.DISMISS_POWER_VOLTAGE_DIALOG /*{ENCODED_INT: 205}*/:
                                    case WitsCommand.SystemCommand.LOW_OR_HIGH_POWER_VOLTAGE_SHUTDOWN /*{ENCODED_INT: 206}*/:
                                    case WitsCommand.SystemCommand.REBOOT_MACHINE /*{ENCODED_INT: 207}*/:
                                    case WitsCommand.SystemCommand.SET_PWM_DUTY_RATIO /*{ENCODED_INT: 208}*/:
                                    case WitsCommand.SystemCommand.SAVE_TP_ALIGN_DATA /*{ENCODED_INT: 209}*/:
                                    case WitsCommand.SystemCommand.UPDATE_FK_CONFIG /*{ENCODED_INT: 210}*/:
                                    case 211:
                                    case 212:
                                    case 213:
                                    case 214:
                                    ...
                                    case 218:
                                    case 219:
                                    case WitsCommand.SystemCommand.IMPORT_CONFIG /*{ENCODED_INT: 220}*/:
                                    case 221:
                                    case 222:
                                    case 223:
                                    case 224:
                                    ...
                                    case 247:
                                    case 248:
                                    case SCSU.LATININDEX:
                                    case 250:
                                    case SCSU.GREEKINDEX:
                                    case SCSU.ARMENIANINDEX:
                                    case SCSU.HIRAGANAINDEX:
                                    case SCSU.KATAKANAINDEX:
                                    case 255:
                                ...
                                switch (aByte3) {
                                    ...
                                    case SCSU.UDEFINE7:
                                        if (bytePos11 < byteBufferLimit) {
                                            int i11 = aByte3 - 232;
                                            this.fCurrentWindow = i11;
                                            this.fOffsets[i11] = sOffsetTable[byteBuffer[bytePos11] & UByte.MAX_VALUE];
                                            this.fMode = i;
                                            bytePos = bytePos11 + 1;
                                            break;
                                        } else {
                                            ...
                                            int i12 = byteBufferLimit - bytePos12;
                                            this.fBufferLength = i12;
                                            bytePos = bytePos12 + i12;
                                            break;
                                        }
                                    case SCSU.UQUOTEU:
                                        if (bytePos11 >= byteBufferLimit - 1) {
                                            ...
                                            bytePos = bytePos14 + 1;
                                            charBuffer[ucPos] = (char) ((byteBuffer[bytePos11] << 8) | (byteBuffer[bytePos14] & UByte.MAX_VALUE));
                                            ucPos++;
                                        }
                                    case SCSU.UDEFINEX:
                                        if (bytePos11 + 1 < byteBufferLimit) {
                                            int bytePos15 = bytePos11 + 1;
                                            int aByte4 = byteBuffer[bytePos11] & UByte.MAX_VALUE;
                                            int i14 = (aByte4 & 224) >> 5;
                                            this.fCurrentWindow = i14;
                                            this.fOffsets[i14] = (((byteBuffer[bytePos15] & UByte.MAX_VALUE) | ((aByte4 & 31) << 8)) * 128) + 65536;
                                            this.fMode = i;
                                            bytePos = bytePos15 + 1;
                                            break;
                                        } else {
                                            ...
                                            int i15 = byteBufferLimit - bytePos16;
                                            this.fBufferLength = i15;
                                            bytePos = bytePos16 + i15;
                                            break;
                                        }
                                    default:
                                        if (bytePos11 >= byteBufferLimit) {
                                            ...
                                            bytePos = bytePos11 + 1;
                                            charBuffer[ucPos] = (char) ((byteBuffer[bytePos11] & UByte.MAX_VALUE) | (aByte3 << 8));
                                            ucPos++;
                                        }
                                }
                            }
