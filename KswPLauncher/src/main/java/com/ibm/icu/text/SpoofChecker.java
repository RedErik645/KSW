...
public class SpoofChecker {
    ...
    public static class Builder {
        ...
        public Builder(SpoofChecker src) {
            ...
            this.fAllowedCharsSet = unicodeSet;
            LinkedHashSet linkedHashSet = new LinkedHashSet();
            this.fAllowedLocales = linkedHashSet;
            this.fChecks = src.fChecks;
            this.fSpoofData = src.fSpoofData;
            unicodeSet.set(src.fAllowedCharsSet);
            linkedHashSet.addAll(src.fAllowedLocales);
        ...
        public Builder setData(Reader confusables) throws ParseException, IOException {
            SpoofData spoofData = new SpoofData();
            this.fSpoofData = spoofData;
            ConfusabledataBuilder.buildConfusableData(confusables, spoofData);
            return this;
        }
        ...
        private void addScriptChars(ULocale locale, UnicodeSet allowedChars) {
            ...
            if (scripts != null) {
                ...
                for (int i : scripts) {
                    tmpSet.applyIntPropertyValue(4106, i);
            ...
            public void build(Reader confusables, SpoofData dest) throws ParseException, IOException {
                ...
                if (numKeys == numValues) {
                    ...
                    while (it2.hasNext()) {
                        ...
                        if (value2 < 65535) {
                            dest.fCFUValues[i3] = (short) value2;
                            i3++;
                        } else {
                            throw new AssertionError();
                        }
    ...
    public static final class ConfusableDataUtils {
        ...
        public static final int codePointAndLengthToKey(int codePoint, int length) {
            if ((16777215 & codePoint) != codePoint) {
                throw new AssertionError();
            } else if (length <= 256) {
    ...
    public static class SpoofData {
        ...
        private SpoofData(ByteBuffer bytes) throws IOException {
            ICUBinary.readHeader(bytes, (int) DATA_FORMAT, IS_ACCEPTABLE);
            bytes.mark();
            readData(bytes);
        }
