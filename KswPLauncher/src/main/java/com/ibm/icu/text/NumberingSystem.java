...
public class NumberingSystem {
    ...
    private static CacheBase<String, NumberingSystem, LocaleLookupData> cachedLocaleData = new SoftCache<String, NumberingSystem, LocaleLookupData>() {
        /* class com.ibm.icu.text.NumberingSystem.AnonymousClass1 */
    ...
    private static CacheBase<String, NumberingSystem, Void> cachedStringData = new SoftCache<String, NumberingSystem, Void>() {
        /* class com.ibm.icu.text.NumberingSystem.AnonymousClass2 */
    ...
    static NumberingSystem lookupInstanceByLocale(LocaleLookupData localeLookupData) {
        try {
            ICUResourceBundle rb = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt63b", localeLookupData.locale).getWithFallback("NumberElements");
    ...
    public static NumberingSystem getInstanceByName(String name2) {
        return (NumberingSystem) cachedStringData.getInstance(name2, (Object) null);
    }

    /* access modifiers changed from: private */
    public static NumberingSystem lookupInstanceByName(String name2) {
        try {
            UResourceBundle nsTop = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt63b", "numberingSystems").get("numberingSystems").get(name2);
    ...
    public static String[] getAvailableNames() {
        UResourceBundle nsCurrent = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt63b", "numberingSystems").get("numberingSystems");
