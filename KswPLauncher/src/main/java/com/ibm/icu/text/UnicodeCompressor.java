...
public final class UnicodeCompressor implements SCSU {
    ...
    /* JADX INFO: Multiple debug info for r5v23 int: [D('ucPos' int), D('bytePos' int)] */
    /* JADX INFO: Multiple debug info for r11v1 int: [D('loByte' int), D('hiByte' int)] */
    /* JADX INFO: Multiple debug info for r5v32 int: [D('ucPos' int), D('bytePos' int)] */
    /* JADX INFO: Multiple debug info for r5v39 int: [D('ucPos' int), D('bytePos' int)] */
    /* JADX INFO: Multiple debug info for r5v45 int: [D('ucPos' int), D('bytePos' int)] */
    /* JADX INFO: Multiple debug info for r5v55 int: [D('ucPos' int), D('bytePos' int)] */
    /* JADX INFO: Multiple debug info for r11v3 int: [D('loByte' int), D('hiByte' int)] */
    /* JADX INFO: Multiple debug info for r5v61 int: [D('ucPos' int), D('bytePos' int)] */
    /* JADX INFO: Multiple debug info for r5v72 int: [D('ucPos' int), D('bytePos' int)] */
    /* JADX INFO: Multiple debug info for r10v5 int: [D('bytePos' int), D('whichWindow' int)] */
    /* JADX INFO: Multiple debug info for r5v105 int: [D('ucPos' int), D('bytePos' int)] */
    /* JADX INFO: Multiple debug info for r5v118 int: [D('ucPos' int), D('bytePos' int)] */
    /* JADX INFO: Multiple debug info for r5v124 int: [D('ucPos' int), D('whichWindow' int)] */
    /* JADX INFO: Multiple debug info for r10v8 int: [D('bytePos' int), D('whichWindow' int)] */
    /* JADX INFO: Can't fix incorrect switch cases order, some code will duplicate */
    /* JADX WARNING: Code restructure failed: missing block: B:106:0x0231, code lost:
        if ((r4 + 3) < r26) goto L_0x0237;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:109:0x0243, code lost:
        if (com.ibm.icu.text.UnicodeCompressor.sUnicodeTagTable[r4] == false) goto L_0x024c;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:153:0x0339, code lost:
        if (com.ibm.icu.text.UnicodeCompressor.sUnicodeTagTable[r4] == false) goto L_0x0342;
     */
