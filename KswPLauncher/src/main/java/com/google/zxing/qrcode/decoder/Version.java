...
public final class Version {
    ...
    private Version(int versionNumber2, int[] alignmentPatternCenters2, ECBlocks... ecBlocks2) {
        ...
        ECB[] eCBlocks = ecBlocks2[0].getECBlocks();
