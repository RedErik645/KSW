...
public final class MaskUtil {
    ...
    static int applyMaskPenaltyRule2(ByteMatrix matrix) {
        ...
        for (int y = 0; y < height - 1; y++) {
            ...
            for (int x = 0; x < width - 1; x++) {
                byte b = arrayY[x];
                if (b == arrayY[x + 1] && b == array[y + 1][x] && b == array[y + 1][x + 1]) {
                    penalty++;
                }
            }
        }
    ...
    /* JADX INFO: Multiple debug info for r2v10 int: [D('intermediate' int), D('temp' int)] */
    /* JADX INFO: Multiple debug info for r2v13 int: [D('intermediate' int), D('temp' int)] */
