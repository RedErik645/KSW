...
public final class Decoder {
    private static final String[] DIGIT_TABLE = {"CTRL_PS", " ", TxzMessage.TXZ_DISMISS, "1", "2", "3", "4", Id9AlsConstants.ID9ALS_SELECT_MODEL_VITALITY, Id9AlsConstants.ID9ALS_SELECT_MODEL_MYSTERIOUS, Id9AlsConstants.ID9ALS_SELECT_MODEL_STEADY, "8", "9", ",", ".", "CTRL_UL", "CTRL_US"};
