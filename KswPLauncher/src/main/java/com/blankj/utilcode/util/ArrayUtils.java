...
public class ArrayUtils {
    ...
    public static <T> T[] add(T[] array, T element) {
        return (T[]) ((Object[]) realAddOne(array, element, array != null ? array.getClass() : element != null ? element.getClass() : Object.class));
    }
    ...
    public static <T> T[] add(T[] array, int index, T element) {
        ...
        return (T[]) ((Object[]) realAdd(array, index, element, clss));
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r7v0, resolved type: com.blankj.utilcode.util.ArrayUtils$Closure<E> */
