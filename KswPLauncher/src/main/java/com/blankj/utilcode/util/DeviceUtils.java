...
public final class DeviceUtils {
    ...
    public static boolean isDeviceRooted() {
        ...
        for (int i = 0; i < length; i++) {
            if (new File(locations[i] + "su").exists()) {
                return true;
            }
        }
        return false;
                ...
                if (ni != null) {
                    if (ni.getName().equalsIgnoreCase("wlan0")) {
                        ...
                        if (macBytes != null && macBytes.length > 0) {
                            ...
                            for (int i = 0; i < length; i++) {
                                sb.append(String.format("%02x:", Byte.valueOf(macBytes[i])));
                            }
    ...
    public static boolean isSameDevice(String uniqueDeviceId) {
        ...
        if (uniqueDeviceId.equals(udid) || uniqueDeviceId.equals(UtilsBridge.getSpUtils4Utils().getString(KEY_UDID, null))) {
            return true;
        }
