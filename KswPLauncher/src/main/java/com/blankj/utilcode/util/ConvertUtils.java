...
public final class ConvertUtils {
    ...
    public static byte[] bits2Bytes(String bits) {
        ...
        if (lenMod != 0) {
            for (int i = lenMod; i < 8; i++) {
                bits = TxzMessage.TXZ_DISMISS + bits;
            }
            byteLen++;
        }
    ...
    public static byte[] hexString2Bytes(String hexString) {
        ...
        if (len % 2 != 0) {
            hexString = TxzMessage.TXZ_DISMISS + hexString;
            len++;
        }
    ...
    public static String byte2FitMemorySize(long byteSize, int precision) {
        ...
        } else if (byteSize < PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID) {
            return String.format("%." + precision + "fB", Double.valueOf((double) byteSize));
        } else if (byteSize < PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED) {
            return String.format("%." + precision + "fKB", Double.valueOf(((double) byteSize) / 1024.0d));
        } else if (byteSize < 1073741824) {
            return String.format("%." + precision + "fMB", Double.valueOf(((double) byteSize) / 1048576.0d));
        } else {
            return String.format("%." + precision + "fGB", Double.valueOf(((double) byteSize) / 1.073741824E9d));
        }
    }
    ...
    public static List<String> inputStream2Lines(InputStream is, String charsetName) {
        ...
        try {
            ...
            BufferedReader reader2 = new BufferedReader(new InputStreamReader(is, getSafeCharset(charsetName)));
            while (true) {
