...
public final class FragmentUtils {
    ...
    public static void show(Fragment show) {
        if (show != null) {
            putArgs(show, false);
            operateNoAnim(show.getFragmentManager(), 2, null, show);
            return;
        }
    ...
    public static void show(FragmentManager fm) {
        if (fm != null) {
            ...
            operateNoAnim(fm, 2, null, (Fragment[]) fragments.toArray(new Fragment[0]));
            return;
        }
    ...
    public static void hide(Fragment hide) {
        if (hide != null) {
            putArgs(hide, true);
            operateNoAnim(hide.getFragmentManager(), 4, null, hide);
            return;
        }
    ...
    public static void hide(FragmentManager fm) {
        if (fm != null) {
            ...
            operateNoAnim(fm, 4, null, (Fragment[]) fragments.toArray(new Fragment[0]));
            return;
        }
        throw new NullPointerException("Argument 'fm' of type FragmentManager (#0 out of 1, zero-based) is marked by @android.support.annotation.NonNull but got null for it");
    }
    ...
    public static void remove(Fragment remove) {
        if (remove != null) {
            operateNoAnim(remove.getFragmentManager(), 32, null, remove);
            return;
        }
    ...
    public static void removeAll(FragmentManager fm) {
        if (fm != null) {
            operateNoAnim(fm, 32, null, (Fragment[]) getFragments(fm).toArray(new Fragment[0]));
            return;
        }
        throw new NullPointerException("Argument 'fm' of type FragmentManager (#0 out of 1, zero-based) is marked by @android.support.annotation.NonNull but got null for it");
    }
    ...
    public static class Args {
        ...
        Args(int id2, boolean isHide2, boolean isAddStack2) {
            this(id2, null, isHide2, isAddStack2);
        }
    ...
    public static class FragmentNode {
        ...
        public String toString() {
            ...
            return append.append((list == null || list.isEmpty()) ? "no child" : this.next.toString()).toString();
        }
    }
}
