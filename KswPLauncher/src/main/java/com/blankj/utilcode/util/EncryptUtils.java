...
public final class EncryptUtils {
    ...
    public static String encryptMD5File2String(String filePath) {
        return encryptMD5File2String(UtilsBridge.isSpace(filePath) ? null : new File(filePath));
    }

    public static byte[] encryptMD5File(String filePath) {
        return encryptMD5File(UtilsBridge.isSpace(filePath) ? null : new File(filePath));
    }
    ...
    /* JADX INFO: Multiple debug info for r7v0 int: [D('lowerTrans' java.lang.String), D('count' int)] */
