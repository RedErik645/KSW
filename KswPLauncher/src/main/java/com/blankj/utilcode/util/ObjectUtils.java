...
public final class ObjectUtils {
    ...
    public static <T> int compare(T a, T b, Comparator<? super T> c) {
        if (c == null) {
            throw new NullPointerException("Argument 'c' of type Comparator<? super T> (#2 out of 3, zero-based) is marked by @android.support.annotation.NonNull but got null for it");
        } else if (a == b) {
            return 0;
        } else {
