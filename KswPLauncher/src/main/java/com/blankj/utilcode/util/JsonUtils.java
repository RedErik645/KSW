...
public final class JsonUtils {
    ...
    public static int getInt(JSONObject jsonObject, String key, int defaultValue) {
        return ((Integer) getValueByType(jsonObject, key, Integer.valueOf(defaultValue), (byte) 1)).intValue();
    }
    ...
    public static int getInt(String json, String key, int defaultValue) {
        return ((Integer) getValueByType(json, key, Integer.valueOf(defaultValue), (byte) 1)).intValue();
    }
    ...
    public static long getLong(JSONObject jsonObject, String key, long defaultValue) {
        return ((Long) getValueByType(jsonObject, key, Long.valueOf(defaultValue), (byte) 2)).longValue();
    }
    ...
    public static long getLong(String json, String key, long defaultValue) {
        return ((Long) getValueByType(json, key, Long.valueOf(defaultValue), (byte) 2)).longValue();
    }
    ...
    public static double getDouble(JSONObject jsonObject, String key, double defaultValue) {
        return ((Double) getValueByType(jsonObject, key, Double.valueOf(defaultValue), (byte) 3)).doubleValue();
    }
    ...
    public static double getDouble(String json, String key, double defaultValue) {
        return ((Double) getValueByType(json, key, Double.valueOf(defaultValue), (byte) 3)).doubleValue();
    }
    ...
    private static <T> T getValueByType(JSONObject jsonObject, String key, T defaultValue, byte type) {
        ...
        if (type != 0) {
            return type == 1 ? (T) Integer.valueOf(jsonObject.getInt(key)) : type == 2 ? (T) Long.valueOf(jsonObject.getLong(key)) : type == 3 ? (T) Double.valueOf(jsonObject.getDouble(key)) : type == 4 ? (T) jsonObject.getString(key) : type == 5 ? (T) jsonObject.getJSONObject(key) : type == 6 ? (T) jsonObject.getJSONArray(key) : defaultValue;
        }
        try {
    ...
    private static <T> T getValueByType(String json, String key, T defaultValue, byte type) {
        ...
        try {
            return (T) getValueByType(new JSONObject(json), key, defaultValue, type);
        } catch (JSONException e) {
            Log.e("JsonUtils", "getValueByType: ", e);
            return defaultValue;
        }
