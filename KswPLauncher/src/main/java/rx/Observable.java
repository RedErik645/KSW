...
public class Observable<T> {
    ...
    public <R> R extend(Func1<? super OnSubscribe<T>, ? extends R> conversion) {
        return (R) conversion.call(new OnSubscribeExtend(this));
    }
    ...
    public static <T> Observable<T> concat(Observable<? extends Observable<? extends T>> observables) {
        return (Observable<R>) observables.concatMap(UtilityFunctions.identity());
    }
    ...
    public static <T> Observable<T> concatDelayError(Observable<? extends Observable<? extends T>> sources) {
        return (Observable<R>) sources.concatMapDelayError(UtilityFunctions.identity());
    }
    ...
    /* JADX DEBUG: Type inference failed for r0v3. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public static <T> Observable<T> merge(Observable<? extends Observable<? extends T>> source) {
        return source.getClass() == ScalarSynchronousObservable.class ? ((ScalarSynchronousObservable) source).scalarFlatMap(UtilityFunctions.identity()) : (Observable<R>) source.lift(OperatorMerge.instance(false));
    }

    /* JADX DEBUG: Type inference failed for r0v3. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public static <T> Observable<T> merge(Observable<? extends Observable<? extends T>> source, int maxConcurrent) {
        return source.getClass() == ScalarSynchronousObservable.class ? ((ScalarSynchronousObservable) source).scalarFlatMap(UtilityFunctions.identity()) : (Observable<R>) source.lift(OperatorMerge.instance(false, maxConcurrent));
    }
    ...
    /* JADX DEBUG: Type inference failed for r0v2. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public static <T> Observable<T> mergeDelayError(Observable<? extends Observable<? extends T>> source) {
        return (Observable<R>) source.lift(OperatorMerge.instance(true));
    }

    /* JADX DEBUG: Type inference failed for r0v2. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public static <T> Observable<T> mergeDelayError(Observable<? extends Observable<? extends T>> source, int maxConcurrent) {
        return (Observable<R>) source.lift(OperatorMerge.instance(true, maxConcurrent));
    }
    ...
    public static <T> Observable<T> switchOnNext(Observable<? extends Observable<? extends T>> sequenceOfSequences) {
        return (Observable<R>) sequenceOfSequences.lift(OperatorSwitch.instance(false));
    }

    /* JADX DEBUG: Type inference failed for r0v2. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public static <T> Observable<T> switchOnNextDelayError(Observable<? extends Observable<? extends T>> sequenceOfSequences) {
        return (Observable<R>) sequenceOfSequences.lift(OperatorSwitch.instance(true));
    }
    ...
    public final <U> Observable<T> debounce(Func1<? super T, ? extends Observable<U>> debounceSelector) {
        return (Observable<R>) lift(new OperatorDebounceWithSelector(debounceSelector));
    }
    ...
    public final Observable<T> debounce(long timeout, TimeUnit unit, Scheduler scheduler) {
        return (Observable<R>) lift(new OperatorDebounceWithTime(timeout, unit, scheduler));
    }
    ...
    public final Observable<T> switchIfEmpty(Observable<? extends T> alternate) {
        return (Observable<R>) lift(new OperatorSwitchIfEmpty(alternate));
    }
    ...
    public final <U, V> Observable<T> delay(Func0<? extends Observable<U>> subscriptionDelay, Func1<? super T, ? extends Observable<V>> itemDelay) {
        return (Observable<R>) delaySubscription(subscriptionDelay).lift(new OperatorDelayWithSelector(this, itemDelay));
    }

    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public final <U> Observable<T> delay(Func1<? super T, ? extends Observable<U>> itemDelay) {
        return (Observable<R>) lift(new OperatorDelayWithSelector(this, itemDelay));
    }
    ...
    public final Observable<T> delay(long delay, TimeUnit unit, Scheduler scheduler) {
        return (Observable<R>) lift(new OperatorDelay(delay, unit, scheduler));
    }
    ...
    public final <U> Observable<T> distinct(Func1<? super T, ? extends U> keySelector) {
        return (Observable<R>) lift(new OperatorDistinct(keySelector));
    }
    ...
    public final <U> Observable<T> distinctUntilChanged(Func1<? super T, ? extends U> keySelector) {
        return (Observable<R>) lift(new OperatorDistinctUntilChanged(keySelector));
    }

    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public final Observable<T> distinctUntilChanged(Func2<? super T, ? super T, Boolean> comparator) {
        return (Observable<R>) lift(new OperatorDistinctUntilChanged(comparator));
    }
    ...
    public final Observable<T> doOnRequest(Action1<Long> onRequest) {
        return (Observable<R>) lift(new OperatorDoOnRequest(onRequest));
    }

    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public final Observable<T> doOnSubscribe(Action0 subscribe) {
        return (Observable<R>) lift(new OperatorDoOnSubscribe(subscribe));
    }
    ...
    public final Observable<T> doOnUnsubscribe(Action0 unsubscribe) {
        return (Observable<R>) lift(new OperatorDoOnUnsubscribe(unsubscribe));
    }
    ...
    public static <T> Observable<T> concatEager(Observable<? extends Observable<? extends T>> sources) {
        return (Observable<R>) sources.concatMapEager(UtilityFunctions.identity());
    }

    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public static <T> Observable<T> concatEager(Observable<? extends Observable<? extends T>> sources, int capacityHint) {
        return (Observable<R>) sources.concatMapEager(UtilityFunctions.identity(), capacityHint);
    }
    ...
    public final Observable<T> elementAt(int index) {
        return (Observable<R>) lift(new OperatorElementAt(index));
    }

    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public final Observable<T> elementAtOrDefault(int index, T defaultValue) {
        return (Observable<R>) lift(new OperatorElementAt(index, defaultValue));
    }
    ...
    public final Observable<T> finallyDo(Action0 action) {
        return (Observable<R>) lift(new OperatorDoAfterTerminate(action));
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: rx.functions.Func1<? super T, ? extends rx.Observable<? extends R>> */
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: rx.functions.Func1<? super java.lang.Throwable, ? extends rx.Observable<? extends R>> */
    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: rx.functions.Func0<? extends rx.Observable<? extends R>> */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    public final Observable<T> observeOn(Scheduler scheduler, boolean delayError, int bufferSize) {
        return this instanceof ScalarSynchronousObservable ? ((ScalarSynchronousObservable) this).scalarScheduleOn(scheduler) : (Observable<R>) lift(new OperatorObserveOn(scheduler, delayError, bufferSize));
    }
    ...
    public final Observable<T> onBackpressureBuffer(long capacity) {
        return (Observable<R>) lift(new OperatorOnBackpressureBuffer(capacity));
    }

    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public final Observable<T> onBackpressureBuffer(long capacity, Action0 onOverflow) {
        return (Observable<R>) lift(new OperatorOnBackpressureBuffer(capacity, onOverflow));
    }
    ...
    public final Observable<T> onBackpressureBuffer(long capacity, Action0 onOverflow, BackpressureOverflow.Strategy overflowStrategy) {
        return (Observable<R>) lift(new OperatorOnBackpressureBuffer(capacity, onOverflow, overflowStrategy));
    }

    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public final Observable<T> onBackpressureDrop(Action1<? super T> onDrop) {
        return (Observable<R>) lift(new OperatorOnBackpressureDrop(onDrop));
    }
    ...
    public final Observable<T> onErrorResumeNext(Func1<Throwable, ? extends Observable<? extends T>> resumeFunction) {
        return (Observable<R>) lift(new OperatorOnErrorResumeNextViaFunction(resumeFunction));
    }

    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public final Observable<T> onErrorResumeNext(Observable<? extends T> resumeSequence) {
        return (Observable<R>) lift(OperatorOnErrorResumeNextViaFunction.withOther(resumeSequence));
    }

    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public final Observable<T> onErrorReturn(Func1<Throwable, ? extends T> resumeFunction) {
        return (Observable<R>) lift(OperatorOnErrorResumeNextViaFunction.withSingle(resumeFunction));
    }

    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public final Observable<T> onExceptionResumeNext(Observable<? extends T> resumeSequence) {
        return (Observable<R>) lift(OperatorOnErrorResumeNextViaFunction.withException(resumeSequence));
    }
    ...
    public final Observable<T> rebatchRequests(int n) {
        if (n > 0) {
            return (Observable<R>) lift(OperatorObserveOn.rebatch(n));
        }
    ...
    public final Observable<T> retry(Func2<Integer, Throwable, Boolean> predicate) {
        return (Observable<R>) nest().lift(new OperatorRetryWithPredicate(predicate));
    }
    ...
    public final Observable<T> sample(long period, TimeUnit unit, Scheduler scheduler) {
        return (Observable<R>) lift(new OperatorSampleWithTime(period, unit, scheduler));
    }

    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public final <U> Observable<T> sample(Observable<U> sampler) {
        return (Observable<R>) lift(new OperatorSampleWithObservable(sampler));
    }

    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public final Observable<T> scan(Func2<T, T, T> accumulator) {
        return (Observable<R>) lift(new OperatorScan(accumulator));
    }
    ...
    public final Observable<T> singleOrDefault(T defaultValue) {
        return (Observable<R>) lift(new OperatorSingle(defaultValue));
    }
    ...
    public final Observable<T> skip(int count) {
        return (Observable<R>) lift(new OperatorSkip(count));
    }
    ...
    public final Observable<T> skipLast(int count) {
        return (Observable<R>) lift(new OperatorSkipLast(count));
    }
    ...
    public final Observable<T> skipLast(long time, TimeUnit unit, Scheduler scheduler) {
        return (Observable<R>) lift(new OperatorSkipLastTimed(time, unit, scheduler));
    }

    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public final <U> Observable<T> skipUntil(Observable<U> other) {
        return (Observable<R>) lift(new OperatorSkipUntil(other));
    }

    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public final Observable<T> skipWhile(Func1<? super T, Boolean> predicate) {
        return (Observable<R>) lift(new OperatorSkipWhile(OperatorSkipWhile.toPredicate2(predicate)));
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v6, resolved type: rx.Observable$OnSubscribe */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    public final Observable<T> take(int count) {
        return (Observable<R>) lift(new OperatorTake(count));
    }
    ...
    public final Observable<T> take(long time, TimeUnit unit, Scheduler scheduler) {
        return (Observable<R>) lift(new OperatorTakeTimed(time, unit, scheduler));
    }
    ...
    public final Observable<T> takeLast(int count) {
        ...
        return count == 1 ? create(new OnSubscribeTakeLastOne(this)) : (Observable<R>) lift(new OperatorTakeLast(count));
    }
    ...
    public final Observable<T> takeLast(int count, long time, TimeUnit unit, Scheduler scheduler) {
        return (Observable<R>) lift(new OperatorTakeLastTimed(count, time, unit, scheduler));
    }
    ...
    public final Observable<T> takeLast(long time, TimeUnit unit, Scheduler scheduler) {
        return (Observable<R>) lift(new OperatorTakeLastTimed(time, unit, scheduler));
    }
    ...
    public final <E> Observable<T> takeUntil(Observable<? extends E> other) {
        return (Observable<R>) lift(new OperatorTakeUntil(other));
    }

    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public final Observable<T> takeWhile(Func1<? super T, Boolean> predicate) {
        return (Observable<R>) lift(new OperatorTakeWhile(predicate));
    }

    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: rx.Observable<R>, rx.Observable<T> */
    public final Observable<T> takeUntil(Func1<? super T, Boolean> stopPredicate) {
        return (Observable<R>) lift(new OperatorTakeUntilPredicate(stopPredicate));
    }
    ...
    public final Observable<T> throttleFirst(long skipDuration, TimeUnit unit, Scheduler scheduler) {
        return (Observable<R>) lift(new OperatorThrottleFirst(skipDuration, unit, scheduler));
    }
    ...
    public final <U, V> Observable<T> timeout(Func0<? extends Observable<U>> firstTimeoutSelector, Func1<? super T, ? extends Observable<V>> timeoutSelector, Observable<? extends T> other) {
        if (timeoutSelector != null) {
            return (Observable<R>) lift(new OperatorTimeoutWithSelector(firstTimeoutSelector, timeoutSelector, other));
        }
    ...
    public final Observable<T> timeout(long timeout, TimeUnit timeUnit, Observable<? extends T> other, Scheduler scheduler) {
        return (Observable<R>) lift(new OperatorTimeout(timeout, timeUnit, other, scheduler));
    }
    ...
    public final Observable<T> sorted(Func2<? super T, ? super T, Integer> sortFunction) {
        return (Observable<R>) toSortedList(sortFunction).flatMapIterable(UtilityFunctions.identity());
    }
