...
public class SpscUnboundedArrayQueue<E> extends SpscUnboundedArrayQueueConsumerField<E> implements QueueProgressIndicators {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r20v0, resolved type: rx.internal.util.unsafe.SpscUnboundedArrayQueue<E> */
    ...
    public final boolean offer(E e) {
        if (e != null) {
            ...
            if (lvElement(objArr, calcWrappedOffset(((long) lookAheadStep) + index, mask)) == null) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r15v0, resolved type: rx.internal.util.unsafe.SpscUnboundedArrayQueue<E> */
    /* JADX WARN: Multi-variable type inference failed */
    @Override // java.util.Queue
    public final E poll() {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r14v0, resolved type: rx.internal.util.unsafe.SpscUnboundedArrayQueue<E> */
    /* JADX WARN: Multi-variable type inference failed */
    @Override // java.util.Queue
    public final E peek() {
        Object[] objArr = this.consumerBuffer;
        ...
        return e == HAS_NEXT ? (E) newBufferPeek(lvNext(objArr), index, mask) : e;
    }
