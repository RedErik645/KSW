...
public final class AdjustedTimeMark extends TimeMark {
    ...
    public final long m1287getAdjustmentUwyO8pc() {
    ...
    public long m1286elapsedNowUwyO8pc() {
        return Duration.m1328minusLRDsOJo(this.mark.m1422elapsedNowUwyO8pc(), m1287getAdjustmentUwyO8pc());
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1288plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1329plusLRDsOJo(m1287getAdjustmentUwyO8pc(), duration), null);
    }
}
