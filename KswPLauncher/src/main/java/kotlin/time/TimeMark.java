...
public abstract class TimeMark {
    ...
    public abstract long m1422elapsedNowUwyO8pc();

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1424plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this, duration, null);
    }

    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public TimeMark m1423minusLRDsOJo(long duration) {
        return m1424plusLRDsOJo(Duration.m1345unaryMinusUwyO8pc(duration));
    }

    public final boolean hasPassedNow() {
        return !Duration.m1326isNegativeimpl(m1422elapsedNowUwyO8pc());
    }
