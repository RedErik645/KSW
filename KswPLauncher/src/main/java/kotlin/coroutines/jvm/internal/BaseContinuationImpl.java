...
public abstract class BaseContinuationImpl implements Continuation<Object>, CoroutineStackFrame, Serializable {
    ...
    /* JADX DEBUG: Type inference failed for r4v0. Raw type applied. Possible types: kotlin.coroutines.Continuation<java.lang.Object>, java.lang.Object, kotlin.coroutines.Continuation */
    ...
    public final void resumeWith(Object result) {
        ...
        while (true) {
            ...
            Continuation completion2 = $this$resumeWith_u24lambda_u2d0.completion;
            ...
            try {
                ...
                if (outcome2 != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    outcome = Result.m9constructorimpl(outcome2);
                ...
                outcome = Result.m9constructorimpl(ResultKt.createFailure(exception));
            }
        }
    }
    ...
    public Continuation<Unit> create(Object value, Continuation<?> continuation) {
        Intrinsics.checkNotNullParameter(continuation, "completion");
