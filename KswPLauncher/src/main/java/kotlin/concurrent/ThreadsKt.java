...
public final class ThreadsKt {
    ...
    public static final Thread thread(boolean start, boolean isDaemon, ClassLoader contextClassLoader, String name, int priority, Function0<Unit> function0) {
        Intrinsics.checkNotNullParameter(function0, "block");
        ThreadsKt$thread$thread$1 thread = new ThreadsKt$thread$thread$1(function0);
        if (isDaemon) {
