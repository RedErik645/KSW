...
public final class DelimitedRangesSequence implements Sequence<IntRange> {
    ...
    public DelimitedRangesSequence(CharSequence input2, int startIndex2, int limit2, Function2<? super CharSequence, ? super Integer, Pair<Integer, Integer>> function2) {
