...
public final class UStringsKt {
    ...
    public static final String m1279toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1281toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1280toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1278toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final byte toUByte(String $this$toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m76unboximpl();
        }
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m154unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m154unboximpl();
        if (UnsignedKt.uintCompare(r0, UInt.m103constructorimpl(255)) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m154unboximpl();
        if (UnsignedKt.uintCompare(r0, UInt.m103constructorimpl(65535)) > 0) {
            return null;
        }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m103constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m356uintDivideJ1ME1BU(-1, uradix);
                if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            int result2 = UInt.m103constructorimpl(result * uradix);
            result = UInt.m103constructorimpl(UInt.m103constructorimpl(digit) + result2);
            if (UnsignedKt.uintCompare(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m97boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m181constructorimpl((long) i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            ...
            if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m358ulongDivideeb3DHEI(-1, uradix);
                if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            long result2 = ULong.m181constructorimpl(result * uradix);
            result = ULong.m181constructorimpl(ULong.m181constructorimpl(((long) UInt.m103constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m175boximpl(result);
    }
}
