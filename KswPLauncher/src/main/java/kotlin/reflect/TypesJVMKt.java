...
public final class TypesJVMKt {
    ...
    private static final Type createPossiblyInnerType(Class<?> cls, List<KTypeProjection> list) {
        ...
        if (ownerClass == null) {
            ...
            for (KTypeProjection item$iv$iv : $this$map$iv) {
                destination$iv$iv.add(getJavaType(item$iv$iv));
            }
            ...
            for (KTypeProjection item$iv$iv2 : $this$map$iv2) {
                destination$iv$iv2.add(getJavaType(item$iv$iv2));
            }
            ...
            for (KTypeProjection item$iv$iv3 : $this$map$iv3) {
                destination$iv$iv3.add(getJavaType(item$iv$iv3));
            }
