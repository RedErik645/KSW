...
public final class UnsignedKt {
    ...
    public static final int m356uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m103constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }

    /* renamed from: uintRemainder-J1ME1BU  reason: not valid java name */
    public static final int m357uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m103constructorimpl((int) ((((long) v1) & 4294967295L) % (4294967295L & ((long) v2))));
    }

    /* renamed from: ulongDivide-eb3DHEI  reason: not valid java name */
    public static final long m358ulongDivideeb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
            if (ulongCompare(v1, v2) >= 0) {
                j = 1;
            }
            return ULong.m181constructorimpl(j);
        } else if (v1 >= 0) {
            return ULong.m181constructorimpl(v1 / v2);
        } else {
            int i = 1;
            long quotient = ((v1 >>> 1) / v2) << 1;
            if (ulongCompare(ULong.m181constructorimpl(v1 - (quotient * v2)), ULong.m181constructorimpl(v2)) < 0) {
                i = 0;
            }
            return ULong.m181constructorimpl(((long) i) + quotient);
        }
    }

    /* renamed from: ulongRemainder-eb3DHEI  reason: not valid java name */
    public static final long m359ulongRemaindereb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
            if (ulongCompare(v1, v2) < 0) {
                return v1;
            ...
            if (ulongCompare(ULong.m181constructorimpl(rem), ULong.m181constructorimpl(v2)) >= 0) {
                j = v2;
            }
            return ULong.m181constructorimpl(rem - j);
        }
    }
    ...
    public static final int doubleToUInt(double v) {
        ...
        if (v <= 2.147483647E9d) {
            return UInt.m103constructorimpl((int) v);
        }
        return UInt.m103constructorimpl(UInt.m103constructorimpl((int) (v - ((double) Integer.MAX_VALUE))) + UInt.m103constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double v) {
        ...
        if (v < 9.223372036854776E18d) {
            return ULong.m181constructorimpl((long) v);
        }
        return ULong.m181constructorimpl(ULong.m181constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
