...
final class DeepRecursiveScopeImpl<T, R> extends DeepRecursiveScope<T, R> implements Continuation<R> {
    ...
    public <U, S> Object callRecursive(DeepRecursiveFunction<U, S> deepRecursiveFunction, U u, Continuation<? super S> continuation) {
        Function3 function2 = deepRecursiveFunction.getBlock$kotlin_stdlib();
    ...
    public final R runCallLoop() {
        while (true) {
            ...
            if (cont2 == null) {
                ...
                return r;
            } else if (Result.m11equalsimpl0(DeepRecursiveKt.access$getUNDEFINED_RESULT$p(), r)) {
                try {
                    Function3<? super DeepRecursiveScope<?, ?>, Object, ? super Continuation<Object>, ? extends Object> function3 = this.function;
                    Object r2 = ((Function3) TypeIntrinsics.beforeCheckcastToFunctionOfArity(function3, 3)).invoke(this, this.value, cont2);
                    if (r2 != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                        Result.Companion companion = Result.Companion;
                        cont2.resumeWith(Result.m9constructorimpl(r2));
                    }
                } catch (Throwable e) {
                    Result.Companion companion2 = Result.Companion;
                    cont2.resumeWith(Result.m9constructorimpl(ResultKt.createFailure(e)));
                }
            } else {
