...
public class AdaptedFunctionReference implements FunctionBase, Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (this.isTopLevel != other.isTopLevel || this.arity != other.arity || this.flags != other.flags || !Intrinsics.areEqual(this.receiver, other.receiver) || !Intrinsics.areEqual(this.owner, other.owner) || !this.name.equals(other.name) || !this.signature.equals(other.signature)) {
            return false;
        }
        return true;
    }
