...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
        ...
        public final String getClassSimpleName(Class<?> cls) {
            ...
            if (cls.isLocalClass()) {
                ...
                if (method != null) {
                    ...
                    String substringAfter$default = StringsKt.substringAfter$default(name, method.getName() + '$', (String) null, 2, (Object) null);
                ...
                if (constructor != null) {
                    Intrinsics.checkNotNullExpressionValue(name, "name");
                    return StringsKt.substringAfter$default(name, constructor.getName() + '$', (String) null, 2, (Object) null);
                }
                Intrinsics.checkNotNullExpressionValue(name, "name");
    ...
    static {
        ...
        Iterable $this$associateTo$iv = $this$primitiveFqNames_u24lambda_u2d1.values();
        ...
        for (Map.Entry<Class<? extends Function<?>>, Integer> entry : FUNCTION_CLASSES.entrySet()) {
            $this$classFqNames_u24lambda_u2d4.put(entry.getKey().getName(), "kotlin.Function" + entry.getValue().intValue());
        }
        ...
        for (Map.Entry element$iv$iv$iv : $this$mapValues$iv.entrySet()) {
            destination$iv$iv2.put(element$iv$iv$iv.getKey(), StringsKt.substringAfterLast$default((String) element$iv$iv$iv.getValue(), '.', (String) null, 2, (Object) null));
        }
