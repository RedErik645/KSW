...
public final class TypeReference implements KType {
    ...
    public TypeReference(KClassifier classifier2, List<KTypeProjection> list, KType platformTypeUpperBound2, int flags2) {
    ...
    public TypeReference(KClassifier classifier2, List<KTypeProjection> list, boolean isMarkedNullable) {
        this(classifier2, list, null, isMarkedNullable ? 1 : 0);
        Intrinsics.checkNotNullParameter(classifier2, "classifier");
        Intrinsics.checkNotNullParameter(list, "arguments");
    }
