...
public final class UIntArrayKt {
    private static final int[] UIntArray(int size, Function1<? super Integer, UInt> function1) {
        ...
        for (int i = 0; i < size; i++) {
            iArr[i] = function1.invoke(Integer.valueOf(i)).m154unboximpl();
        }
        return UIntArray.m157constructorimpl(iArr);
    }

    /* renamed from: uintArrayOf--ajY-9A  reason: not valid java name */
    private static final int[] m173uintArrayOfajY9A(int... elements) {
