...
final class SequencesKt___SequencesKt$runningFold$1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: kotlin.jvm.functions.Function2<? super R, ? super T, ? extends R> */
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                if ($this$sequence2.yield(sequencesKt___SequencesKt$runningFold$1.$initial, sequencesKt___SequencesKt$runningFold$1) == coroutine_suspended) {
        ...
        while (it.hasNext()) {
            accumulator = sequencesKt___SequencesKt$runningFold$1.$operation.invoke(accumulator, it.next());
