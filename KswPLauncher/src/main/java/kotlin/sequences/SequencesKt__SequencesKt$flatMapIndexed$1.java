...
@DebugMetadata(c = "kotlin.sequences.SequencesKt__SequencesKt$flatMapIndexed$1", f = "Sequences.kt", i = {0, 0}, l = {332}, m = "invokeSuspend", n = {"$this$sequence", BenzConfig.INDEX}, s = {"L$0", "I$0"})
...
final class SequencesKt__SequencesKt$flatMapIndexed$1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: kotlin.jvm.functions.Function2<? super java.lang.Integer, ? super T, ? extends C> */
    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: kotlin.jvm.functions.Function1<? super C, ? extends java.util.Iterator<? extends R>> */
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        while (it.hasNext()) {
            ...
            C invoke = function2.invoke(Boxing.boxInt(index), element);
            ...
            if ($this$sequence.yieldAll(sequencesKt__SequencesKt$flatMapIndexed$1.$iterator.invoke(invoke), sequencesKt__SequencesKt$flatMapIndexed$1) == coroutine_suspended) {
