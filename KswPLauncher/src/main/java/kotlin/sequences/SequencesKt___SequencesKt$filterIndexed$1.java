...
final class SequencesKt___SequencesKt$filterIndexed$1 extends Lambda implements Function1<IndexedValue<? extends T>, Boolean> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: kotlin.jvm.functions.Function2<? super java.lang.Integer, ? super T, java.lang.Boolean> */
    ...
    public final Boolean invoke(IndexedValue<? extends T> indexedValue) {
        ...
        return this.$predicate.invoke(Integer.valueOf(indexedValue.getIndex()), (T) indexedValue.getValue());
    }
}
