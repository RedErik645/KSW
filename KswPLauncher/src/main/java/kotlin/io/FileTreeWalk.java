...
public final class FileTreeWalk implements Sequence<File> {
    ...
    private FileTreeWalk(File start2, FileWalkDirection direction2, Function1<? super File, Boolean> function1, Function1<? super File, Unit> function12, Function2<? super File, ? super IOException, Unit> function2, int maxDepth2) {
        this.start = start2;
