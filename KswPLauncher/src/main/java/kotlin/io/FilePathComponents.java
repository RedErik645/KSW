...
public final class FilePathComponents {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public FilePathComponents(File root2, List<? extends File> list) {
