...
public class UArraysKt___UArraysJvmKt {
    ...
    private static final byte m484elementAtPpDY95g(byte[] $this$elementAt_u2dPpDY95g, int index) {
        Intrinsics.checkNotNullParameter($this$elementAt_u2dPpDY95g, "$this$elementAt");
        return UByteArray.m84getw2LRezQ($this$elementAt_u2dPpDY95g, index);
    }

    /* renamed from: elementAt-nggk6HY  reason: not valid java name */
    private static final short m485elementAtnggk6HY(short[] $this$elementAt_u2dnggk6HY, int index) {
        Intrinsics.checkNotNullParameter($this$elementAt_u2dnggk6HY, "$this$elementAt");
        return UShortArray.m344getMh2AYeg($this$elementAt_u2dnggk6HY, index);
    }

    /* renamed from: asList--ajY-9A  reason: not valid java name */
    public static final List<UInt> m472asListajY9A(int[] $this$asList_u2d_u2dajY_u2d9A) {
    ...
    public static final List<ULong> m474asListQwZRm1k(long[] $this$asList_u2dQwZRm1k) {
    ...
    public static final List<UByte> m473asListGBYM_sE(byte[] $this$asList_u2dGBYM_sE) {
    ...
    public static final List<UShort> m475asListrL5Bavg(short[] $this$asList_u2drL5Bavg) {
    ...
    public static /* synthetic */ int m477binarySearch2fe2U9s$default(int[] iArr, int i, int i2, int i3, int i4, Object obj) {
        ...
        if ((i4 & 4) != 0) {
            i3 = UIntArray.m163getSizeimpl(iArr);
        }
        return UArraysKt.m476binarySearch2fe2U9s(iArr, i, i2, i3);
    }

    /* renamed from: binarySearch-2fe2U9s  reason: not valid java name */
    public static final int m476binarySearch2fe2U9s(int[] $this$binarySearch_u2d2fe2U9s, int element, int fromIndex, int toIndex) {
        Intrinsics.checkNotNullParameter($this$binarySearch_u2d2fe2U9s, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(fromIndex, toIndex, UIntArray.m163getSizeimpl($this$binarySearch_u2d2fe2U9s));
        int low = fromIndex;
        int high = toIndex - 1;
        while (low <= high) {
            int mid = (low + high) >>> 1;
            int cmp = UnsignedKt.uintCompare($this$binarySearch_u2d2fe2U9s[mid], element);
            if (cmp < 0) {
                low = mid + 1;
            } else if (cmp <= 0) {
                return mid;
    ...
    public static final int m480binarySearchK6DWlUc(long[] $this$binarySearch_u2dK6DWlUc, long element, int fromIndex, int toIndex) {
        ...
        while (low <= high) {
            int mid = (low + high) >>> 1;
            int cmp = UnsignedKt.ulongCompare($this$binarySearch_u2dK6DWlUc[mid], element);
            if (cmp < 0) {
                low = mid + 1;
            } else if (cmp <= 0) {
                return mid;
    ...
    public static /* synthetic */ int m483binarySearchWpHrYlw$default(byte[] bArr, byte b, int i, int i2, int i3, Object obj) {
        ...
        if ((i3 & 4) != 0) {
            i2 = UByteArray.m85getSizeimpl(bArr);
        }
        return UArraysKt.m482binarySearchWpHrYlw(bArr, b, i, i2);
    }

    /* renamed from: binarySearch-WpHrYlw  reason: not valid java name */
    public static final int m482binarySearchWpHrYlw(byte[] $this$binarySearch_u2dWpHrYlw, byte element, int fromIndex, int toIndex) {
        Intrinsics.checkNotNullParameter($this$binarySearch_u2dWpHrYlw, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(fromIndex, toIndex, UByteArray.m85getSizeimpl($this$binarySearch_u2dWpHrYlw));
    ...
    public static /* synthetic */ int m479binarySearchEtDCXyQ$default(short[] sArr, short s, int i, int i2, int i3, Object obj) {
        ...
        if ((i3 & 4) != 0) {
            i2 = UShortArray.m345getSizeimpl(sArr);
        }
        return UArraysKt.m478binarySearchEtDCXyQ(sArr, s, i, i2);
    }

    /* renamed from: binarySearch-EtDCXyQ  reason: not valid java name */
    public static final int m478binarySearchEtDCXyQ(short[] $this$binarySearch_u2dEtDCXyQ, short element, int fromIndex, int toIndex) {
        Intrinsics.checkNotNullParameter($this$binarySearch_u2dEtDCXyQ, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(fromIndex, toIndex, UShortArray.m345getSizeimpl($this$binarySearch_u2dEtDCXyQ));
    ...
    private static final BigDecimal sumOfBigDecimal(int[] $this$sumOf_u2djgv0xPQ, Function1<? super UInt, ? extends BigDecimal> function1) {
        ...
        int r1 = UIntArray.m163getSizeimpl($this$sumOf_u2djgv0xPQ);
        for (int i = 0; i < r1; i++) {
            BigDecimal add = sum.add((BigDecimal) function1.invoke(UInt.m97boximpl(UIntArray.m162getpVg5ArA($this$sumOf_u2djgv0xPQ, i))));
    ...
    private static final BigDecimal sumOfBigDecimal(long[] $this$sumOf_u2dMShoTSo, Function1<? super ULong, ? extends BigDecimal> function1) {
        ...
        for (int i = 0; i < r1; i++) {
            BigDecimal add = sum.add((BigDecimal) function1.invoke(ULong.m175boximpl(ULongArray.m240getsVKNKU($this$sumOf_u2dMShoTSo, i))));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
    ...
    private static final BigDecimal sumOfBigDecimal(byte[] $this$sumOf_u2dJOV_ifY, Function1<? super UByte, ? extends BigDecimal> function1) {
        ...
        BigDecimal sum = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(sum, "valueOf(this.toLong())");
        int r1 = UByteArray.m85getSizeimpl($this$sumOf_u2dJOV_ifY);
        for (int i = 0; i < r1; i++) {
            BigDecimal add = sum.add((BigDecimal) function1.invoke(UByte.m21boximpl(UByteArray.m84getw2LRezQ($this$sumOf_u2dJOV_ifY, i))));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
    ...
    private static final BigDecimal sumOfBigDecimal(short[] $this$sumOf_u2dxTcfx_M, Function1<? super UShort, ? extends BigDecimal> function1) {
        ...
        BigDecimal sum = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(sum, "valueOf(this.toLong())");
        int r1 = UShortArray.m345getSizeimpl($this$sumOf_u2dxTcfx_M);
        for (int i = 0; i < r1; i++) {
            BigDecimal add = sum.add((BigDecimal) function1.invoke(UShort.m281boximpl(UShortArray.m344getMh2AYeg($this$sumOf_u2dxTcfx_M, i))));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
    ...
    private static final BigInteger sumOfBigInteger(int[] $this$sumOf_u2djgv0xPQ, Function1<? super UInt, ? extends BigInteger> function1) {
        ...
        int r1 = UIntArray.m163getSizeimpl($this$sumOf_u2djgv0xPQ);
        for (int i = 0; i < r1; i++) {
            BigInteger add = sum.add((BigInteger) function1.invoke(UInt.m97boximpl(UIntArray.m162getpVg5ArA($this$sumOf_u2djgv0xPQ, i))));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
    ...
    private static final BigInteger sumOfBigInteger(long[] $this$sumOf_u2dMShoTSo, Function1<? super ULong, ? extends BigInteger> function1) {
        ...
        int r1 = ULongArray.m241getSizeimpl($this$sumOf_u2dMShoTSo);
        for (int i = 0; i < r1; i++) {
            BigInteger add = sum.add((BigInteger) function1.invoke(ULong.m175boximpl(ULongArray.m240getsVKNKU($this$sumOf_u2dMShoTSo, i))));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
    ...
    private static final BigInteger sumOfBigInteger(byte[] $this$sumOf_u2dJOV_ifY, Function1<? super UByte, ? extends BigInteger> function1) {
        ...
        int r1 = UByteArray.m85getSizeimpl($this$sumOf_u2dJOV_ifY);
        for (int i = 0; i < r1; i++) {
            BigInteger add = sum.add((BigInteger) function1.invoke(UByte.m21boximpl(UByteArray.m84getw2LRezQ($this$sumOf_u2dJOV_ifY, i))));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
    ...
    private static final BigInteger sumOfBigInteger(short[] $this$sumOf_u2dxTcfx_M, Function1<? super UShort, ? extends BigInteger> function1) {
        ...
        int r1 = UShortArray.m345getSizeimpl($this$sumOf_u2dxTcfx_M);
        for (int i = 0; i < r1; i++) {
            BigInteger add = sum.add((BigInteger) function1.invoke(UShort.m281boximpl(UShortArray.m344getMh2AYeg($this$sumOf_u2dxTcfx_M, i))));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
