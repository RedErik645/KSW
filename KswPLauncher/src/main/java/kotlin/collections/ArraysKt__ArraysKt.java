...
class ArraysKt__ArraysKt extends ArraysKt__ArraysJVMKt {
                                                    ...
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m553contentEqualslec5QzE(t.m249unboximpl(), t2.m249unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m549contentEqualsKJPZfPQ(t.m171unboximpl(), t2.m171unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m548contentEqualsFGO6Aew(t.m353unboximpl(), t2.m353unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m551contentEqualskV0jMPg(t.m93unboximpl(), t2.m93unboximpl())) {
                                                        return false;
                                                    }
    ...
    public static final <T> String contentDeepToString(T[] tArr) {
        ...
        StringBuilder $this$contentDeepToStringImpl_u24lambda_u2d2 = new StringBuilder((RangesKt.coerceAtMost(tArr.length, 429496729) * 5) + 2);
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                if (t instanceof UByteArray) {
                    T t2 = t;
                    if (t2 != null) {
                        bArr = t2.m93unboximpl();
                    }
                    result.append(UArraysKt.m565contentToString2csIQuQ(bArr));
                } else if (t instanceof UShortArray) {
                    T t3 = t;
                    if (t3 != null) {
                        sArr = t3.m353unboximpl();
                    }
                    result.append(UArraysKt.m569contentToStringd6D3K8(sArr));
                } else if (t instanceof UIntArray) {
                    T t4 = t;
                    if (t4 != null) {
                        iArr = t4.m171unboximpl();
                    }
                    result.append(UArraysKt.m568contentToStringXUkPCBk(iArr));
                } else if (t instanceof ULongArray) {
                    T t5 = t;
                    if (t5 != null) {
                        jArr = t5.m249unboximpl();
                    }
                    result.append(UArraysKt.m571contentToStringuLth9ew(jArr));
                } else {
