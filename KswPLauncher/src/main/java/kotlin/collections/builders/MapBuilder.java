...
public final class MapBuilder<K, V> implements Map<K, V>, Serializable, KMutableMap {
    ...
    private MapBuilder(K[] kArr, V[] vArr, int[] presenceArray2, int[] hashArray2, int maxProbeDistance2, int length2) {
        this.keysArray = kArr;
    ...
    private final int findKey(K k) {
        ...
        while (true) {
            ...
            if (index > 0 && Intrinsics.areEqual((Object) this.keysArray[index - 1], (Object) k)) {
                return index - 1;
            }
            probesLeft--;
            if (probesLeft < 0) {
    ...
    public final int addKey$kotlin_stdlib(K k) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                } else if (Intrinsics.areEqual((Object) this.keysArray[index - 1], (Object) k)) {
                    return -index;
                } else {
                    probeDistance++;
    ...
    private final boolean putEntry(Map.Entry<? extends K, ? extends V> entry) {
        ...
        if (Intrinsics.areEqual(entry.getValue(), valuesArray2[(-index) - 1])) {
            return false;
        }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: kotlin.collections.builders.MapBuilder<K, V> */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    @Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010'\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0007\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0000\b\u0000\u0018\u0000*\u0004\b\u0002\u0010\u0001*\u0004\b\u0003\u0010\u00022\u000e\u0012\u0004\u0012\u0002H\u0001\u0012\u0004\u0012\u0002H\u00020\u0003B!\u0012\u0012\u0010\u0004\u001a\u000e\u0012\u0004\u0012\u00028\u0002\u0012\u0004\u0012\u00028\u00030\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bJ\u0013\u0010\u000e\u001a\u00020\u000f2\b\u0010\u0010\u001a\u0004\u0018\u00010\u0011H\u0002J\b\u0010\u0012\u001a\u00020\u0007H\u0016J\u0015\u0010\u0013\u001a\u00028\u00032\u0006\u0010\u0014\u001a\u00028\u0003H\u0016¢\u0006\u0002\u0010\u0015J\b\u0010\u0016\u001a\u00020\u0017H\u0016R\u000e\u0010\u0006\u001a\u00020\u0007X\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\t\u001a\u00028\u00028VX\u0004¢\u0006\u0006\u001a\u0004\b\n\u0010\u000bR\u001a\u0010\u0004\u001a\u000e\u0012\u0004\u0012\u00028\u0002\u0012\u0004\u0012\u00028\u00030\u0005X\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\f\u001a\u00028\u00038VX\u0004¢\u0006\u0006\u001a\u0004\b\r\u0010\u000b¨\u0006\u0018"}, d2 = {"Lkotlin/collections/builders/MapBuilder$EntryRef;", "K", "V", "", "map", "Lkotlin/collections/builders/MapBuilder;", BenzConfig.INDEX, "", "(Lkotlin/collections/builders/MapBuilder;I)V", "key", "getKey", "()Ljava/lang/Object;", "value", "getValue", "equals", "", PluralRules.KEYWORD_OTHER, "", "hashCode", "setValue", "newValue", "(Ljava/lang/Object;)Ljava/lang/Object;", "toString", "", "kotlin-stdlib"}, k = 1, mv = {1, 6, 0}, xi = 48)
    /* compiled from: MapBuilder.kt */
    public static final class EntryRef<K, V> implements Map.Entry<K, V>, KMutableMap.Entry {
        private final int index;
        private final MapBuilder<K, V> map;

        public EntryRef(MapBuilder<K, V> mapBuilder, int index2) {
            Intrinsics.checkNotNullParameter(mapBuilder, "map");
            this.map = mapBuilder;
            this.index = index2;
        }
        ...
        public String toString() {
            return new StringBuilder().append((Object) getKey()).append('=').append((Object) getValue()).toString();
        }
    }
}
