...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] result = UByteArray.m78constructorimpl(collection.size());
        int index = 0;
        for (UByte uByte : collection) {
            UByteArray.m89setVurrAj0(result, index, uByte.m76unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        int[] result = UIntArray.m156constructorimpl(collection.size());
        int index = 0;
        for (UInt uInt : collection) {
            UIntArray.m167setVXSXFK8(result, index, uInt.m154unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        long[] result = ULongArray.m234constructorimpl(collection.size());
        int index = 0;
        for (ULong uLong : collection) {
            ULongArray.m245setk8EXiF4(result, index, uLong.m232unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] result = UShortArray.m338constructorimpl(collection.size());
        int index = 0;
        for (UShort uShort : collection) {
            UShortArray.m349set01HTLdE(result, index, uShort.m336unboximpl());
            index++;
        }
        return result;
    }
