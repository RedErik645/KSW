...
public class LruCache<K, V> {
    ...
    public final synchronized String toString() {
        ...
        return String.format(Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", Integer.valueOf(this.maxSize), Integer.valueOf(this.hitCount), Integer.valueOf(this.missCount), Integer.valueOf(accesses != 0 ? (i * 100) / accesses : 0));
    }
}
