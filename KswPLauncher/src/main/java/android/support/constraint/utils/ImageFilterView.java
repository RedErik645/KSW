...
public class ImageFilterView extends AppCompatImageView {
    ...
    public static class ImageMatrix {
        ...
        /* JADX INFO: Multiple debug info for r1v2 float: [D('colorR' float), D('tmpColor_b' float)] */
        private void warmth(float warmth) {
            ...
            fArr[10] = 0.0f;
            fArr[11] = 0.0f;
            fArr[12] = tmpColor_b / Math.min(255.0f, Math.max(colorB2, 0.0f));
            fArr[13] = 0.0f;
            fArr[14] = 0.0f;
            fArr[15] = 0.0f;
            fArr[16] = 0.0f;
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                if (this.mViewOutlineProvider == null) {
                    AnonymousClass1 r2 = new ViewOutlineProvider() {
                        /* class android.support.constraint.utils.ImageFilterView.AnonymousClass1 */
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                if (this.mViewOutlineProvider == null) {
                    AnonymousClass2 r2 = new ViewOutlineProvider() {
                        /* class android.support.constraint.utils.ImageFilterView.AnonymousClass2 */
