...
public class VerticalWidgetRun extends WidgetRun {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$android$support$constraint$solver$widgets$analyzer$WidgetRun$RunType;

        static {
            int[] iArr = new int[WidgetRun.RunType.values().length];
            $SwitchMap$android$support$constraint$solver$widgets$analyzer$WidgetRun$RunType = iArr;
            try {
    ...
    public void update(Dependency dependency) {
        switch (AnonymousClass1.$SwitchMap$android$support$constraint$solver$widgets$analyzer$WidgetRun$RunType[this.mRunType.ordinal()]) {
            case 1:
