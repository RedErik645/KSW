...
public class ConstraintWidget {
    ...
    /* JADX INFO: Multiple debug info for r2v7 int: [D('inHorizontalChain' boolean), D('width' int)] */
    /* JADX INFO: Multiple debug info for r0v5 int: [D('matchConstraintDefaultHeight' int), D('bottom' android.support.constraint.solver.SolverVariable)] */
