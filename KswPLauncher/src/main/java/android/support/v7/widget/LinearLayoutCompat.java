...
public class LinearLayoutCompat extends ViewGroup {
    ...
    /* JADX INFO: Multiple debug info for r3v3 int: [D('largestChildHeight' int), D('weightedMaxWidth' int)] */
    /* JADX INFO: Multiple debug info for r13v20 'lp'  android.support.v7.widget.LinearLayoutCompat$LayoutParams: [D('lp' android.support.v7.widget.LinearLayoutCompat$LayoutParams), D('heightMode' int)] */
    /* access modifiers changed from: package-private */
