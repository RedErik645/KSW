...
public abstract class Single<T> implements SingleSource<T> {
    ...
    /* JADX DEBUG: Type inference failed for r0v2. Raw type applied. Possible types: io.reactivex.Single<R>, io.reactivex.Single<U> */
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final <U> Single<U> cast(Class<? extends U> clazz) {
        ObjectHelper.requireNonNull(clazz, "clazz is null");
        return (Single<R>) map(Functions.castFunction(clazz));
    }
