...
public final class ObservableConcatMapMaybe<T, R> extends Observable<R> {
    ...
    public ObservableConcatMapMaybe(Observable<T> source2, Function<? super T, ? extends MaybeSource<? extends R>> mapper2, ErrorMode errorMode2, int prefetch2) {
        this.source = source2;
        this.mapper = mapper2;
    ...
    static final class ConcatMapMaybeMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        ConcatMapMaybeMainObserver(Observer<? super R> downstream2, Function<? super T, ? extends MaybeSource<? extends R>> mapper2, int prefetch, ErrorMode errorMode2) {
        ...
        public static final class ConcatMapMaybeObserver<R> extends AtomicReference<Disposable> implements MaybeObserver<R> {
            ...
            ConcatMapMaybeObserver(ConcatMapMaybeMainObserver<?, R> parent2) {
                this.parent = parent2;
            }
