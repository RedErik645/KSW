...
public final class ObservableSwitchMapSingle<T, R> extends Observable<R> {
    ...
    static final class SwitchMapSingleMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r2v1, resolved type: java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.operators.mixed.ObservableSwitchMapSingle$SwitchMapSingleMainObserver$SwitchMapSingleObserver<R>> */
        ...
        /* JADX INFO: Multiple debug info for r4v2 boolean: [D('d' boolean), D('ex' java.lang.Throwable)] */
        /* access modifiers changed from: package-private */
        public void drain() {
