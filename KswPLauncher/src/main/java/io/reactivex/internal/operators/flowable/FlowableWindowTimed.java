...
public final class FlowableWindowTimed<T> extends AbstractFlowableWithUpstream<T, Flowable<T>> {
    ...
    static final class WindowExactUnboundedSubscriber<T> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements FlowableSubscriber<T>, Subscription, Runnable {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r2v5, resolved type: io.reactivex.processors.UnicastProcessor */
        /* JADX WARN: Multi-variable type inference failed */
    ...
    static final class WindowExactBoundedSubscriber<T> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements Subscription {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r2v2, resolved type: org.reactivestreams.Subscriber */
        /* JADX WARN: Multi-variable type inference failed */
        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription s) {
            Disposable task;
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r1v2, resolved type: io.reactivex.internal.fuseable.SimplePlainQueue */
        /* JADX DEBUG: Multi-variable search result rejected for r7v8, resolved type: org.reactivestreams.Subscriber */
        /* JADX WARN: Multi-variable type inference failed */
        @Override // org.reactivestreams.Subscriber
        public void onNext(T t) {
            if (!this.terminated) {
        ...
        /* JADX DEBUG: Failed to insert an additional move for type inference into block B:52:0x0009 */
        /* JADX DEBUG: Failed to insert an additional move for type inference into block B:63:0x0009 */
        /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: org.reactivestreams.Subscriber */
        /* JADX DEBUG: Multi-variable search result rejected for r2v1, resolved type: org.reactivestreams.Subscriber */
        /* JADX DEBUG: Multi-variable search result rejected for r2v2, resolved type: org.reactivestreams.Subscriber */
        /* JADX DEBUG: Multi-variable search result rejected for r2v3, resolved type: org.reactivestreams.Subscriber */
        /* JADX DEBUG: Multi-variable search result rejected for r11v7, resolved type: org.reactivestreams.Subscriber */
        /* JADX WARN: Multi-variable type inference failed */
        /* access modifiers changed from: package-private */
        public void drainLoop() {
    ...
    static final class WindowSkipSubscriber<T> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements Subscription, Runnable {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r0v9, resolved type: org.reactivestreams.Subscriber */
        /* JADX WARN: Multi-variable type inference failed */
        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription s) {
            if (SubscriptionHelper.validate(this.upstream, s)) {
