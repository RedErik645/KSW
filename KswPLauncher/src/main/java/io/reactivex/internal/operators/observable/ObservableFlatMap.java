...
public final class ObservableFlatMap<T, U> extends AbstractObservableWithUpstream<T, U> {
    ...
    static final class MergeObserver<T, U> extends AtomicInteger implements Disposable, Observer<T> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r2v1, resolved type: java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.operators.observable.ObservableFlatMap$InnerObserver<?, ?>[]> */
        ...
        public boolean disposeAll() {
            ...
            if (a2 == innerObserverArr || (a = this.observers.getAndSet(innerObserverArr)) == innerObserverArr) {
                return false;
            }
