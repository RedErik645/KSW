...
public final class ObservableSwitchMap<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    static final class SwitchMapObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.operators.observable.ObservableSwitchMap$SwitchMapInnerObserver<T, R>> */
        ...
        /* JADX INFO: Multiple debug info for r10v2 boolean: [D('d' boolean), D('ex' java.lang.Throwable)] */
        /* access modifiers changed from: package-private */
        public void drain() {
            SimpleQueue<R> q;
            boolean retry;
