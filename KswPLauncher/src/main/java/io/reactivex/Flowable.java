...
public abstract class Flowable<T> implements Publisher<T> {
    ...
    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: io.reactivex.Flowable<U extends java.util.Collection<? super T>>, io.reactivex.Flowable<java.util.List<T>> */
    @SchedulerSupport(SchedulerSupport.NONE)
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<List<T>> buffer(int count, int skip) {
        return (Flowable<U>) buffer(count, skip, ArrayListSupplier.asCallable());
    }
    ...
    public final Flowable<List<T>> buffer(long timespan, long timeskip, TimeUnit unit) {
        return (Flowable<U>) buffer(timespan, timeskip, unit, Schedulers.computation(), ArrayListSupplier.asCallable());
    }
    ...
    public final Flowable<List<T>> buffer(long timespan, long timeskip, TimeUnit unit, Scheduler scheduler) {
        return (Flowable<U>) buffer(timespan, timeskip, unit, scheduler, ArrayListSupplier.asCallable());
    }
    ...
    public final Flowable<List<T>> buffer(long timespan, TimeUnit unit, Scheduler scheduler, int count) {
        return (Flowable<U>) buffer(timespan, unit, scheduler, count, ArrayListSupplier.asCallable(), false);
    }
    ...
    public final Flowable<List<T>> buffer(long timespan, TimeUnit unit, Scheduler scheduler) {
        return (Flowable<U>) buffer(timespan, unit, scheduler, Integer.MAX_VALUE, ArrayListSupplier.asCallable(), false);
    }
    ...
    public final <TOpening, TClosing> Flowable<List<T>> buffer(Flowable<? extends TOpening> openingIndicator, Function<? super TOpening, ? extends Publisher<? extends TClosing>> closingIndicator) {
        return (Flowable<U>) buffer(openingIndicator, closingIndicator, ArrayListSupplier.asCallable());
    }
    ...
    public final <B> Flowable<List<T>> buffer(Publisher<B> boundaryIndicator) {
        return (Flowable<U>) buffer(boundaryIndicator, ArrayListSupplier.asCallable());
    }

    /* JADX DEBUG: Type inference failed for r0v2. Raw type applied. Possible types: io.reactivex.Flowable<U extends java.util.Collection<? super T>>, io.reactivex.Flowable<java.util.List<T>> */
    @SchedulerSupport(SchedulerSupport.NONE)
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final <B> Flowable<List<T>> buffer(Publisher<B> boundaryIndicator, int initialCapacity) {
        ...
        return (Flowable<U>) buffer(boundaryIndicator, Functions.createArrayList(initialCapacity));
    }
    ...
    public final <B> Flowable<List<T>> buffer(Callable<? extends Publisher<B>> boundaryIndicatorSupplier) {
        return (Flowable<U>) buffer(boundaryIndicatorSupplier, ArrayListSupplier.asCallable());
    }
    ...
    /* JADX DEBUG: Type inference failed for r0v2. Raw type applied. Possible types: io.reactivex.Flowable<R>, io.reactivex.Flowable<U> */
    @SchedulerSupport(SchedulerSupport.NONE)
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @CheckReturnValue
    public final <U> Flowable<U> cast(Class<U> clazz) {
        ObjectHelper.requireNonNull(clazz, "clazz is null");
        return (Flowable<R>) map(Functions.castFunction(clazz));
    }
    ...
    /* JADX DEBUG: Type inference failed for r0v2. Raw type applied. Possible types: io.reactivex.Flowable<R>, io.reactivex.Flowable<T> */
    @SchedulerSupport(SchedulerSupport.NONE)
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U> Flowable<T> delay(Function<? super T, ? extends Publisher<U>> itemDelayIndicator) {
        ...
        return (Flowable<R>) flatMap(FlowableInternalHelper.itemDelay(itemDelayIndicator));
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: io.reactivex.functions.Function<? super T, ? extends org.reactivestreams.Publisher<V>> */
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX DEBUG: Type inference failed for r0v2. Raw type applied. Possible types: io.reactivex.Flowable<R>, io.reactivex.Flowable<V> */
    @SchedulerSupport(SchedulerSupport.NONE)
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U, V> Flowable<V> flatMapIterable(Function<? super T, ? extends Iterable<? extends U>> mapper, BiFunction<? super T, ? super U, ? extends V> resultSelector) {
        ...
        return (Flowable<R>) flatMap(FlowableInternalHelper.flatMapIntoIterable(mapper), resultSelector, false, bufferSize(), bufferSize());
    }
    ...
    public final <U, V> Flowable<V> flatMapIterable(Function<? super T, ? extends Iterable<? extends U>> mapper, BiFunction<? super T, ? super U, ? extends V> resultSelector, int prefetch) {
        ObjectHelper.requireNonNull(mapper, "mapper is null");
        ObjectHelper.requireNonNull(resultSelector, "resultSelector is null");
        return (Flowable<R>) flatMap(FlowableInternalHelper.flatMapIntoIterable(mapper), resultSelector, false, bufferSize(), prefetch);
    }
    ...
    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: io.reactivex.Flowable<io.reactivex.flowables.GroupedFlowable<K, V>>, io.reactivex.Flowable<io.reactivex.flowables.GroupedFlowable<K, T>> */
    @SchedulerSupport(SchedulerSupport.NONE)
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <K> Flowable<GroupedFlowable<K, T>> groupBy(Function<? super T, ? extends K> keySelector) {
        return (Flowable<GroupedFlowable<K, V>>) groupBy(keySelector, Functions.identity(), false, bufferSize());
    }
    ...
    public final <K> Flowable<GroupedFlowable<K, T>> groupBy(Function<? super T, ? extends K> keySelector, boolean delayError) {
        return (Flowable<GroupedFlowable<K, V>>) groupBy(keySelector, Functions.identity(), delayError, bufferSize());
    }
    ...
    /* JADX DEBUG: Type inference failed for r0v4. Raw type applied. Possible types: io.reactivex.Flowable<U>, io.reactivex.Flowable<T> */
    @SchedulerSupport(SchedulerSupport.NONE)
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> sorted(Comparator<? super T> sortFunction) {
        ObjectHelper.requireNonNull(sortFunction, "sortFunction");
        return (Flowable<U>) toList().toFlowable().map(Functions.listSorter(sortFunction)).flatMapIterable(Functions.identity());
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: io.reactivex.Flowable<T> */
    /* JADX WARN: Multi-variable type inference failed */
    @SchedulerSupport(SchedulerSupport.NONE)
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @CheckReturnValue
