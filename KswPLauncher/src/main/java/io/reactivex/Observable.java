...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: io.reactivex.Observable<U extends java.util.Collection<? super T>>, io.reactivex.Observable<java.util.List<T>> */
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final Observable<List<T>> buffer(int count, int skip) {
        return (Observable<U>) buffer(count, skip, ArrayListSupplier.asCallable());
    }
    ...
    public final Observable<List<T>> buffer(long timespan, long timeskip, TimeUnit unit) {
        return (Observable<U>) buffer(timespan, timeskip, unit, Schedulers.computation(), ArrayListSupplier.asCallable());
    }
    ...
    public final Observable<List<T>> buffer(long timespan, long timeskip, TimeUnit unit, Scheduler scheduler) {
        return (Observable<U>) buffer(timespan, timeskip, unit, scheduler, ArrayListSupplier.asCallable());
    }
    ...
    public final Observable<List<T>> buffer(long timespan, TimeUnit unit, Scheduler scheduler, int count) {
        return (Observable<U>) buffer(timespan, unit, scheduler, count, ArrayListSupplier.asCallable(), false);
    }
    ...
    public final Observable<List<T>> buffer(long timespan, TimeUnit unit, Scheduler scheduler) {
        return (Observable<U>) buffer(timespan, unit, scheduler, Integer.MAX_VALUE, ArrayListSupplier.asCallable(), false);
    }
    ...
    public final <TOpening, TClosing> Observable<List<T>> buffer(ObservableSource<? extends TOpening> openingIndicator, Function<? super TOpening, ? extends ObservableSource<? extends TClosing>> closingIndicator) {
        return (Observable<U>) buffer(openingIndicator, closingIndicator, ArrayListSupplier.asCallable());
    }
    ...
    public final <B> Observable<List<T>> buffer(ObservableSource<B> boundary) {
        return (Observable<U>) buffer(boundary, ArrayListSupplier.asCallable());
    }

    /* JADX DEBUG: Type inference failed for r0v2. Raw type applied. Possible types: io.reactivex.Observable<U extends java.util.Collection<? super T>>, io.reactivex.Observable<java.util.List<T>> */
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final <B> Observable<List<T>> buffer(ObservableSource<B> boundary, int initialCapacity) {
        ...
        return (Observable<U>) buffer(boundary, Functions.createArrayList(initialCapacity));
    }
    ...
    public final <B> Observable<List<T>> buffer(Callable<? extends ObservableSource<B>> boundarySupplier) {
        return (Observable<U>) buffer(boundarySupplier, ArrayListSupplier.asCallable());
    }
    ...
    /* JADX DEBUG: Type inference failed for r0v2. Raw type applied. Possible types: io.reactivex.Observable<R>, io.reactivex.Observable<U> */
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final <U> Observable<U> cast(Class<U> clazz) {
        ObjectHelper.requireNonNull(clazz, "clazz is null");
        return (Observable<R>) map(Functions.castFunction(clazz));
    }
    ...
    /* JADX DEBUG: Type inference failed for r0v3. Raw type applied. Possible types: io.reactivex.Observable<R>, io.reactivex.Observable<U> */
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final <U> Observable<U> concatMapIterable(Function<? super T, ? extends Iterable<? extends U>> mapper, int prefetch) {
        ObjectHelper.requireNonNull(mapper, "mapper is null");
        ObjectHelper.verifyPositive(prefetch, "prefetch");
        return (Observable<R>) concatMap(ObservableInternalHelper.flatMapIntoIterable(mapper), prefetch);
    }
    ...
    /* JADX DEBUG: Type inference failed for r0v2. Raw type applied. Possible types: io.reactivex.Observable<R>, io.reactivex.Observable<T> */
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final <U> Observable<T> delay(Function<? super T, ? extends ObservableSource<U>> itemDelay) {
        ...
        return (Observable<R>) flatMap(ObservableInternalHelper.itemDelay(itemDelay));
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: io.reactivex.functions.Function<? super T, ? extends io.reactivex.ObservableSource<V>> */
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX DEBUG: Type inference failed for r0v2. Raw type applied. Possible types: io.reactivex.Observable<R>, io.reactivex.Observable<V> */
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final <U, V> Observable<V> flatMapIterable(Function<? super T, ? extends Iterable<? extends U>> mapper, BiFunction<? super T, ? super U, ? extends V> resultSelector) {
        ...
        return (Observable<R>) flatMap(ObservableInternalHelper.flatMapIntoIterable(mapper), resultSelector, false, bufferSize(), bufferSize());
    }
    ...
    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: io.reactivex.Observable<io.reactivex.observables.GroupedObservable<K, V>>, io.reactivex.Observable<io.reactivex.observables.GroupedObservable<K, T>> */
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final <K> Observable<GroupedObservable<K, T>> groupBy(Function<? super T, ? extends K> keySelector) {
        return (Observable<GroupedObservable<K, V>>) groupBy(keySelector, Functions.identity(), false, bufferSize());
    }
    ...
    public final <K> Observable<GroupedObservable<K, T>> groupBy(Function<? super T, ? extends K> keySelector, boolean delayError) {
        return (Observable<GroupedObservable<K, V>>) groupBy(keySelector, Functions.identity(), delayError, bufferSize());
    }
    ...
    /* JADX DEBUG: Type inference failed for r0v4. Raw type applied. Possible types: io.reactivex.Observable<U>, io.reactivex.Observable<T> */
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final Observable<T> sorted(Comparator<? super T> sortFunction) {
        ...
        return (Observable<U>) toList().toObservable().map(Functions.listSorter(sortFunction)).flatMapIterable(Functions.identity());
    }
    ...
    /* JADX DEBUG: Type inference failed for r3v0. Raw type applied. Possible types: io.reactivex.Single<java.util.Map<K, java.util.Collection<V>>>, io.reactivex.Single<java.util.Map<K, java.util.Collection<T>>> */
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final <K> Single<Map<K, Collection<T>>> toMultimap(Function<? super T, ? extends K> keySelector) {
        return (Single<Map<K, Collection<V>>>) toMultimap(keySelector, Functions.identity(), HashMapSupplier.asCallable(), ArrayListSupplier.asFunction());
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: io.reactivex.Observable<T> */
    /* JADX WARN: Multi-variable type inference failed */
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
