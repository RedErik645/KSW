...
public final class BehaviorProcessor<T> extends FlowableProcessor<T> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: io.reactivex.processors.BehaviorProcessor<T> */
    ...
    public T[] getValues(T[] array) {
        ...
        Object value2 = NotificationLite.getValue(o);
        if (array.length != 0) {
            array[0] = value2;
            if (array.length == 1) {
                return array;
